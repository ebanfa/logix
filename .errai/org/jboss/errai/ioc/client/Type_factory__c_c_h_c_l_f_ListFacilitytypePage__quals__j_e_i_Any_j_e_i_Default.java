...
public class Type_factory__c_c_h_c_l_f_ListFacilitytypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListFacilitytypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListFacilitytypePage.class, "Type_factory__c_c_h_c_l_f_ListFacilitytypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_f_ListFacilitytypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/facilitytype/list-facilitytype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_f_ListFacilitytypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListFacilitytypePage.class);
  ...
  public ListFacilitytypePage createInstance(final ContextManager contextManager) {
    final ListFacilitytypePage instance = new ListFacilitytypePage();
    ...
    final FacilitytypeListWidget ListFacilitytypePage_listWidget = (FacilitytypeListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_f_FacilitytypeListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListFacilitytypePage_listWidget);
    ListFacilitytypePage_FacilitytypeListWidget_listWidget(instance, ListFacilitytypePage_listWidget);
    ...
    c_c_h_c_l_f_ListFacilitytypePageTemplateResource templateForListFacilitytypePage = GWT.create(c_c_h_c_l_f_ListFacilitytypePageTemplateResource.class);
    Element parentElementForTemplateOfListFacilitytypePage = TemplateUtil.getRootTemplateParentElement(templateForListFacilitytypePage.getContents().getText(), "com/cloderia/helion/client/local/facilitytype/list-facilitytype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/facilitytype/list-facilitytype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListFacilitytypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListFacilitytypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facilitytype.ListFacilitytypePage", "com/cloderia/helion/client/local/facilitytype/list-facilitytype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facilitytype.ListFacilitytypePage", "com/cloderia/helion/client/local/facilitytype/list-facilitytype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListFacilitytypePage_FacilitytypeListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facilitytype.ListFacilitytypePage", "com/cloderia/helion/client/local/facilitytype/list-facilitytype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListFacilitytypePage_AnchorElement_createNewFacilitytypeLink(instance));
      }
    }, dataFieldElements, "createNewFacilitytypeLink");
    ...
    templateFieldsMap.put("listWidget", ListFacilitytypePage_FacilitytypeListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewFacilitytypeLink", ElementWrapperWidget.getWidget(ListFacilitytypePage_AnchorElement_createNewFacilitytypeLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListFacilitytypePage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewFacilitytypeLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListFacilitytypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListFacilitytypePage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListFacilitytypePage_AnchorElement_createNewFacilitytypeLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListFacilitytypePage instance) {
  ...
  native static FacilitytypeListWidget ListFacilitytypePage_FacilitytypeListWidget_listWidget(ListFacilitytypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facilitytype.ListFacilitytypePage::listWidget;
  }-*/;

  native static void ListFacilitytypePage_FacilitytypeListWidget_listWidget(ListFacilitytypePage instance, FacilitytypeListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.facilitytype.ListFacilitytypePage::listWidget = value;
  }-*/;
  ...
  native static AnchorElement ListFacilitytypePage_AnchorElement_createNewFacilitytypeLink(ListFacilitytypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facilitytype.ListFacilitytypePage::createNewFacilitytypeLink;
  }-*/;

  native static void ListFacilitytypePage_AnchorElement_createNewFacilitytypeLink(ListFacilitytypePage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.facilitytype.ListFacilitytypePage::createNewFacilitytypeLink = value;
  }-*/;
