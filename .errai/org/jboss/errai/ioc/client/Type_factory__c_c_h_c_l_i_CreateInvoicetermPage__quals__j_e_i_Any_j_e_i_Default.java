...
public class Type_factory__c_c_h_c_l_i_CreateInvoicetermPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateInvoicetermPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateInvoicetermPage.class, "Type_factory__c_c_h_c_l_i_CreateInvoicetermPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_CreateInvoicetermPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_CreateInvoicetermPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateInvoicetermPage.class);
  ...
  public CreateInvoicetermPage createInstance(final ContextManager contextManager) {
    final CreateInvoicetermPage instance = new CreateInvoicetermPage();
    ...
    final InvoicetermEditor CreateInvoicetermPage_invoicetermEditor = (InvoicetermEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InvoicetermEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateInvoicetermPage_invoicetermEditor);
    CreateInvoicetermPage_InvoicetermEditor_invoicetermEditor(instance, CreateInvoicetermPage_invoicetermEditor);
    ...
    c_c_h_c_l_i_CreateInvoicetermPageTemplateResource templateForCreateInvoicetermPage = GWT.create(c_c_h_c_l_i_CreateInvoicetermPageTemplateResource.class);
    Element parentElementForTemplateOfCreateInvoicetermPage = TemplateUtil.getRootTemplateParentElement(templateForCreateInvoicetermPage.getContents().getText(), "com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInvoicetermPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInvoicetermPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceterm.CreateInvoicetermPage", "com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceterm.CreateInvoicetermPage", "com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateInvoicetermPage_InvoicetermEditor_invoicetermEditor(instance));
      }
    ...
    templateFieldsMap.put("invoicetermEditor", TemplateWidgetMapper.get(CreateInvoicetermPage_InvoicetermEditor_invoicetermEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInvoicetermPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateInvoicetermPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateInvoicetermPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateInvoicetermPage instance) {
  ...
  native static InvoicetermEditor CreateInvoicetermPage_InvoicetermEditor_invoicetermEditor(CreateInvoicetermPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoiceterm.CreateInvoicetermPage::invoicetermEditor;
  }-*/;

  native static void CreateInvoicetermPage_InvoicetermEditor_invoicetermEditor(CreateInvoicetermPage instance, InvoicetermEditor value) /*-{
    instance.@com.cloderia.helion.client.local.invoiceterm.CreateInvoicetermPage::invoicetermEditor = value;
  }-*/;
