...
public class Type_factory__c_c_h_c_l_p_ListPartytypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListPartytypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListPartytypePage.class, "Type_factory__c_c_h_c_l_p_ListPartytypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ListPartytypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partytype/list-partytype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ListPartytypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListPartytypePage.class);
  ...
  public ListPartytypePage createInstance(final ContextManager contextManager) {
    final ListPartytypePage instance = new ListPartytypePage();
    ...
    final PartytypeListWidget ListPartytypePage_listWidget = (PartytypeListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartytypeListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListPartytypePage_listWidget);
    ListPartytypePage_PartytypeListWidget_listWidget(instance, ListPartytypePage_listWidget);
    ...
    c_c_h_c_l_p_ListPartytypePageTemplateResource templateForListPartytypePage = GWT.create(c_c_h_c_l_p_ListPartytypePageTemplateResource.class);
    Element parentElementForTemplateOfListPartytypePage = TemplateUtil.getRootTemplateParentElement(templateForListPartytypePage.getContents().getText(), "com/cloderia/helion/client/local/partytype/list-partytype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partytype/list-partytype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPartytypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPartytypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partytype.ListPartytypePage", "com/cloderia/helion/client/local/partytype/list-partytype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partytype.ListPartytypePage", "com/cloderia/helion/client/local/partytype/list-partytype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListPartytypePage_PartytypeListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partytype.ListPartytypePage", "com/cloderia/helion/client/local/partytype/list-partytype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListPartytypePage_AnchorElement_createNewPartytypeLink(instance));
      }
    }, dataFieldElements, "createNewPartytypeLink");
    ...
    templateFieldsMap.put("listWidget", ListPartytypePage_PartytypeListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewPartytypeLink", ElementWrapperWidget.getWidget(ListPartytypePage_AnchorElement_createNewPartytypeLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPartytypePage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewPartytypeLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListPartytypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListPartytypePage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListPartytypePage_AnchorElement_createNewPartytypeLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListPartytypePage instance) {
  ...
  native static AnchorElement ListPartytypePage_AnchorElement_createNewPartytypeLink(ListPartytypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partytype.ListPartytypePage::createNewPartytypeLink;
  }-*/;

  native static void ListPartytypePage_AnchorElement_createNewPartytypeLink(ListPartytypePage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.partytype.ListPartytypePage::createNewPartytypeLink = value;
  }-*/;
  ...
  native static PartytypeListWidget ListPartytypePage_PartytypeListWidget_listWidget(ListPartytypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partytype.ListPartytypePage::listWidget;
  }-*/;

  native static void ListPartytypePage_PartytypeListWidget_listWidget(ListPartytypePage instance, PartytypeListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.partytype.ListPartytypePage::listWidget = value;
  }-*/;
