...
public class Type_factory__c_c_h_c_l_p_BasePartyrolePage__quals__j_e_i_Any_j_e_i_Default extends Factory<BasePartyrolePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BasePartyrolePage.class, "Type_factory__c_c_h_c_l_p_BasePartyrolePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BasePartyrolePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BasePartyrolePage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BasePartyrolePage createInstance(final ContextManager contextManager) {
    final BasePartyrolePage instance = new BasePartyrolePage();
    ...
    c_c_h_c_l_p_BasePartyrolePageTemplateResource templateForBasePartyrolePage = GWT.create(c_c_h_c_l_p_BasePartyrolePageTemplateResource.class);
    Element parentElementForTemplateOfBasePartyrolePage = TemplateUtil.getRootTemplateParentElement(templateForBasePartyrolePage.getContents().getText(), "com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartyrolePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartyrolePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyrole.BasePartyrolePage", "com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartyrolePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BasePartyrolePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BasePartyrolePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BasePartyrolePage instance) {
