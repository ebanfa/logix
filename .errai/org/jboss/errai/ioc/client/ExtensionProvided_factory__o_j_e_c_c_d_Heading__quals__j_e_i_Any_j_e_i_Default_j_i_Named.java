...
public class ExtensionProvided_factory__o_j_e_c_c_d_Heading__quals__j_e_i_Any_j_e_i_Default_j_i_Named extends Factory<Heading> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(Heading.class, "ExtensionProvided_factory__o_j_e_c_c_d_Heading__quals__j_e_i_Any_j_e_i_Default_j_i_Named", Dependent.class, false, "h2", true);
  public ExtensionProvided_factory__o_j_e_c_c_d_Heading__quals__j_e_i_Any_j_e_i_Default_j_i_Named() {
    ...
    handle.addQualifier(new Named() {
      ...
      public String toString() {
        return "@javax.inject.Named(value=h2)";
      }
      public String value() {
        return "h2";
      }
  ...
  public Heading createInstance(final ContextManager contextManager) {
    final com.google.gwt.dom.client.Element element = Document.get().createElement("h2");
