...
public class Type_factory__c_c_h_c_l_o_BaseOrganizationgeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseOrganizationgeneralledgeraccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseOrganizationgeneralledgeraccountPage.class, "Type_factory__c_c_h_c_l_o_BaseOrganizationgeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_BaseOrganizationgeneralledgeraccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organizationgeneralledgeraccount/edit-organizationgeneralledgeraccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_BaseOrganizationgeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseOrganizationgeneralledgeraccountPage createInstance(final ContextManager contextManager) {
    final BaseOrganizationgeneralledgeraccountPage instance = new BaseOrganizationgeneralledgeraccountPage();
    ...
    c_c_h_c_l_o_BaseOrganizationgeneralledgeraccountPageTemplateResource templateForBaseOrganizationgeneralledgeraccountPage = GWT.create(c_c_h_c_l_o_BaseOrganizationgeneralledgeraccountPageTemplateResource.class);
    Element parentElementForTemplateOfBaseOrganizationgeneralledgeraccountPage = TemplateUtil.getRootTemplateParentElement(templateForBaseOrganizationgeneralledgeraccountPage.getContents().getText(), "com/cloderia/helion/client/local/organizationgeneralledgeraccount/edit-organizationgeneralledgeraccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organizationgeneralledgeraccount/edit-organizationgeneralledgeraccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseOrganizationgeneralledgeraccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseOrganizationgeneralledgeraccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationgeneralledgeraccount.BaseOrganizationgeneralledgeraccountPage", "com/cloderia/helion/client/local/organizationgeneralledgeraccount/edit-organizationgeneralledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseOrganizationgeneralledgeraccountPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseOrganizationgeneralledgeraccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseOrganizationgeneralledgeraccountPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseOrganizationgeneralledgeraccountPage instance) {
