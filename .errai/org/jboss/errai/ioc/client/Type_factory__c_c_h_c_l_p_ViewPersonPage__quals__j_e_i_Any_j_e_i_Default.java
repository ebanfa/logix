...
public class Type_factory__c_c_h_c_l_p_ViewPersonPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewPersonPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewPersonPage.class, "Type_factory__c_c_h_c_l_p_ViewPersonPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewPersonPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/person/view-person-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewPersonPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewPersonPage.class);
  ...
  public ViewPersonPage createInstance(final ContextManager contextManager) {
    final ViewPersonPage instance = new ViewPersonPage();
    ...
    final PersonDisplay ViewPersonPage_entityDisplayComponent = (PersonDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PersonDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewPersonPage_entityDisplayComponent);
    ViewPersonPage_PersonDisplay_entityDisplayComponent(instance, ViewPersonPage_entityDisplayComponent);
    ...
    final DataBinder ViewPersonPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Person.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewPersonPage_binder);
    ViewPersonPage_DataBinder_binder(instance, ViewPersonPage_binder);
    ...
    c_c_h_c_l_p_ViewPersonPageTemplateResource templateForViewPersonPage = GWT.create(c_c_h_c_l_p_ViewPersonPageTemplateResource.class);
    Element parentElementForTemplateOfViewPersonPage = TemplateUtil.getRootTemplateParentElement(templateForViewPersonPage.getContents().getText(), "com/cloderia/helion/client/local/person/view-person-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/person/view-person-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPersonPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPersonPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.person.ViewPersonPage", "com/cloderia/helion/client/local/person/view-person-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.person.ViewPersonPage", "com/cloderia/helion/client/local/person/view-person-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewPersonPage_PersonDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewPersonPage_PersonDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPersonPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewPersonPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewPersonPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewPersonPage instance) {
  ...
  native static DataBinder ViewPersonPage_DataBinder_binder(ViewPersonPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.person.ViewPersonPage::binder;
  }-*/;

  native static void ViewPersonPage_DataBinder_binder(ViewPersonPage instance, DataBinder<Person> value) /*-{
    instance.@com.cloderia.helion.client.local.person.ViewPersonPage::binder = value;
  }-*/;
  ...
  native static PersonDisplay ViewPersonPage_PersonDisplay_entityDisplayComponent(ViewPersonPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.person.ViewPersonPage::entityDisplayComponent;
  }-*/;

  native static void ViewPersonPage_PersonDisplay_entityDisplayComponent(ViewPersonPage instance, PersonDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.person.ViewPersonPage::entityDisplayComponent = value;
  }-*/;
