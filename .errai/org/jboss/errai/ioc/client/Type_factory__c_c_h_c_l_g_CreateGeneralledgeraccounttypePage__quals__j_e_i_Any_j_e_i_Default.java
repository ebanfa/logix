...
public class Type_factory__c_c_h_c_l_g_CreateGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateGeneralledgeraccounttypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateGeneralledgeraccounttypePage.class, "Type_factory__c_c_h_c_l_g_CreateGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_g_CreateGeneralledgeraccounttypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_g_CreateGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateGeneralledgeraccounttypePage.class);
  ...
  public CreateGeneralledgeraccounttypePage createInstance(final ContextManager contextManager) {
    final CreateGeneralledgeraccounttypePage instance = new CreateGeneralledgeraccounttypePage();
    ...
    final GeneralledgeraccounttypeEditor CreateGeneralledgeraccounttypePage_generalledgeraccounttypeEditor = (GeneralledgeraccounttypeEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_g_GeneralledgeraccounttypeEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateGeneralledgeraccounttypePage_generalledgeraccounttypeEditor);
    CreateGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(instance, CreateGeneralledgeraccounttypePage_generalledgeraccounttypeEditor);
    ...
    c_c_h_c_l_g_CreateGeneralledgeraccounttypePageTemplateResource templateForCreateGeneralledgeraccounttypePage = GWT.create(c_c_h_c_l_g_CreateGeneralledgeraccounttypePageTemplateResource.class);
    Element parentElementForTemplateOfCreateGeneralledgeraccounttypePage = TemplateUtil.getRootTemplateParentElement(templateForCreateGeneralledgeraccounttypePage.getContents().getText(), "com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateGeneralledgeraccounttypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateGeneralledgeraccounttypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccounttype.CreateGeneralledgeraccounttypePage", "com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccounttype.CreateGeneralledgeraccounttypePage", "com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(instance));
      }
    ...
    templateFieldsMap.put("generalledgeraccounttypeEditor", TemplateWidgetMapper.get(CreateGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateGeneralledgeraccounttypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateGeneralledgeraccounttypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateGeneralledgeraccounttypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateGeneralledgeraccounttypePage instance) {
  ...
  native static GeneralledgeraccounttypeEditor CreateGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(CreateGeneralledgeraccounttypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccounttype.CreateGeneralledgeraccounttypePage::generalledgeraccounttypeEditor;
  }-*/;

  native static void CreateGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(CreateGeneralledgeraccounttypePage instance, GeneralledgeraccounttypeEditor value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccounttype.CreateGeneralledgeraccounttypePage::generalledgeraccounttypeEditor = value;
  }-*/;
