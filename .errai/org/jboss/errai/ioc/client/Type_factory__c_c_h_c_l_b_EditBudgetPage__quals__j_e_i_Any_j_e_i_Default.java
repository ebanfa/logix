...
public class Type_factory__c_c_h_c_l_b_EditBudgetPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditBudgetPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditBudgetPage.class, "Type_factory__c_c_h_c_l_b_EditBudgetPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_EditBudgetPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/budget/edit-budget-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_EditBudgetPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditBudgetPage.class);
  ...
  public EditBudgetPage createInstance(final ContextManager contextManager) {
    final EditBudgetPage instance = new EditBudgetPage();
    ...
    final BudgetEditor EditBudgetPage_budgetEditor = (BudgetEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_b_BudgetEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditBudgetPage_budgetEditor);
    EditBudgetPage_BudgetEditor_budgetEditor(instance, EditBudgetPage_budgetEditor);
    ...
    c_c_h_c_l_b_EditBudgetPageTemplateResource templateForEditBudgetPage = GWT.create(c_c_h_c_l_b_EditBudgetPageTemplateResource.class);
    Element parentElementForTemplateOfEditBudgetPage = TemplateUtil.getRootTemplateParentElement(templateForEditBudgetPage.getContents().getText(), "com/cloderia/helion/client/local/budget/edit-budget-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/budget/edit-budget-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditBudgetPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditBudgetPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budget.EditBudgetPage", "com/cloderia/helion/client/local/budget/edit-budget-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budget.EditBudgetPage", "com/cloderia/helion/client/local/budget/edit-budget-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditBudgetPage_BudgetEditor_budgetEditor(instance));
      }
    ...
    templateFieldsMap.put("budgetEditor", TemplateWidgetMapper.get(EditBudgetPage_BudgetEditor_budgetEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditBudgetPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditBudgetPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditBudgetPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditBudgetPage instance) {
  ...
  native static BudgetEditor EditBudgetPage_BudgetEditor_budgetEditor(EditBudgetPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.budget.EditBudgetPage::budgetEditor;
  }-*/;

  native static void EditBudgetPage_BudgetEditor_budgetEditor(EditBudgetPage instance, BudgetEditor value) /*-{
    instance.@com.cloderia.helion.client.local.budget.EditBudgetPage::budgetEditor = value;
  }-*/;
