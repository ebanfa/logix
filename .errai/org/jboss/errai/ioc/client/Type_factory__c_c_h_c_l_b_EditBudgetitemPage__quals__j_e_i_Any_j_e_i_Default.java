...
public class Type_factory__c_c_h_c_l_b_EditBudgetitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditBudgetitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditBudgetitemPage.class, "Type_factory__c_c_h_c_l_b_EditBudgetitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_EditBudgetitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/budgetitem/edit-budgetitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_EditBudgetitemPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditBudgetitemPage.class);
  ...
  public EditBudgetitemPage createInstance(final ContextManager contextManager) {
    final EditBudgetitemPage instance = new EditBudgetitemPage();
    ...
    final BudgetitemEditor EditBudgetitemPage_budgetitemEditor = (BudgetitemEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_b_BudgetitemEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditBudgetitemPage_budgetitemEditor);
    EditBudgetitemPage_BudgetitemEditor_budgetitemEditor(instance, EditBudgetitemPage_budgetitemEditor);
    ...
    c_c_h_c_l_b_EditBudgetitemPageTemplateResource templateForEditBudgetitemPage = GWT.create(c_c_h_c_l_b_EditBudgetitemPageTemplateResource.class);
    Element parentElementForTemplateOfEditBudgetitemPage = TemplateUtil.getRootTemplateParentElement(templateForEditBudgetitemPage.getContents().getText(), "com/cloderia/helion/client/local/budgetitem/edit-budgetitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/budgetitem/edit-budgetitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditBudgetitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditBudgetitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budgetitem.EditBudgetitemPage", "com/cloderia/helion/client/local/budgetitem/edit-budgetitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budgetitem.EditBudgetitemPage", "com/cloderia/helion/client/local/budgetitem/edit-budgetitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditBudgetitemPage_BudgetitemEditor_budgetitemEditor(instance));
      }
    ...
    templateFieldsMap.put("budgetitemEditor", TemplateWidgetMapper.get(EditBudgetitemPage_BudgetitemEditor_budgetitemEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditBudgetitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditBudgetitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditBudgetitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditBudgetitemPage instance) {
  ...
  native static BudgetitemEditor EditBudgetitemPage_BudgetitemEditor_budgetitemEditor(EditBudgetitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.budgetitem.EditBudgetitemPage::budgetitemEditor;
  }-*/;

  native static void EditBudgetitemPage_BudgetitemEditor_budgetitemEditor(EditBudgetitemPage instance, BudgetitemEditor value) /*-{
    instance.@com.cloderia.helion.client.local.budgetitem.EditBudgetitemPage::budgetitemEditor = value;
  }-*/;
