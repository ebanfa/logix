...
public class Type_factory__c_c_h_c_l_o_CreateOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateOrganizationglaccountbalancePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateOrganizationglaccountbalancePage.class, "Type_factory__c_c_h_c_l_o_CreateOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_CreateOrganizationglaccountbalancePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_CreateOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateOrganizationglaccountbalancePage.class);
  ...
  public CreateOrganizationglaccountbalancePage createInstance(final ContextManager contextManager) {
    final CreateOrganizationglaccountbalancePage instance = new CreateOrganizationglaccountbalancePage();
    ...
    final OrganizationglaccountbalanceEditor CreateOrganizationglaccountbalancePage_organizationglaccountbalanceEditor = (OrganizationglaccountbalanceEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_o_OrganizationglaccountbalanceEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateOrganizationglaccountbalancePage_organizationglaccountbalanceEditor);
    CreateOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(instance, CreateOrganizationglaccountbalancePage_organizationglaccountbalanceEditor);
    ...
    c_c_h_c_l_o_CreateOrganizationglaccountbalancePageTemplateResource templateForCreateOrganizationglaccountbalancePage = GWT.create(c_c_h_c_l_o_CreateOrganizationglaccountbalancePageTemplateResource.class);
    Element parentElementForTemplateOfCreateOrganizationglaccountbalancePage = TemplateUtil.getRootTemplateParentElement(templateForCreateOrganizationglaccountbalancePage.getContents().getText(), "com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateOrganizationglaccountbalancePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateOrganizationglaccountbalancePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationglaccountbalance.CreateOrganizationglaccountbalancePage", "com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationglaccountbalance.CreateOrganizationglaccountbalancePage", "com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(instance));
      }
    ...
    templateFieldsMap.put("organizationglaccountbalanceEditor", TemplateWidgetMapper.get(CreateOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateOrganizationglaccountbalancePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateOrganizationglaccountbalancePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateOrganizationglaccountbalancePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateOrganizationglaccountbalancePage instance) {
  ...
  native static OrganizationglaccountbalanceEditor CreateOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(CreateOrganizationglaccountbalancePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organizationglaccountbalance.CreateOrganizationglaccountbalancePage::organizationglaccountbalanceEditor;
  }-*/;

  native static void CreateOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(CreateOrganizationglaccountbalancePage instance, OrganizationglaccountbalanceEditor value) /*-{
    instance.@com.cloderia.helion.client.local.organizationglaccountbalance.CreateOrganizationglaccountbalancePage::organizationglaccountbalanceEditor = value;
  }-*/;
