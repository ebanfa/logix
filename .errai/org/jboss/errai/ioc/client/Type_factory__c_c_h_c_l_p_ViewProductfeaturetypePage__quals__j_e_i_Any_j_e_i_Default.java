...
public class Type_factory__c_c_h_c_l_p_ViewProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewProductfeaturetypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewProductfeaturetypePage.class, "Type_factory__c_c_h_c_l_p_ViewProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewProductfeaturetypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productfeaturetype/view-productfeaturetype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewProductfeaturetypePage.class);
  ...
  public ViewProductfeaturetypePage createInstance(final ContextManager contextManager) {
    final ViewProductfeaturetypePage instance = new ViewProductfeaturetypePage();
    ...
    final ProductfeaturetypeDisplay ViewProductfeaturetypePage_entityDisplayComponent = (ProductfeaturetypeDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductfeaturetypeDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewProductfeaturetypePage_entityDisplayComponent);
    ViewProductfeaturetypePage_ProductfeaturetypeDisplay_entityDisplayComponent(instance, ViewProductfeaturetypePage_entityDisplayComponent);
    final DataBinder ViewProductfeaturetypePage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Productfeaturetype.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewProductfeaturetypePage_binder);
    ViewProductfeaturetypePage_DataBinder_binder(instance, ViewProductfeaturetypePage_binder);
    ...
    c_c_h_c_l_p_ViewProductfeaturetypePageTemplateResource templateForViewProductfeaturetypePage = GWT.create(c_c_h_c_l_p_ViewProductfeaturetypePageTemplateResource.class);
    Element parentElementForTemplateOfViewProductfeaturetypePage = TemplateUtil.getRootTemplateParentElement(templateForViewProductfeaturetypePage.getContents().getText(), "com/cloderia/helion/client/local/productfeaturetype/view-productfeaturetype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productfeaturetype/view-productfeaturetype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductfeaturetypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductfeaturetypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeaturetype.ViewProductfeaturetypePage", "com/cloderia/helion/client/local/productfeaturetype/view-productfeaturetype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeaturetype.ViewProductfeaturetypePage", "com/cloderia/helion/client/local/productfeaturetype/view-productfeaturetype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewProductfeaturetypePage_ProductfeaturetypeDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewProductfeaturetypePage_ProductfeaturetypeDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductfeaturetypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewProductfeaturetypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewProductfeaturetypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewProductfeaturetypePage instance) {
  ...
  native static DataBinder ViewProductfeaturetypePage_DataBinder_binder(ViewProductfeaturetypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeaturetype.ViewProductfeaturetypePage::binder;
  }-*/;

  native static void ViewProductfeaturetypePage_DataBinder_binder(ViewProductfeaturetypePage instance, DataBinder<Productfeaturetype> value) /*-{
    instance.@com.cloderia.helion.client.local.productfeaturetype.ViewProductfeaturetypePage::binder = value;
  }-*/;
  ...
  native static ProductfeaturetypeDisplay ViewProductfeaturetypePage_ProductfeaturetypeDisplay_entityDisplayComponent(ViewProductfeaturetypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeaturetype.ViewProductfeaturetypePage::entityDisplayComponent;
  }-*/;

  native static void ViewProductfeaturetypePage_ProductfeaturetypeDisplay_entityDisplayComponent(ViewProductfeaturetypePage instance, ProductfeaturetypeDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.productfeaturetype.ViewProductfeaturetypePage::entityDisplayComponent = value;
  }-*/;
