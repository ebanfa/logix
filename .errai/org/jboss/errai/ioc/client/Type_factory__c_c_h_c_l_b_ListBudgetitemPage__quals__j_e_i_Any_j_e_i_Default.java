...
public class Type_factory__c_c_h_c_l_b_ListBudgetitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListBudgetitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListBudgetitemPage.class, "Type_factory__c_c_h_c_l_b_ListBudgetitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_ListBudgetitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/budgetitem/list-budgetitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_ListBudgetitemPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListBudgetitemPage.class);
  ...
  public ListBudgetitemPage createInstance(final ContextManager contextManager) {
    final ListBudgetitemPage instance = new ListBudgetitemPage();
    ...
    final BudgetitemListWidget ListBudgetitemPage_listWidget = (BudgetitemListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_b_BudgetitemListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListBudgetitemPage_listWidget);
    ListBudgetitemPage_BudgetitemListWidget_listWidget(instance, ListBudgetitemPage_listWidget);
    ...
    c_c_h_c_l_b_ListBudgetitemPageTemplateResource templateForListBudgetitemPage = GWT.create(c_c_h_c_l_b_ListBudgetitemPageTemplateResource.class);
    Element parentElementForTemplateOfListBudgetitemPage = TemplateUtil.getRootTemplateParentElement(templateForListBudgetitemPage.getContents().getText(), "com/cloderia/helion/client/local/budgetitem/list-budgetitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/budgetitem/list-budgetitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListBudgetitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListBudgetitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budgetitem.ListBudgetitemPage", "com/cloderia/helion/client/local/budgetitem/list-budgetitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budgetitem.ListBudgetitemPage", "com/cloderia/helion/client/local/budgetitem/list-budgetitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListBudgetitemPage_BudgetitemListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budgetitem.ListBudgetitemPage", "com/cloderia/helion/client/local/budgetitem/list-budgetitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListBudgetitemPage_AnchorElement_createNewBudgetitemLink(instance));
      }
    }, dataFieldElements, "createNewBudgetitemLink");
    ...
    templateFieldsMap.put("listWidget", ListBudgetitemPage_BudgetitemListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewBudgetitemLink", ElementWrapperWidget.getWidget(ListBudgetitemPage_AnchorElement_createNewBudgetitemLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListBudgetitemPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewBudgetitemLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListBudgetitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListBudgetitemPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListBudgetitemPage_AnchorElement_createNewBudgetitemLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListBudgetitemPage instance) {
  ...
  native static BudgetitemListWidget ListBudgetitemPage_BudgetitemListWidget_listWidget(ListBudgetitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.budgetitem.ListBudgetitemPage::listWidget;
  }-*/;

  native static void ListBudgetitemPage_BudgetitemListWidget_listWidget(ListBudgetitemPage instance, BudgetitemListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.budgetitem.ListBudgetitemPage::listWidget = value;
  }-*/;

  native static AnchorElement ListBudgetitemPage_AnchorElement_createNewBudgetitemLink(ListBudgetitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.budgetitem.ListBudgetitemPage::createNewBudgetitemLink;
  }-*/;

  native static void ListBudgetitemPage_AnchorElement_createNewBudgetitemLink(ListBudgetitemPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.budgetitem.ListBudgetitemPage::createNewBudgetitemLink = value;
  }-*/;
