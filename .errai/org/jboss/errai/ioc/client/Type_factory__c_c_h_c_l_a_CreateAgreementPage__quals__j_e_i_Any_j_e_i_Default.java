...
public class Type_factory__c_c_h_c_l_a_CreateAgreementPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateAgreementPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateAgreementPage.class, "Type_factory__c_c_h_c_l_a_CreateAgreementPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_a_CreateAgreementPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/agreement/edit-agreement-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_a_CreateAgreementPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateAgreementPage.class);
  ...
  public CreateAgreementPage createInstance(final ContextManager contextManager) {
    final CreateAgreementPage instance = new CreateAgreementPage();
    ...
    final AgreementEditor CreateAgreementPage_agreementEditor = (AgreementEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_a_AgreementEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateAgreementPage_agreementEditor);
    CreateAgreementPage_AgreementEditor_agreementEditor(instance, CreateAgreementPage_agreementEditor);
    ...
    c_c_h_c_l_a_CreateAgreementPageTemplateResource templateForCreateAgreementPage = GWT.create(c_c_h_c_l_a_CreateAgreementPageTemplateResource.class);
    Element parentElementForTemplateOfCreateAgreementPage = TemplateUtil.getRootTemplateParentElement(templateForCreateAgreementPage.getContents().getText(), "com/cloderia/helion/client/local/agreement/edit-agreement-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/agreement/edit-agreement-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateAgreementPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateAgreementPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.agreement.CreateAgreementPage", "com/cloderia/helion/client/local/agreement/edit-agreement-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.agreement.CreateAgreementPage", "com/cloderia/helion/client/local/agreement/edit-agreement-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateAgreementPage_AgreementEditor_agreementEditor(instance));
      }
    ...
    templateFieldsMap.put("agreementEditor", TemplateWidgetMapper.get(CreateAgreementPage_AgreementEditor_agreementEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateAgreementPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateAgreementPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateAgreementPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateAgreementPage instance) {
  ...
  native static AgreementEditor CreateAgreementPage_AgreementEditor_agreementEditor(CreateAgreementPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.agreement.CreateAgreementPage::agreementEditor;
  }-*/;

  native static void CreateAgreementPage_AgreementEditor_agreementEditor(CreateAgreementPage instance, AgreementEditor value) /*-{
    instance.@com.cloderia.helion.client.local.agreement.CreateAgreementPage::agreementEditor = value;
  }-*/;
