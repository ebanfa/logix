...
public class Type_factory__c_c_h_c_l_p_CreateProductfeaturePage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateProductfeaturePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateProductfeaturePage.class, "Type_factory__c_c_h_c_l_p_CreateProductfeaturePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_CreateProductfeaturePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_CreateProductfeaturePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateProductfeaturePage.class);
  ...
  public CreateProductfeaturePage createInstance(final ContextManager contextManager) {
    final CreateProductfeaturePage instance = new CreateProductfeaturePage();
    ...
    final ProductfeatureEditor CreateProductfeaturePage_productfeatureEditor = (ProductfeatureEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductfeatureEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateProductfeaturePage_productfeatureEditor);
    CreateProductfeaturePage_ProductfeatureEditor_productfeatureEditor(instance, CreateProductfeaturePage_productfeatureEditor);
    ...
    c_c_h_c_l_p_CreateProductfeaturePageTemplateResource templateForCreateProductfeaturePage = GWT.create(c_c_h_c_l_p_CreateProductfeaturePageTemplateResource.class);
    Element parentElementForTemplateOfCreateProductfeaturePage = TemplateUtil.getRootTemplateParentElement(templateForCreateProductfeaturePage.getContents().getText(), "com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductfeaturePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductfeaturePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeature.CreateProductfeaturePage", "com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeature.CreateProductfeaturePage", "com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateProductfeaturePage_ProductfeatureEditor_productfeatureEditor(instance));
      }
    ...
    templateFieldsMap.put("productfeatureEditor", TemplateWidgetMapper.get(CreateProductfeaturePage_ProductfeatureEditor_productfeatureEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductfeaturePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateProductfeaturePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateProductfeaturePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateProductfeaturePage instance) {
  ...
  native static ProductfeatureEditor CreateProductfeaturePage_ProductfeatureEditor_productfeatureEditor(CreateProductfeaturePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeature.CreateProductfeaturePage::productfeatureEditor;
  }-*/;

  native static void CreateProductfeaturePage_ProductfeatureEditor_productfeatureEditor(CreateProductfeaturePage instance, ProductfeatureEditor value) /*-{
    instance.@com.cloderia.helion.client.local.productfeature.CreateProductfeaturePage::productfeatureEditor = value;
  }-*/;
