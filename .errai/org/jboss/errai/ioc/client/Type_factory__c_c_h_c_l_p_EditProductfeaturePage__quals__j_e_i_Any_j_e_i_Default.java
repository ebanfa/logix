...
public class Type_factory__c_c_h_c_l_p_EditProductfeaturePage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditProductfeaturePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditProductfeaturePage.class, "Type_factory__c_c_h_c_l_p_EditProductfeaturePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditProductfeaturePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditProductfeaturePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditProductfeaturePage.class);
  ...
  public EditProductfeaturePage createInstance(final ContextManager contextManager) {
    final EditProductfeaturePage instance = new EditProductfeaturePage();
    ...
    final ProductfeatureEditor EditProductfeaturePage_productfeatureEditor = (ProductfeatureEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductfeatureEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditProductfeaturePage_productfeatureEditor);
    EditProductfeaturePage_ProductfeatureEditor_productfeatureEditor(instance, EditProductfeaturePage_productfeatureEditor);
    ...
    c_c_h_c_l_p_EditProductfeaturePageTemplateResource templateForEditProductfeaturePage = GWT.create(c_c_h_c_l_p_EditProductfeaturePageTemplateResource.class);
    Element parentElementForTemplateOfEditProductfeaturePage = TemplateUtil.getRootTemplateParentElement(templateForEditProductfeaturePage.getContents().getText(), "com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProductfeaturePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProductfeaturePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeature.EditProductfeaturePage", "com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeature.EditProductfeaturePage", "com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditProductfeaturePage_ProductfeatureEditor_productfeatureEditor(instance));
      }
    ...
    templateFieldsMap.put("productfeatureEditor", TemplateWidgetMapper.get(EditProductfeaturePage_ProductfeatureEditor_productfeatureEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProductfeaturePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditProductfeaturePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditProductfeaturePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditProductfeaturePage instance) {
  ...
  native static ProductfeatureEditor EditProductfeaturePage_ProductfeatureEditor_productfeatureEditor(EditProductfeaturePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeature.EditProductfeaturePage::productfeatureEditor;
  }-*/;

  native static void EditProductfeaturePage_ProductfeatureEditor_productfeatureEditor(EditProductfeaturePage instance, ProductfeatureEditor value) /*-{
    instance.@com.cloderia.helion.client.local.productfeature.EditProductfeaturePage::productfeatureEditor = value;
  }-*/;
