...
public class Type_factory__c_c_h_c_l_b_CreateBudgetPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateBudgetPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateBudgetPage.class, "Type_factory__c_c_h_c_l_b_CreateBudgetPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_CreateBudgetPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/budget/edit-budget-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_CreateBudgetPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateBudgetPage.class);
  ...
  public CreateBudgetPage createInstance(final ContextManager contextManager) {
    final CreateBudgetPage instance = new CreateBudgetPage();
    ...
    final BudgetEditor CreateBudgetPage_budgetEditor = (BudgetEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_b_BudgetEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateBudgetPage_budgetEditor);
    CreateBudgetPage_BudgetEditor_budgetEditor(instance, CreateBudgetPage_budgetEditor);
    ...
    c_c_h_c_l_b_CreateBudgetPageTemplateResource templateForCreateBudgetPage = GWT.create(c_c_h_c_l_b_CreateBudgetPageTemplateResource.class);
    Element parentElementForTemplateOfCreateBudgetPage = TemplateUtil.getRootTemplateParentElement(templateForCreateBudgetPage.getContents().getText(), "com/cloderia/helion/client/local/budget/edit-budget-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/budget/edit-budget-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateBudgetPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateBudgetPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budget.CreateBudgetPage", "com/cloderia/helion/client/local/budget/edit-budget-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budget.CreateBudgetPage", "com/cloderia/helion/client/local/budget/edit-budget-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateBudgetPage_BudgetEditor_budgetEditor(instance));
      }
    ...
    templateFieldsMap.put("budgetEditor", TemplateWidgetMapper.get(CreateBudgetPage_BudgetEditor_budgetEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateBudgetPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateBudgetPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateBudgetPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateBudgetPage instance) {
  ...
  native static BudgetEditor CreateBudgetPage_BudgetEditor_budgetEditor(CreateBudgetPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.budget.CreateBudgetPage::budgetEditor;
  }-*/;

  native static void CreateBudgetPage_BudgetEditor_budgetEditor(CreateBudgetPage instance, BudgetEditor value) /*-{
    instance.@com.cloderia.helion.client.local.budget.CreateBudgetPage::budgetEditor = value;
  }-*/;
