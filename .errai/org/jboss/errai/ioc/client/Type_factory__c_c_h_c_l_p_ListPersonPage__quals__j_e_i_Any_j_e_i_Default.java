...
public class Type_factory__c_c_h_c_l_p_ListPersonPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListPersonPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListPersonPage.class, "Type_factory__c_c_h_c_l_p_ListPersonPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ListPersonPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/person/list-person-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ListPersonPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListPersonPage.class);
  ...
  public ListPersonPage createInstance(final ContextManager contextManager) {
    final ListPersonPage instance = new ListPersonPage();
    ...
    final PersonListWidget ListPersonPage_listWidget = (PersonListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PersonListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListPersonPage_listWidget);
    ListPersonPage_PersonListWidget_listWidget(instance, ListPersonPage_listWidget);
    ...
    c_c_h_c_l_p_ListPersonPageTemplateResource templateForListPersonPage = GWT.create(c_c_h_c_l_p_ListPersonPageTemplateResource.class);
    Element parentElementForTemplateOfListPersonPage = TemplateUtil.getRootTemplateParentElement(templateForListPersonPage.getContents().getText(), "com/cloderia/helion/client/local/person/list-person-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/person/list-person-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPersonPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPersonPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.person.ListPersonPage", "com/cloderia/helion/client/local/person/list-person-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.person.ListPersonPage", "com/cloderia/helion/client/local/person/list-person-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListPersonPage_PersonListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.person.ListPersonPage", "com/cloderia/helion/client/local/person/list-person-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListPersonPage_AnchorElement_createNewPersonLink(instance));
      }
    }, dataFieldElements, "createNewPersonLink");
    ...
    templateFieldsMap.put("listWidget", ListPersonPage_PersonListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewPersonLink", ElementWrapperWidget.getWidget(ListPersonPage_AnchorElement_createNewPersonLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPersonPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewPersonLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListPersonPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListPersonPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListPersonPage_AnchorElement_createNewPersonLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListPersonPage instance) {
  ...
  native static PersonListWidget ListPersonPage_PersonListWidget_listWidget(ListPersonPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.person.ListPersonPage::listWidget;
  }-*/;

  native static void ListPersonPage_PersonListWidget_listWidget(ListPersonPage instance, PersonListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.person.ListPersonPage::listWidget = value;
  }-*/;

  native static AnchorElement ListPersonPage_AnchorElement_createNewPersonLink(ListPersonPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.person.ListPersonPage::createNewPersonLink;
  }-*/;

  native static void ListPersonPage_AnchorElement_createNewPersonLink(ListPersonPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.person.ListPersonPage::createNewPersonLink = value;
  }-*/;
