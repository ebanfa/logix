...
public class Type_factory__c_c_h_c_l_i_EditInventoryitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditInventoryitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditInventoryitemPage.class, "Type_factory__c_c_h_c_l_i_EditInventoryitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_EditInventoryitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_EditInventoryitemPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditInventoryitemPage.class);
  ...
  public EditInventoryitemPage createInstance(final ContextManager contextManager) {
    final EditInventoryitemPage instance = new EditInventoryitemPage();
    setIncompleteInstance(instance);
    final InventoryitemEditor EditInventoryitemPage_inventoryitemEditor = (InventoryitemEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InventoryitemEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditInventoryitemPage_inventoryitemEditor);
    EditInventoryitemPage_InventoryitemEditor_inventoryitemEditor(instance, EditInventoryitemPage_inventoryitemEditor);
    ...
    c_c_h_c_l_i_EditInventoryitemPageTemplateResource templateForEditInventoryitemPage = GWT.create(c_c_h_c_l_i_EditInventoryitemPageTemplateResource.class);
    Element parentElementForTemplateOfEditInventoryitemPage = TemplateUtil.getRootTemplateParentElement(templateForEditInventoryitemPage.getContents().getText(), "com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInventoryitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInventoryitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.inventoryitem.EditInventoryitemPage", "com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.inventoryitem.EditInventoryitemPage", "com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditInventoryitemPage_InventoryitemEditor_inventoryitemEditor(instance));
      }
    ...
    templateFieldsMap.put("inventoryitemEditor", TemplateWidgetMapper.get(EditInventoryitemPage_InventoryitemEditor_inventoryitemEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInventoryitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditInventoryitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditInventoryitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditInventoryitemPage instance) {
  ...
  native static InventoryitemEditor EditInventoryitemPage_InventoryitemEditor_inventoryitemEditor(EditInventoryitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.inventoryitem.EditInventoryitemPage::inventoryitemEditor;
  }-*/;

  native static void EditInventoryitemPage_InventoryitemEditor_inventoryitemEditor(EditInventoryitemPage instance, InventoryitemEditor value) /*-{
    instance.@com.cloderia.helion.client.local.inventoryitem.EditInventoryitemPage::inventoryitemEditor = value;
  }-*/;
