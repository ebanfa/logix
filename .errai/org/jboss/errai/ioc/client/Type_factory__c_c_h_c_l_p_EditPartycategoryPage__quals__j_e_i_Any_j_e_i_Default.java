...
public class Type_factory__c_c_h_c_l_p_EditPartycategoryPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditPartycategoryPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditPartycategoryPage.class, "Type_factory__c_c_h_c_l_p_EditPartycategoryPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditPartycategoryPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditPartycategoryPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditPartycategoryPage.class);
  ...
  public EditPartycategoryPage createInstance(final ContextManager contextManager) {
    final EditPartycategoryPage instance = new EditPartycategoryPage();
    ...
    final PartycategoryEditor EditPartycategoryPage_partycategoryEditor = (PartycategoryEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartycategoryEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditPartycategoryPage_partycategoryEditor);
    EditPartycategoryPage_PartycategoryEditor_partycategoryEditor(instance, EditPartycategoryPage_partycategoryEditor);
    ...
    c_c_h_c_l_p_EditPartycategoryPageTemplateResource templateForEditPartycategoryPage = GWT.create(c_c_h_c_l_p_EditPartycategoryPageTemplateResource.class);
    Element parentElementForTemplateOfEditPartycategoryPage = TemplateUtil.getRootTemplateParentElement(templateForEditPartycategoryPage.getContents().getText(), "com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartycategoryPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartycategoryPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partycategory.EditPartycategoryPage", "com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partycategory.EditPartycategoryPage", "com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditPartycategoryPage_PartycategoryEditor_partycategoryEditor(instance));
      }
    ...
    templateFieldsMap.put("partycategoryEditor", TemplateWidgetMapper.get(EditPartycategoryPage_PartycategoryEditor_partycategoryEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartycategoryPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditPartycategoryPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditPartycategoryPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditPartycategoryPage instance) {
  ...
  native static PartycategoryEditor EditPartycategoryPage_PartycategoryEditor_partycategoryEditor(EditPartycategoryPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partycategory.EditPartycategoryPage::partycategoryEditor;
  }-*/;

  native static void EditPartycategoryPage_PartycategoryEditor_partycategoryEditor(EditPartycategoryPage instance, PartycategoryEditor value) /*-{
    instance.@com.cloderia.helion.client.local.partycategory.EditPartycategoryPage::partycategoryEditor = value;
  }-*/;
