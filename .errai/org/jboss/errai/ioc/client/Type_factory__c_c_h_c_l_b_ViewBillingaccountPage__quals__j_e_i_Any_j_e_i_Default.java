...
public class Type_factory__c_c_h_c_l_b_ViewBillingaccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewBillingaccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewBillingaccountPage.class, "Type_factory__c_c_h_c_l_b_ViewBillingaccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_ViewBillingaccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/billingaccount/view-billingaccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_ViewBillingaccountPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewBillingaccountPage.class);
  ...
  public ViewBillingaccountPage createInstance(final ContextManager contextManager) {
    final ViewBillingaccountPage instance = new ViewBillingaccountPage();
    ...
    final BillingaccountDisplay ViewBillingaccountPage_entityDisplayComponent = (BillingaccountDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_b_BillingaccountDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewBillingaccountPage_entityDisplayComponent);
    ViewBillingaccountPage_BillingaccountDisplay_entityDisplayComponent(instance, ViewBillingaccountPage_entityDisplayComponent);
    ...
    final DataBinder ViewBillingaccountPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Billingaccount.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewBillingaccountPage_binder);
    ViewBillingaccountPage_DataBinder_binder(instance, ViewBillingaccountPage_binder);
    ...
    c_c_h_c_l_b_ViewBillingaccountPageTemplateResource templateForViewBillingaccountPage = GWT.create(c_c_h_c_l_b_ViewBillingaccountPageTemplateResource.class);
    Element parentElementForTemplateOfViewBillingaccountPage = TemplateUtil.getRootTemplateParentElement(templateForViewBillingaccountPage.getContents().getText(), "com/cloderia/helion/client/local/billingaccount/view-billingaccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/billingaccount/view-billingaccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewBillingaccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewBillingaccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.billingaccount.ViewBillingaccountPage", "com/cloderia/helion/client/local/billingaccount/view-billingaccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.billingaccount.ViewBillingaccountPage", "com/cloderia/helion/client/local/billingaccount/view-billingaccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewBillingaccountPage_BillingaccountDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewBillingaccountPage_BillingaccountDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewBillingaccountPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewBillingaccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewBillingaccountPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewBillingaccountPage instance) {
  ...
  native static DataBinder ViewBillingaccountPage_DataBinder_binder(ViewBillingaccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.billingaccount.ViewBillingaccountPage::binder;
  }-*/;

  native static void ViewBillingaccountPage_DataBinder_binder(ViewBillingaccountPage instance, DataBinder<Billingaccount> value) /*-{
    instance.@com.cloderia.helion.client.local.billingaccount.ViewBillingaccountPage::binder = value;
  }-*/;

  native static BillingaccountDisplay ViewBillingaccountPage_BillingaccountDisplay_entityDisplayComponent(ViewBillingaccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.billingaccount.ViewBillingaccountPage::entityDisplayComponent;
  }-*/;

  native static void ViewBillingaccountPage_BillingaccountDisplay_entityDisplayComponent(ViewBillingaccountPage instance, BillingaccountDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.billingaccount.ViewBillingaccountPage::entityDisplayComponent = value;
  }-*/;
