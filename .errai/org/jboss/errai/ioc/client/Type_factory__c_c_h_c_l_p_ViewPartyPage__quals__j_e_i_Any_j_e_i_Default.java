...
public class Type_factory__c_c_h_c_l_p_ViewPartyPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewPartyPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewPartyPage.class, "Type_factory__c_c_h_c_l_p_ViewPartyPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewPartyPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/party/view-party-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewPartyPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewPartyPage.class);
  ...
  public ViewPartyPage createInstance(final ContextManager contextManager) {
    final ViewPartyPage instance = new ViewPartyPage();
    ...
    final PartyDisplay ViewPartyPage_entityDisplayComponent = (PartyDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartyDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewPartyPage_entityDisplayComponent);
    ViewPartyPage_PartyDisplay_entityDisplayComponent(instance, ViewPartyPage_entityDisplayComponent);
    ...
    final DataBinder ViewPartyPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Party.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewPartyPage_binder);
    ViewPartyPage_DataBinder_binder(instance, ViewPartyPage_binder);
    ...
    c_c_h_c_l_p_ViewPartyPageTemplateResource templateForViewPartyPage = GWT.create(c_c_h_c_l_p_ViewPartyPageTemplateResource.class);
    Element parentElementForTemplateOfViewPartyPage = TemplateUtil.getRootTemplateParentElement(templateForViewPartyPage.getContents().getText(), "com/cloderia/helion/client/local/party/view-party-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/party/view-party-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartyPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartyPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.party.ViewPartyPage", "com/cloderia/helion/client/local/party/view-party-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.party.ViewPartyPage", "com/cloderia/helion/client/local/party/view-party-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewPartyPage_PartyDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewPartyPage_PartyDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartyPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewPartyPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewPartyPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewPartyPage instance) {
  ...
  native static PartyDisplay ViewPartyPage_PartyDisplay_entityDisplayComponent(ViewPartyPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.party.ViewPartyPage::entityDisplayComponent;
  }-*/;

  native static void ViewPartyPage_PartyDisplay_entityDisplayComponent(ViewPartyPage instance, PartyDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.party.ViewPartyPage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewPartyPage_DataBinder_binder(ViewPartyPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.party.ViewPartyPage::binder;
  }-*/;

  native static void ViewPartyPage_DataBinder_binder(ViewPartyPage instance, DataBinder<Party> value) /*-{
    instance.@com.cloderia.helion.client.local.party.ViewPartyPage::binder = value;
  }-*/;
