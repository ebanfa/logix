...
public class Type_factory__c_c_h_c_l_g_EditGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditGeneralledgeraccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditGeneralledgeraccountPage.class, "Type_factory__c_c_h_c_l_g_EditGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_g_EditGeneralledgeraccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_g_EditGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditGeneralledgeraccountPage.class);
  ...
  public EditGeneralledgeraccountPage createInstance(final ContextManager contextManager) {
    final EditGeneralledgeraccountPage instance = new EditGeneralledgeraccountPage();
    ...
    final GeneralledgeraccountEditor EditGeneralledgeraccountPage_generalledgeraccountEditor = (GeneralledgeraccountEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_g_GeneralledgeraccountEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditGeneralledgeraccountPage_generalledgeraccountEditor);
    EditGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(instance, EditGeneralledgeraccountPage_generalledgeraccountEditor);
    ...
    c_c_h_c_l_g_EditGeneralledgeraccountPageTemplateResource templateForEditGeneralledgeraccountPage = GWT.create(c_c_h_c_l_g_EditGeneralledgeraccountPageTemplateResource.class);
    Element parentElementForTemplateOfEditGeneralledgeraccountPage = TemplateUtil.getRootTemplateParentElement(templateForEditGeneralledgeraccountPage.getContents().getText(), "com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditGeneralledgeraccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditGeneralledgeraccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccount.EditGeneralledgeraccountPage", "com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccount.EditGeneralledgeraccountPage", "com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(instance));
      }
    ...
    templateFieldsMap.put("generalledgeraccountEditor", TemplateWidgetMapper.get(EditGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditGeneralledgeraccountPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditGeneralledgeraccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditGeneralledgeraccountPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditGeneralledgeraccountPage instance) {
  ...
  native static GeneralledgeraccountEditor EditGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(EditGeneralledgeraccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccount.EditGeneralledgeraccountPage::generalledgeraccountEditor;
  }-*/;

  native static void EditGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(EditGeneralledgeraccountPage instance, GeneralledgeraccountEditor value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccount.EditGeneralledgeraccountPage::generalledgeraccountEditor = value;
  }-*/;
