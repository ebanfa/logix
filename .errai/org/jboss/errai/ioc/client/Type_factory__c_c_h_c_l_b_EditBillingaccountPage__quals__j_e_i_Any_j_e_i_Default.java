...
public class Type_factory__c_c_h_c_l_b_EditBillingaccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditBillingaccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditBillingaccountPage.class, "Type_factory__c_c_h_c_l_b_EditBillingaccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_EditBillingaccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_EditBillingaccountPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditBillingaccountPage.class);
  ...
  public EditBillingaccountPage createInstance(final ContextManager contextManager) {
    final EditBillingaccountPage instance = new EditBillingaccountPage();
    ...
    final BillingaccountEditor EditBillingaccountPage_billingaccountEditor = (BillingaccountEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_b_BillingaccountEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditBillingaccountPage_billingaccountEditor);
    EditBillingaccountPage_BillingaccountEditor_billingaccountEditor(instance, EditBillingaccountPage_billingaccountEditor);
    ...
    c_c_h_c_l_b_EditBillingaccountPageTemplateResource templateForEditBillingaccountPage = GWT.create(c_c_h_c_l_b_EditBillingaccountPageTemplateResource.class);
    Element parentElementForTemplateOfEditBillingaccountPage = TemplateUtil.getRootTemplateParentElement(templateForEditBillingaccountPage.getContents().getText(), "com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditBillingaccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditBillingaccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.billingaccount.EditBillingaccountPage", "com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.billingaccount.EditBillingaccountPage", "com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditBillingaccountPage_BillingaccountEditor_billingaccountEditor(instance));
      }
    ...
    templateFieldsMap.put("billingaccountEditor", TemplateWidgetMapper.get(EditBillingaccountPage_BillingaccountEditor_billingaccountEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditBillingaccountPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditBillingaccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditBillingaccountPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditBillingaccountPage instance) {
  ...
  native static BillingaccountEditor EditBillingaccountPage_BillingaccountEditor_billingaccountEditor(EditBillingaccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.billingaccount.EditBillingaccountPage::billingaccountEditor;
  }-*/;

  native static void EditBillingaccountPage_BillingaccountEditor_billingaccountEditor(EditBillingaccountPage instance, BillingaccountEditor value) /*-{
    instance.@com.cloderia.helion.client.local.billingaccount.EditBillingaccountPage::billingaccountEditor = value;
  }-*/;
