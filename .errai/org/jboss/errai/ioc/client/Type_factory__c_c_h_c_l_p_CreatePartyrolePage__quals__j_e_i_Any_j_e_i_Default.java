...
public class Type_factory__c_c_h_c_l_p_CreatePartyrolePage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreatePartyrolePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreatePartyrolePage.class, "Type_factory__c_c_h_c_l_p_CreatePartyrolePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_CreatePartyrolePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_CreatePartyrolePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreatePartyrolePage.class);
  ...
  public CreatePartyrolePage createInstance(final ContextManager contextManager) {
    final CreatePartyrolePage instance = new CreatePartyrolePage();
    ...
    final PartyroleEditor CreatePartyrolePage_partyroleEditor = (PartyroleEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartyroleEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreatePartyrolePage_partyroleEditor);
    CreatePartyrolePage_PartyroleEditor_partyroleEditor(instance, CreatePartyrolePage_partyroleEditor);
    ...
    c_c_h_c_l_p_CreatePartyrolePageTemplateResource templateForCreatePartyrolePage = GWT.create(c_c_h_c_l_p_CreatePartyrolePageTemplateResource.class);
    Element parentElementForTemplateOfCreatePartyrolePage = TemplateUtil.getRootTemplateParentElement(templateForCreatePartyrolePage.getContents().getText(), "com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePartyrolePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePartyrolePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyrole.CreatePartyrolePage", "com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyrole.CreatePartyrolePage", "com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreatePartyrolePage_PartyroleEditor_partyroleEditor(instance));
      }
    ...
    templateFieldsMap.put("partyroleEditor", TemplateWidgetMapper.get(CreatePartyrolePage_PartyroleEditor_partyroleEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePartyrolePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreatePartyrolePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreatePartyrolePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreatePartyrolePage instance) {
  ...
  native static PartyroleEditor CreatePartyrolePage_PartyroleEditor_partyroleEditor(CreatePartyrolePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partyrole.CreatePartyrolePage::partyroleEditor;
  }-*/;

  native static void CreatePartyrolePage_PartyroleEditor_partyroleEditor(CreatePartyrolePage instance, PartyroleEditor value) /*-{
    instance.@com.cloderia.helion.client.local.partyrole.CreatePartyrolePage::partyroleEditor = value;
  }-*/;
