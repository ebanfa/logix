...
public class Type_factory__c_c_h_c_l_b_ListBudgetPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListBudgetPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListBudgetPage.class, "Type_factory__c_c_h_c_l_b_ListBudgetPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_ListBudgetPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/budget/list-budget-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_ListBudgetPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListBudgetPage.class);
  ...
  public ListBudgetPage createInstance(final ContextManager contextManager) {
    final ListBudgetPage instance = new ListBudgetPage();
    ...
    final BudgetListWidget ListBudgetPage_listWidget = (BudgetListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_b_BudgetListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListBudgetPage_listWidget);
    ListBudgetPage_BudgetListWidget_listWidget(instance, ListBudgetPage_listWidget);
    ...
    c_c_h_c_l_b_ListBudgetPageTemplateResource templateForListBudgetPage = GWT.create(c_c_h_c_l_b_ListBudgetPageTemplateResource.class);
    Element parentElementForTemplateOfListBudgetPage = TemplateUtil.getRootTemplateParentElement(templateForListBudgetPage.getContents().getText(), "com/cloderia/helion/client/local/budget/list-budget-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/budget/list-budget-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListBudgetPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListBudgetPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budget.ListBudgetPage", "com/cloderia/helion/client/local/budget/list-budget-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budget.ListBudgetPage", "com/cloderia/helion/client/local/budget/list-budget-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListBudgetPage_BudgetListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budget.ListBudgetPage", "com/cloderia/helion/client/local/budget/list-budget-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListBudgetPage_AnchorElement_createNewBudgetLink(instance));
      }
    }, dataFieldElements, "createNewBudgetLink");
    ...
    templateFieldsMap.put("listWidget", ListBudgetPage_BudgetListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewBudgetLink", ElementWrapperWidget.getWidget(ListBudgetPage_AnchorElement_createNewBudgetLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListBudgetPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewBudgetLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListBudgetPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListBudgetPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListBudgetPage_AnchorElement_createNewBudgetLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListBudgetPage instance) {
  ...
  native static AnchorElement ListBudgetPage_AnchorElement_createNewBudgetLink(ListBudgetPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.budget.ListBudgetPage::createNewBudgetLink;
  }-*/;

  native static void ListBudgetPage_AnchorElement_createNewBudgetLink(ListBudgetPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.budget.ListBudgetPage::createNewBudgetLink = value;
  }-*/;
  ...
  native static BudgetListWidget ListBudgetPage_BudgetListWidget_listWidget(ListBudgetPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.budget.ListBudgetPage::listWidget;
  }-*/;

  native static void ListBudgetPage_BudgetListWidget_listWidget(ListBudgetPage instance, BudgetListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.budget.ListBudgetPage::listWidget = value;
  }-*/;
