...
public class Type_factory__c_c_h_c_l_p_BaseProductcategoryPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseProductcategoryPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseProductcategoryPage.class, "Type_factory__c_c_h_c_l_p_BaseProductcategoryPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BaseProductcategoryPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productcategory/edit-productcategory-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BaseProductcategoryPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseProductcategoryPage createInstance(final ContextManager contextManager) {
    final BaseProductcategoryPage instance = new BaseProductcategoryPage();
    ...
    c_c_h_c_l_p_BaseProductcategoryPageTemplateResource templateForBaseProductcategoryPage = GWT.create(c_c_h_c_l_p_BaseProductcategoryPageTemplateResource.class);
    Element parentElementForTemplateOfBaseProductcategoryPage = TemplateUtil.getRootTemplateParentElement(templateForBaseProductcategoryPage.getContents().getText(), "com/cloderia/helion/client/local/productcategory/edit-productcategory-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productcategory/edit-productcategory-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProductcategoryPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProductcategoryPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productcategory.BaseProductcategoryPage", "com/cloderia/helion/client/local/productcategory/edit-productcategory-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProductcategoryPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseProductcategoryPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseProductcategoryPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseProductcategoryPage instance) {
