...
public class Type_factory__c_c_h_c_l_f_EditFacilitytypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditFacilitytypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditFacilitytypePage.class, "Type_factory__c_c_h_c_l_f_EditFacilitytypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_f_EditFacilitytypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/facilitytype/edit-facilitytype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_f_EditFacilitytypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditFacilitytypePage.class);
  ...
  public EditFacilitytypePage createInstance(final ContextManager contextManager) {
    final EditFacilitytypePage instance = new EditFacilitytypePage();
    ...
    final FacilitytypeEditor EditFacilitytypePage_facilitytypeEditor = (FacilitytypeEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_f_FacilitytypeEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditFacilitytypePage_facilitytypeEditor);
    EditFacilitytypePage_FacilitytypeEditor_facilitytypeEditor(instance, EditFacilitytypePage_facilitytypeEditor);
    ...
    c_c_h_c_l_f_EditFacilitytypePageTemplateResource templateForEditFacilitytypePage = GWT.create(c_c_h_c_l_f_EditFacilitytypePageTemplateResource.class);
    Element parentElementForTemplateOfEditFacilitytypePage = TemplateUtil.getRootTemplateParentElement(templateForEditFacilitytypePage.getContents().getText(), "com/cloderia/helion/client/local/facilitytype/edit-facilitytype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/facilitytype/edit-facilitytype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditFacilitytypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditFacilitytypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facilitytype.EditFacilitytypePage", "com/cloderia/helion/client/local/facilitytype/edit-facilitytype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facilitytype.EditFacilitytypePage", "com/cloderia/helion/client/local/facilitytype/edit-facilitytype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditFacilitytypePage_FacilitytypeEditor_facilitytypeEditor(instance));
      }
    ...
    templateFieldsMap.put("facilitytypeEditor", TemplateWidgetMapper.get(EditFacilitytypePage_FacilitytypeEditor_facilitytypeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditFacilitytypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditFacilitytypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditFacilitytypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditFacilitytypePage instance) {
  ...
  native static FacilitytypeEditor EditFacilitytypePage_FacilitytypeEditor_facilitytypeEditor(EditFacilitytypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facilitytype.EditFacilitytypePage::facilitytypeEditor;
  }-*/;

  native static void EditFacilitytypePage_FacilitytypeEditor_facilitytypeEditor(EditFacilitytypePage instance, FacilitytypeEditor value) /*-{
    instance.@com.cloderia.helion.client.local.facilitytype.EditFacilitytypePage::facilitytypeEditor = value;
  }-*/;
