...
public class Type_factory__c_c_h_c_l_b_BaseBudgetitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseBudgetitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseBudgetitemPage.class, "Type_factory__c_c_h_c_l_b_BaseBudgetitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_BaseBudgetitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/budgetitem/edit-budgetitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_BaseBudgetitemPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseBudgetitemPage createInstance(final ContextManager contextManager) {
    final BaseBudgetitemPage instance = new BaseBudgetitemPage();
    ...
    c_c_h_c_l_b_BaseBudgetitemPageTemplateResource templateForBaseBudgetitemPage = GWT.create(c_c_h_c_l_b_BaseBudgetitemPageTemplateResource.class);
    Element parentElementForTemplateOfBaseBudgetitemPage = TemplateUtil.getRootTemplateParentElement(templateForBaseBudgetitemPage.getContents().getText(), "com/cloderia/helion/client/local/budgetitem/edit-budgetitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/budgetitem/edit-budgetitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseBudgetitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseBudgetitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budgetitem.BaseBudgetitemPage", "com/cloderia/helion/client/local/budgetitem/edit-budgetitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseBudgetitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseBudgetitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseBudgetitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseBudgetitemPage instance) {
