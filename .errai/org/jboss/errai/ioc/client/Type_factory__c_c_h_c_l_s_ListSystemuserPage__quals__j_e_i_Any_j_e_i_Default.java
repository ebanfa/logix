...
public class Type_factory__c_c_h_c_l_s_ListSystemuserPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListSystemuserPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListSystemuserPage.class, "Type_factory__c_c_h_c_l_s_ListSystemuserPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_s_ListSystemuserPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/systemuser/list-systemuser-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_s_ListSystemuserPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListSystemuserPage.class);
  ...
  public ListSystemuserPage createInstance(final ContextManager contextManager) {
    final ListSystemuserPage instance = new ListSystemuserPage();
    ...
    final SystemuserListWidget ListSystemuserPage_listWidget = (SystemuserListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_s_SystemuserListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListSystemuserPage_listWidget);
    ListSystemuserPage_SystemuserListWidget_listWidget(instance, ListSystemuserPage_listWidget);
    ...
    c_c_h_c_l_s_ListSystemuserPageTemplateResource templateForListSystemuserPage = GWT.create(c_c_h_c_l_s_ListSystemuserPageTemplateResource.class);
    Element parentElementForTemplateOfListSystemuserPage = TemplateUtil.getRootTemplateParentElement(templateForListSystemuserPage.getContents().getText(), "com/cloderia/helion/client/local/systemuser/list-systemuser-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/systemuser/list-systemuser-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListSystemuserPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListSystemuserPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.systemuser.ListSystemuserPage", "com/cloderia/helion/client/local/systemuser/list-systemuser-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.systemuser.ListSystemuserPage", "com/cloderia/helion/client/local/systemuser/list-systemuser-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListSystemuserPage_SystemuserListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.systemuser.ListSystemuserPage", "com/cloderia/helion/client/local/systemuser/list-systemuser-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListSystemuserPage_AnchorElement_createNewSystemuserLink(instance));
      }
    }, dataFieldElements, "createNewSystemuserLink");
    ...
    templateFieldsMap.put("listWidget", ListSystemuserPage_SystemuserListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewSystemuserLink", ElementWrapperWidget.getWidget(ListSystemuserPage_AnchorElement_createNewSystemuserLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListSystemuserPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewSystemuserLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListSystemuserPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListSystemuserPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListSystemuserPage_AnchorElement_createNewSystemuserLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListSystemuserPage instance) {
  ...
  native static AnchorElement ListSystemuserPage_AnchorElement_createNewSystemuserLink(ListSystemuserPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.systemuser.ListSystemuserPage::createNewSystemuserLink;
  }-*/;

  native static void ListSystemuserPage_AnchorElement_createNewSystemuserLink(ListSystemuserPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.systemuser.ListSystemuserPage::createNewSystemuserLink = value;
  }-*/;
  ...
  native static SystemuserListWidget ListSystemuserPage_SystemuserListWidget_listWidget(ListSystemuserPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.systemuser.ListSystemuserPage::listWidget;
  }-*/;

  native static void ListSystemuserPage_SystemuserListWidget_listWidget(ListSystemuserPage instance, SystemuserListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.systemuser.ListSystemuserPage::listWidget = value;
  }-*/;
