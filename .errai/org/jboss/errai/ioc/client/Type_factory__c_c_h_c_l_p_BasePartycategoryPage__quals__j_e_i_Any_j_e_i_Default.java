...
public class Type_factory__c_c_h_c_l_p_BasePartycategoryPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BasePartycategoryPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BasePartycategoryPage.class, "Type_factory__c_c_h_c_l_p_BasePartycategoryPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BasePartycategoryPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BasePartycategoryPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BasePartycategoryPage createInstance(final ContextManager contextManager) {
    final BasePartycategoryPage instance = new BasePartycategoryPage();
    ...
    c_c_h_c_l_p_BasePartycategoryPageTemplateResource templateForBasePartycategoryPage = GWT.create(c_c_h_c_l_p_BasePartycategoryPageTemplateResource.class);
    Element parentElementForTemplateOfBasePartycategoryPage = TemplateUtil.getRootTemplateParentElement(templateForBasePartycategoryPage.getContents().getText(), "com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartycategoryPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartycategoryPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partycategory.BasePartycategoryPage", "com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartycategoryPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BasePartycategoryPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BasePartycategoryPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BasePartycategoryPage instance) {
