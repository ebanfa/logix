...
public class Type_factory__c_c_h_c_l_p_BaseProductfeaturePage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseProductfeaturePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseProductfeaturePage.class, "Type_factory__c_c_h_c_l_p_BaseProductfeaturePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BaseProductfeaturePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BaseProductfeaturePage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseProductfeaturePage createInstance(final ContextManager contextManager) {
    final BaseProductfeaturePage instance = new BaseProductfeaturePage();
    ...
    c_c_h_c_l_p_BaseProductfeaturePageTemplateResource templateForBaseProductfeaturePage = GWT.create(c_c_h_c_l_p_BaseProductfeaturePageTemplateResource.class);
    Element parentElementForTemplateOfBaseProductfeaturePage = TemplateUtil.getRootTemplateParentElement(templateForBaseProductfeaturePage.getContents().getText(), "com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProductfeaturePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProductfeaturePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeature.BaseProductfeaturePage", "com/cloderia/helion/client/local/productfeature/edit-productfeature-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProductfeaturePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseProductfeaturePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseProductfeaturePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseProductfeaturePage instance) {
