...
public class Type_factory__c_c_h_c_l_p_EditProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditProductfeaturetypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditProductfeaturetypePage.class, "Type_factory__c_c_h_c_l_p_EditProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditProductfeaturetypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditProductfeaturetypePage.class);
  ...
  public EditProductfeaturetypePage createInstance(final ContextManager contextManager) {
    final EditProductfeaturetypePage instance = new EditProductfeaturetypePage();
    ...
    final ProductfeaturetypeEditor EditProductfeaturetypePage_productfeaturetypeEditor = (ProductfeaturetypeEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductfeaturetypeEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditProductfeaturetypePage_productfeaturetypeEditor);
    EditProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(instance, EditProductfeaturetypePage_productfeaturetypeEditor);
    ...
    c_c_h_c_l_p_EditProductfeaturetypePageTemplateResource templateForEditProductfeaturetypePage = GWT.create(c_c_h_c_l_p_EditProductfeaturetypePageTemplateResource.class);
    Element parentElementForTemplateOfEditProductfeaturetypePage = TemplateUtil.getRootTemplateParentElement(templateForEditProductfeaturetypePage.getContents().getText(), "com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProductfeaturetypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProductfeaturetypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeaturetype.EditProductfeaturetypePage", "com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeaturetype.EditProductfeaturetypePage", "com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(instance));
      }
    ...
    templateFieldsMap.put("productfeaturetypeEditor", TemplateWidgetMapper.get(EditProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProductfeaturetypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditProductfeaturetypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditProductfeaturetypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditProductfeaturetypePage instance) {
  ...
  native static ProductfeaturetypeEditor EditProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(EditProductfeaturetypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeaturetype.EditProductfeaturetypePage::productfeaturetypeEditor;
  }-*/;

  native static void EditProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(EditProductfeaturetypePage instance, ProductfeaturetypeEditor value) /*-{
    instance.@com.cloderia.helion.client.local.productfeaturetype.EditProductfeaturetypePage::productfeaturetypeEditor = value;
  }-*/;
