...
public class Type_factory__c_c_h_c_l_i_EditInvoicetermPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditInvoicetermPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditInvoicetermPage.class, "Type_factory__c_c_h_c_l_i_EditInvoicetermPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_EditInvoicetermPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_EditInvoicetermPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditInvoicetermPage.class);
  ...
  public EditInvoicetermPage createInstance(final ContextManager contextManager) {
    final EditInvoicetermPage instance = new EditInvoicetermPage();
    ...
    final InvoicetermEditor EditInvoicetermPage_invoicetermEditor = (InvoicetermEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InvoicetermEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditInvoicetermPage_invoicetermEditor);
    EditInvoicetermPage_InvoicetermEditor_invoicetermEditor(instance, EditInvoicetermPage_invoicetermEditor);
    ...
    c_c_h_c_l_i_EditInvoicetermPageTemplateResource templateForEditInvoicetermPage = GWT.create(c_c_h_c_l_i_EditInvoicetermPageTemplateResource.class);
    Element parentElementForTemplateOfEditInvoicetermPage = TemplateUtil.getRootTemplateParentElement(templateForEditInvoicetermPage.getContents().getText(), "com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInvoicetermPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInvoicetermPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceterm.EditInvoicetermPage", "com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceterm.EditInvoicetermPage", "com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditInvoicetermPage_InvoicetermEditor_invoicetermEditor(instance));
      }
    ...
    templateFieldsMap.put("invoicetermEditor", TemplateWidgetMapper.get(EditInvoicetermPage_InvoicetermEditor_invoicetermEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInvoicetermPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditInvoicetermPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditInvoicetermPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditInvoicetermPage instance) {
  ...
  native static InvoicetermEditor EditInvoicetermPage_InvoicetermEditor_invoicetermEditor(EditInvoicetermPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoiceterm.EditInvoicetermPage::invoicetermEditor;
  }-*/;

  native static void EditInvoicetermPage_InvoicetermEditor_invoicetermEditor(EditInvoicetermPage instance, InvoicetermEditor value) /*-{
    instance.@com.cloderia.helion.client.local.invoiceterm.EditInvoicetermPage::invoicetermEditor = value;
  }-*/;
