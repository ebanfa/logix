...
public class Type_factory__c_c_h_c_l_p_ViewPaymentPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewPaymentPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewPaymentPage.class, "Type_factory__c_c_h_c_l_p_ViewPaymentPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewPaymentPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/payment/view-payment-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewPaymentPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewPaymentPage.class);
  ...
  public ViewPaymentPage createInstance(final ContextManager contextManager) {
    final ViewPaymentPage instance = new ViewPaymentPage();
    ...
    final DataBinder ViewPaymentPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Payment.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewPaymentPage_binder);
    ViewPaymentPage_DataBinder_binder(instance, ViewPaymentPage_binder);
    final PaymentDisplay ViewPaymentPage_entityDisplayComponent = (PaymentDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PaymentDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewPaymentPage_entityDisplayComponent);
    ViewPaymentPage_PaymentDisplay_entityDisplayComponent(instance, ViewPaymentPage_entityDisplayComponent);
    ...
    c_c_h_c_l_p_ViewPaymentPageTemplateResource templateForViewPaymentPage = GWT.create(c_c_h_c_l_p_ViewPaymentPageTemplateResource.class);
    Element parentElementForTemplateOfViewPaymentPage = TemplateUtil.getRootTemplateParentElement(templateForViewPaymentPage.getContents().getText(), "com/cloderia/helion/client/local/payment/view-payment-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/payment/view-payment-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPaymentPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPaymentPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.payment.ViewPaymentPage", "com/cloderia/helion/client/local/payment/view-payment-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.payment.ViewPaymentPage", "com/cloderia/helion/client/local/payment/view-payment-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewPaymentPage_PaymentDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewPaymentPage_PaymentDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPaymentPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewPaymentPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewPaymentPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewPaymentPage instance) {
  ...
  native static DataBinder ViewPaymentPage_DataBinder_binder(ViewPaymentPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.payment.ViewPaymentPage::binder;
  }-*/;

  native static void ViewPaymentPage_DataBinder_binder(ViewPaymentPage instance, DataBinder<Payment> value) /*-{
    instance.@com.cloderia.helion.client.local.payment.ViewPaymentPage::binder = value;
  }-*/;
  ...
  native static PaymentDisplay ViewPaymentPage_PaymentDisplay_entityDisplayComponent(ViewPaymentPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.payment.ViewPaymentPage::entityDisplayComponent;
  }-*/;

  native static void ViewPaymentPage_PaymentDisplay_entityDisplayComponent(ViewPaymentPage instance, PaymentDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.payment.ViewPaymentPage::entityDisplayComponent = value;
  }-*/;
