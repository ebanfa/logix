...
public class Type_factory__c_c_h_c_l_s_ViewSystemuserPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewSystemuserPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewSystemuserPage.class, "Type_factory__c_c_h_c_l_s_ViewSystemuserPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_s_ViewSystemuserPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/systemuser/view-systemuser-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_s_ViewSystemuserPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewSystemuserPage.class);
  ...
  public ViewSystemuserPage createInstance(final ContextManager contextManager) {
    final ViewSystemuserPage instance = new ViewSystemuserPage();
    setIncompleteInstance(instance);
    final DataBinder ViewSystemuserPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Systemuser.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewSystemuserPage_binder);
    ViewSystemuserPage_DataBinder_binder(instance, ViewSystemuserPage_binder);
    ...
    final SystemuserDisplay ViewSystemuserPage_entityDisplayComponent = (SystemuserDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_s_SystemuserDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewSystemuserPage_entityDisplayComponent);
    ViewSystemuserPage_SystemuserDisplay_entityDisplayComponent(instance, ViewSystemuserPage_entityDisplayComponent);
    ...
    c_c_h_c_l_s_ViewSystemuserPageTemplateResource templateForViewSystemuserPage = GWT.create(c_c_h_c_l_s_ViewSystemuserPageTemplateResource.class);
    Element parentElementForTemplateOfViewSystemuserPage = TemplateUtil.getRootTemplateParentElement(templateForViewSystemuserPage.getContents().getText(), "com/cloderia/helion/client/local/systemuser/view-systemuser-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/systemuser/view-systemuser-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewSystemuserPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewSystemuserPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.systemuser.ViewSystemuserPage", "com/cloderia/helion/client/local/systemuser/view-systemuser-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.systemuser.ViewSystemuserPage", "com/cloderia/helion/client/local/systemuser/view-systemuser-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewSystemuserPage_SystemuserDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewSystemuserPage_SystemuserDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewSystemuserPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewSystemuserPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewSystemuserPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewSystemuserPage instance) {
  ...
  native static DataBinder ViewSystemuserPage_DataBinder_binder(ViewSystemuserPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.systemuser.ViewSystemuserPage::binder;
  }-*/;

  native static void ViewSystemuserPage_DataBinder_binder(ViewSystemuserPage instance, DataBinder<Systemuser> value) /*-{
    instance.@com.cloderia.helion.client.local.systemuser.ViewSystemuserPage::binder = value;
  }-*/;

  native static SystemuserDisplay ViewSystemuserPage_SystemuserDisplay_entityDisplayComponent(ViewSystemuserPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.systemuser.ViewSystemuserPage::entityDisplayComponent;
  }-*/;

  native static void ViewSystemuserPage_SystemuserDisplay_entityDisplayComponent(ViewSystemuserPage instance, SystemuserDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.systemuser.ViewSystemuserPage::entityDisplayComponent = value;
  }-*/;
