...
public class Type_factory__c_c_h_c_l_g_ListGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListGeneralledgeraccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListGeneralledgeraccountPage.class, "Type_factory__c_c_h_c_l_g_ListGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_g_ListGeneralledgeraccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/generalledgeraccount/list-generalledgeraccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_g_ListGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListGeneralledgeraccountPage.class);
  ...
  public ListGeneralledgeraccountPage createInstance(final ContextManager contextManager) {
    final ListGeneralledgeraccountPage instance = new ListGeneralledgeraccountPage();
    ...
    final GeneralledgeraccountListWidget ListGeneralledgeraccountPage_listWidget = (GeneralledgeraccountListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_g_GeneralledgeraccountListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListGeneralledgeraccountPage_listWidget);
    ListGeneralledgeraccountPage_GeneralledgeraccountListWidget_listWidget(instance, ListGeneralledgeraccountPage_listWidget);
    ...
    c_c_h_c_l_g_ListGeneralledgeraccountPageTemplateResource templateForListGeneralledgeraccountPage = GWT.create(c_c_h_c_l_g_ListGeneralledgeraccountPageTemplateResource.class);
    Element parentElementForTemplateOfListGeneralledgeraccountPage = TemplateUtil.getRootTemplateParentElement(templateForListGeneralledgeraccountPage.getContents().getText(), "com/cloderia/helion/client/local/generalledgeraccount/list-generalledgeraccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/generalledgeraccount/list-generalledgeraccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListGeneralledgeraccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListGeneralledgeraccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccount.ListGeneralledgeraccountPage", "com/cloderia/helion/client/local/generalledgeraccount/list-generalledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccount.ListGeneralledgeraccountPage", "com/cloderia/helion/client/local/generalledgeraccount/list-generalledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListGeneralledgeraccountPage_GeneralledgeraccountListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccount.ListGeneralledgeraccountPage", "com/cloderia/helion/client/local/generalledgeraccount/list-generalledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListGeneralledgeraccountPage_AnchorElement_createNewGeneralledgeraccountLink(instance));
      }
    }, dataFieldElements, "createNewGeneralledgeraccountLink");
    ...
    templateFieldsMap.put("listWidget", ListGeneralledgeraccountPage_GeneralledgeraccountListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewGeneralledgeraccountLink", ElementWrapperWidget.getWidget(ListGeneralledgeraccountPage_AnchorElement_createNewGeneralledgeraccountLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListGeneralledgeraccountPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewGeneralledgeraccountLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListGeneralledgeraccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListGeneralledgeraccountPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListGeneralledgeraccountPage_AnchorElement_createNewGeneralledgeraccountLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListGeneralledgeraccountPage instance) {
  ...
  native static GeneralledgeraccountListWidget ListGeneralledgeraccountPage_GeneralledgeraccountListWidget_listWidget(ListGeneralledgeraccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccount.ListGeneralledgeraccountPage::listWidget;
  }-*/;

  native static void ListGeneralledgeraccountPage_GeneralledgeraccountListWidget_listWidget(ListGeneralledgeraccountPage instance, GeneralledgeraccountListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccount.ListGeneralledgeraccountPage::listWidget = value;
  }-*/;
  ...
  native static AnchorElement ListGeneralledgeraccountPage_AnchorElement_createNewGeneralledgeraccountLink(ListGeneralledgeraccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccount.ListGeneralledgeraccountPage::createNewGeneralledgeraccountLink;
  }-*/;

  native static void ListGeneralledgeraccountPage_AnchorElement_createNewGeneralledgeraccountLink(ListGeneralledgeraccountPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccount.ListGeneralledgeraccountPage::createNewGeneralledgeraccountLink = value;
  }-*/;
