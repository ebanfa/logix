...
public class Type_factory__c_c_h_c_l_p_ViewPartytypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewPartytypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewPartytypePage.class, "Type_factory__c_c_h_c_l_p_ViewPartytypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewPartytypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partytype/view-partytype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewPartytypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewPartytypePage.class);
  ...
  public ViewPartytypePage createInstance(final ContextManager contextManager) {
    final ViewPartytypePage instance = new ViewPartytypePage();
    ...
    final PartytypeDisplay ViewPartytypePage_entityDisplayComponent = (PartytypeDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartytypeDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewPartytypePage_entityDisplayComponent);
    ViewPartytypePage_PartytypeDisplay_entityDisplayComponent(instance, ViewPartytypePage_entityDisplayComponent);
    ...
    final DataBinder ViewPartytypePage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Partytype.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewPartytypePage_binder);
    ViewPartytypePage_DataBinder_binder(instance, ViewPartytypePage_binder);
    ...
    c_c_h_c_l_p_ViewPartytypePageTemplateResource templateForViewPartytypePage = GWT.create(c_c_h_c_l_p_ViewPartytypePageTemplateResource.class);
    Element parentElementForTemplateOfViewPartytypePage = TemplateUtil.getRootTemplateParentElement(templateForViewPartytypePage.getContents().getText(), "com/cloderia/helion/client/local/partytype/view-partytype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partytype/view-partytype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartytypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartytypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partytype.ViewPartytypePage", "com/cloderia/helion/client/local/partytype/view-partytype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partytype.ViewPartytypePage", "com/cloderia/helion/client/local/partytype/view-partytype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewPartytypePage_PartytypeDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewPartytypePage_PartytypeDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartytypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewPartytypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewPartytypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewPartytypePage instance) {
  ...
  native static DataBinder ViewPartytypePage_DataBinder_binder(ViewPartytypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partytype.ViewPartytypePage::binder;
  }-*/;

  native static void ViewPartytypePage_DataBinder_binder(ViewPartytypePage instance, DataBinder<Partytype> value) /*-{
    instance.@com.cloderia.helion.client.local.partytype.ViewPartytypePage::binder = value;
  }-*/;

  native static PartytypeDisplay ViewPartytypePage_PartytypeDisplay_entityDisplayComponent(ViewPartytypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partytype.ViewPartytypePage::entityDisplayComponent;
  }-*/;

  native static void ViewPartytypePage_PartytypeDisplay_entityDisplayComponent(ViewPartytypePage instance, PartytypeDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.partytype.ViewPartytypePage::entityDisplayComponent = value;
  }-*/;
