...
public class Type_factory__c_c_h_c_l_i_EditInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditInvoiceitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditInvoiceitemPage.class, "Type_factory__c_c_h_c_l_i_EditInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_EditInvoiceitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_EditInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditInvoiceitemPage.class);
  ...
  public EditInvoiceitemPage createInstance(final ContextManager contextManager) {
    final EditInvoiceitemPage instance = new EditInvoiceitemPage();
    ...
    final InvoiceitemEditor EditInvoiceitemPage_invoiceitemEditor = (InvoiceitemEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InvoiceitemEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditInvoiceitemPage_invoiceitemEditor);
    EditInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(instance, EditInvoiceitemPage_invoiceitemEditor);
    ...
    c_c_h_c_l_i_EditInvoiceitemPageTemplateResource templateForEditInvoiceitemPage = GWT.create(c_c_h_c_l_i_EditInvoiceitemPageTemplateResource.class);
    Element parentElementForTemplateOfEditInvoiceitemPage = TemplateUtil.getRootTemplateParentElement(templateForEditInvoiceitemPage.getContents().getText(), "com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInvoiceitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInvoiceitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceitem.EditInvoiceitemPage", "com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceitem.EditInvoiceitemPage", "com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(instance));
      }
    ...
    templateFieldsMap.put("invoiceitemEditor", TemplateWidgetMapper.get(EditInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInvoiceitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditInvoiceitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditInvoiceitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditInvoiceitemPage instance) {
  ...
  native static InvoiceitemEditor EditInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(EditInvoiceitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoiceitem.EditInvoiceitemPage::invoiceitemEditor;
  }-*/;

  native static void EditInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(EditInvoiceitemPage instance, InvoiceitemEditor value) /*-{
    instance.@com.cloderia.helion.client.local.invoiceitem.EditInvoiceitemPage::invoiceitemEditor = value;
  }-*/;
