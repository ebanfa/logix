...
public class Type_factory__c_c_h_c_l_p_BasePartytypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<BasePartytypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BasePartytypePage.class, "Type_factory__c_c_h_c_l_p_BasePartytypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BasePartytypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partytype/edit-partytype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BasePartytypePage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BasePartytypePage createInstance(final ContextManager contextManager) {
    final BasePartytypePage instance = new BasePartytypePage();
    ...
    c_c_h_c_l_p_BasePartytypePageTemplateResource templateForBasePartytypePage = GWT.create(c_c_h_c_l_p_BasePartytypePageTemplateResource.class);
    Element parentElementForTemplateOfBasePartytypePage = TemplateUtil.getRootTemplateParentElement(templateForBasePartytypePage.getContents().getText(), "com/cloderia/helion/client/local/partytype/edit-partytype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partytype/edit-partytype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartytypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartytypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partytype.BasePartytypePage", "com/cloderia/helion/client/local/partytype/edit-partytype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartytypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BasePartytypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BasePartytypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BasePartytypePage instance) {
