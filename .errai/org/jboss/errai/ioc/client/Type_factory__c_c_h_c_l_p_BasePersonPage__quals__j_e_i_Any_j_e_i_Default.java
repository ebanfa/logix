...
public class Type_factory__c_c_h_c_l_p_BasePersonPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BasePersonPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BasePersonPage.class, "Type_factory__c_c_h_c_l_p_BasePersonPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BasePersonPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/person/edit-person-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BasePersonPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BasePersonPage createInstance(final ContextManager contextManager) {
    final BasePersonPage instance = new BasePersonPage();
    ...
    c_c_h_c_l_p_BasePersonPageTemplateResource templateForBasePersonPage = GWT.create(c_c_h_c_l_p_BasePersonPageTemplateResource.class);
    Element parentElementForTemplateOfBasePersonPage = TemplateUtil.getRootTemplateParentElement(templateForBasePersonPage.getContents().getText(), "com/cloderia/helion/client/local/person/edit-person-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/person/edit-person-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePersonPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePersonPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.person.BasePersonPage", "com/cloderia/helion/client/local/person/edit-person-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePersonPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BasePersonPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BasePersonPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BasePersonPage instance) {
