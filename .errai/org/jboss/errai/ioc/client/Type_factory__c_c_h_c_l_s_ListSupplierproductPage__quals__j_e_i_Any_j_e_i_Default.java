...
public class Type_factory__c_c_h_c_l_s_ListSupplierproductPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListSupplierproductPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListSupplierproductPage.class, "Type_factory__c_c_h_c_l_s_ListSupplierproductPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_s_ListSupplierproductPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/supplierproduct/list-supplierproduct-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_s_ListSupplierproductPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListSupplierproductPage.class);
  ...
  public ListSupplierproductPage createInstance(final ContextManager contextManager) {
    final ListSupplierproductPage instance = new ListSupplierproductPage();
    ...
    final SupplierproductListWidget ListSupplierproductPage_listWidget = (SupplierproductListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_s_SupplierproductListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListSupplierproductPage_listWidget);
    ListSupplierproductPage_SupplierproductListWidget_listWidget(instance, ListSupplierproductPage_listWidget);
    ...
    c_c_h_c_l_s_ListSupplierproductPageTemplateResource templateForListSupplierproductPage = GWT.create(c_c_h_c_l_s_ListSupplierproductPageTemplateResource.class);
    Element parentElementForTemplateOfListSupplierproductPage = TemplateUtil.getRootTemplateParentElement(templateForListSupplierproductPage.getContents().getText(), "com/cloderia/helion/client/local/supplierproduct/list-supplierproduct-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/supplierproduct/list-supplierproduct-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListSupplierproductPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListSupplierproductPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.supplierproduct.ListSupplierproductPage", "com/cloderia/helion/client/local/supplierproduct/list-supplierproduct-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.supplierproduct.ListSupplierproductPage", "com/cloderia/helion/client/local/supplierproduct/list-supplierproduct-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListSupplierproductPage_SupplierproductListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.supplierproduct.ListSupplierproductPage", "com/cloderia/helion/client/local/supplierproduct/list-supplierproduct-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListSupplierproductPage_AnchorElement_createNewSupplierproductLink(instance));
      }
    }, dataFieldElements, "createNewSupplierproductLink");
    ...
    templateFieldsMap.put("listWidget", ListSupplierproductPage_SupplierproductListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewSupplierproductLink", ElementWrapperWidget.getWidget(ListSupplierproductPage_AnchorElement_createNewSupplierproductLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListSupplierproductPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewSupplierproductLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListSupplierproductPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListSupplierproductPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListSupplierproductPage_AnchorElement_createNewSupplierproductLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListSupplierproductPage instance) {
  ...
  native static SupplierproductListWidget ListSupplierproductPage_SupplierproductListWidget_listWidget(ListSupplierproductPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.supplierproduct.ListSupplierproductPage::listWidget;
  }-*/;

  native static void ListSupplierproductPage_SupplierproductListWidget_listWidget(ListSupplierproductPage instance, SupplierproductListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.supplierproduct.ListSupplierproductPage::listWidget = value;
  }-*/;

  native static AnchorElement ListSupplierproductPage_AnchorElement_createNewSupplierproductLink(ListSupplierproductPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.supplierproduct.ListSupplierproductPage::createNewSupplierproductLink;
  }-*/;

  native static void ListSupplierproductPage_AnchorElement_createNewSupplierproductLink(ListSupplierproductPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.supplierproduct.ListSupplierproductPage::createNewSupplierproductLink = value;
  }-*/;
