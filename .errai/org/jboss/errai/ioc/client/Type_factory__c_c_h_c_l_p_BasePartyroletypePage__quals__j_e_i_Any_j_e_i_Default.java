...
public class Type_factory__c_c_h_c_l_p_BasePartyroletypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<BasePartyroletypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BasePartyroletypePage.class, "Type_factory__c_c_h_c_l_p_BasePartyroletypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BasePartyroletypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BasePartyroletypePage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BasePartyroletypePage createInstance(final ContextManager contextManager) {
    final BasePartyroletypePage instance = new BasePartyroletypePage();
    ...
    c_c_h_c_l_p_BasePartyroletypePageTemplateResource templateForBasePartyroletypePage = GWT.create(c_c_h_c_l_p_BasePartyroletypePageTemplateResource.class);
    Element parentElementForTemplateOfBasePartyroletypePage = TemplateUtil.getRootTemplateParentElement(templateForBasePartyroletypePage.getContents().getText(), "com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartyroletypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartyroletypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyroletype.BasePartyroletypePage", "com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartyroletypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BasePartyroletypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BasePartyroletypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BasePartyroletypePage instance) {
