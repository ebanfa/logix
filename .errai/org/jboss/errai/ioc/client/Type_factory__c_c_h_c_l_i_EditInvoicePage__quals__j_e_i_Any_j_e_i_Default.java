...
public class Type_factory__c_c_h_c_l_i_EditInvoicePage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditInvoicePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditInvoicePage.class, "Type_factory__c_c_h_c_l_i_EditInvoicePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_EditInvoicePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoice/edit-invoice-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_EditInvoicePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditInvoicePage.class);
  ...
  public EditInvoicePage createInstance(final ContextManager contextManager) {
    final EditInvoicePage instance = new EditInvoicePage();
    ...
    final InvoiceEditor EditInvoicePage_invoiceEditor = (InvoiceEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InvoiceEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditInvoicePage_invoiceEditor);
    EditInvoicePage_InvoiceEditor_invoiceEditor(instance, EditInvoicePage_invoiceEditor);
    ...
    c_c_h_c_l_i_EditInvoicePageTemplateResource templateForEditInvoicePage = GWT.create(c_c_h_c_l_i_EditInvoicePageTemplateResource.class);
    Element parentElementForTemplateOfEditInvoicePage = TemplateUtil.getRootTemplateParentElement(templateForEditInvoicePage.getContents().getText(), "com/cloderia/helion/client/local/invoice/edit-invoice-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoice/edit-invoice-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInvoicePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInvoicePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoice.EditInvoicePage", "com/cloderia/helion/client/local/invoice/edit-invoice-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoice.EditInvoicePage", "com/cloderia/helion/client/local/invoice/edit-invoice-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditInvoicePage_InvoiceEditor_invoiceEditor(instance));
      }
    ...
    templateFieldsMap.put("invoiceEditor", TemplateWidgetMapper.get(EditInvoicePage_InvoiceEditor_invoiceEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditInvoicePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditInvoicePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditInvoicePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditInvoicePage instance) {
  ...
  native static InvoiceEditor EditInvoicePage_InvoiceEditor_invoiceEditor(EditInvoicePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoice.EditInvoicePage::invoiceEditor;
  }-*/;

  native static void EditInvoicePage_InvoiceEditor_invoiceEditor(EditInvoicePage instance, InvoiceEditor value) /*-{
    instance.@com.cloderia.helion.client.local.invoice.EditInvoicePage::invoiceEditor = value;
  }-*/;
