...
public class Type_factory__c_c_h_c_l_p_EditPaymentPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditPaymentPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditPaymentPage.class, "Type_factory__c_c_h_c_l_p_EditPaymentPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditPaymentPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/payment/edit-payment-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditPaymentPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditPaymentPage.class);
  ...
  public EditPaymentPage createInstance(final ContextManager contextManager) {
    final EditPaymentPage instance = new EditPaymentPage();
    ...
    final PaymentEditor EditPaymentPage_paymentEditor = (PaymentEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PaymentEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditPaymentPage_paymentEditor);
    EditPaymentPage_PaymentEditor_paymentEditor(instance, EditPaymentPage_paymentEditor);
    ...
    c_c_h_c_l_p_EditPaymentPageTemplateResource templateForEditPaymentPage = GWT.create(c_c_h_c_l_p_EditPaymentPageTemplateResource.class);
    Element parentElementForTemplateOfEditPaymentPage = TemplateUtil.getRootTemplateParentElement(templateForEditPaymentPage.getContents().getText(), "com/cloderia/helion/client/local/payment/edit-payment-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/payment/edit-payment-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPaymentPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPaymentPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.payment.EditPaymentPage", "com/cloderia/helion/client/local/payment/edit-payment-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.payment.EditPaymentPage", "com/cloderia/helion/client/local/payment/edit-payment-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditPaymentPage_PaymentEditor_paymentEditor(instance));
      }
    ...
    templateFieldsMap.put("paymentEditor", TemplateWidgetMapper.get(EditPaymentPage_PaymentEditor_paymentEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPaymentPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditPaymentPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditPaymentPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditPaymentPage instance) {
  ...
  native static PaymentEditor EditPaymentPage_PaymentEditor_paymentEditor(EditPaymentPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.payment.EditPaymentPage::paymentEditor;
  }-*/;

  native static void EditPaymentPage_PaymentEditor_paymentEditor(EditPaymentPage instance, PaymentEditor value) /*-{
    instance.@com.cloderia.helion.client.local.payment.EditPaymentPage::paymentEditor = value;
  }-*/;
