...
public class Type_factory__c_c_h_c_l_o_CreateOrganizationPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateOrganizationPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateOrganizationPage.class, "Type_factory__c_c_h_c_l_o_CreateOrganizationPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_CreateOrganizationPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organization/edit-organization-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_CreateOrganizationPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateOrganizationPage.class);
  ...
  public CreateOrganizationPage createInstance(final ContextManager contextManager) {
    final CreateOrganizationPage instance = new CreateOrganizationPage();
    ...
    final OrganizationEditor CreateOrganizationPage_organizationEditor = (OrganizationEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_o_OrganizationEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateOrganizationPage_organizationEditor);
    CreateOrganizationPage_OrganizationEditor_organizationEditor(instance, CreateOrganizationPage_organizationEditor);
    ...
    c_c_h_c_l_o_CreateOrganizationPageTemplateResource templateForCreateOrganizationPage = GWT.create(c_c_h_c_l_o_CreateOrganizationPageTemplateResource.class);
    Element parentElementForTemplateOfCreateOrganizationPage = TemplateUtil.getRootTemplateParentElement(templateForCreateOrganizationPage.getContents().getText(), "com/cloderia/helion/client/local/organization/edit-organization-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organization/edit-organization-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateOrganizationPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateOrganizationPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organization.CreateOrganizationPage", "com/cloderia/helion/client/local/organization/edit-organization-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organization.CreateOrganizationPage", "com/cloderia/helion/client/local/organization/edit-organization-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateOrganizationPage_OrganizationEditor_organizationEditor(instance));
      }
    ...
    templateFieldsMap.put("organizationEditor", TemplateWidgetMapper.get(CreateOrganizationPage_OrganizationEditor_organizationEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateOrganizationPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateOrganizationPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateOrganizationPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateOrganizationPage instance) {
  ...
  native static OrganizationEditor CreateOrganizationPage_OrganizationEditor_organizationEditor(CreateOrganizationPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organization.CreateOrganizationPage::organizationEditor;
  }-*/;

  native static void CreateOrganizationPage_OrganizationEditor_organizationEditor(CreateOrganizationPage instance, OrganizationEditor value) /*-{
    instance.@com.cloderia.helion.client.local.organization.CreateOrganizationPage::organizationEditor = value;
  }-*/;
