...
public class Type_factory__c_c_h_c_l_a_EditAgreementPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditAgreementPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditAgreementPage.class, "Type_factory__c_c_h_c_l_a_EditAgreementPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_a_EditAgreementPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/agreement/edit-agreement-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_a_EditAgreementPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditAgreementPage.class);
  ...
  public EditAgreementPage createInstance(final ContextManager contextManager) {
    final EditAgreementPage instance = new EditAgreementPage();
    setIncompleteInstance(instance);
    final AgreementEditor EditAgreementPage_agreementEditor = (AgreementEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_a_AgreementEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditAgreementPage_agreementEditor);
    EditAgreementPage_AgreementEditor_agreementEditor(instance, EditAgreementPage_agreementEditor);
    ...
    c_c_h_c_l_a_EditAgreementPageTemplateResource templateForEditAgreementPage = GWT.create(c_c_h_c_l_a_EditAgreementPageTemplateResource.class);
    Element parentElementForTemplateOfEditAgreementPage = TemplateUtil.getRootTemplateParentElement(templateForEditAgreementPage.getContents().getText(), "com/cloderia/helion/client/local/agreement/edit-agreement-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/agreement/edit-agreement-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditAgreementPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditAgreementPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.agreement.EditAgreementPage", "com/cloderia/helion/client/local/agreement/edit-agreement-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.agreement.EditAgreementPage", "com/cloderia/helion/client/local/agreement/edit-agreement-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditAgreementPage_AgreementEditor_agreementEditor(instance));
      }
    ...
    templateFieldsMap.put("agreementEditor", TemplateWidgetMapper.get(EditAgreementPage_AgreementEditor_agreementEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditAgreementPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditAgreementPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditAgreementPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditAgreementPage instance) {
  ...
  native static AgreementEditor EditAgreementPage_AgreementEditor_agreementEditor(EditAgreementPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.agreement.EditAgreementPage::agreementEditor;
  }-*/;

  native static void EditAgreementPage_AgreementEditor_agreementEditor(EditAgreementPage instance, AgreementEditor value) /*-{
    instance.@com.cloderia.helion.client.local.agreement.EditAgreementPage::agreementEditor = value;
  }-*/;
