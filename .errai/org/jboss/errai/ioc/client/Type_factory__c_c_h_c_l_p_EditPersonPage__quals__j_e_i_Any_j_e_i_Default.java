...
public class Type_factory__c_c_h_c_l_p_EditPersonPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditPersonPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditPersonPage.class, "Type_factory__c_c_h_c_l_p_EditPersonPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditPersonPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/person/edit-person-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditPersonPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditPersonPage.class);
  ...
  public EditPersonPage createInstance(final ContextManager contextManager) {
    final EditPersonPage instance = new EditPersonPage();
    ...
    final PersonEditor EditPersonPage_personEditor = (PersonEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PersonEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditPersonPage_personEditor);
    EditPersonPage_PersonEditor_personEditor(instance, EditPersonPage_personEditor);
    ...
    c_c_h_c_l_p_EditPersonPageTemplateResource templateForEditPersonPage = GWT.create(c_c_h_c_l_p_EditPersonPageTemplateResource.class);
    Element parentElementForTemplateOfEditPersonPage = TemplateUtil.getRootTemplateParentElement(templateForEditPersonPage.getContents().getText(), "com/cloderia/helion/client/local/person/edit-person-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/person/edit-person-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPersonPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPersonPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.person.EditPersonPage", "com/cloderia/helion/client/local/person/edit-person-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.person.EditPersonPage", "com/cloderia/helion/client/local/person/edit-person-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditPersonPage_PersonEditor_personEditor(instance));
      }
    ...
    templateFieldsMap.put("personEditor", TemplateWidgetMapper.get(EditPersonPage_PersonEditor_personEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPersonPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditPersonPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditPersonPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditPersonPage instance) {
  ...
  native static PersonEditor EditPersonPage_PersonEditor_personEditor(EditPersonPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.person.EditPersonPage::personEditor;
  }-*/;

  native static void EditPersonPage_PersonEditor_personEditor(EditPersonPage instance, PersonEditor value) /*-{
    instance.@com.cloderia.helion.client.local.person.EditPersonPage::personEditor = value;
  }-*/;
