...
public class Type_factory__c_c_h_c_l_u_BaseUniversePage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseUniversePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseUniversePage.class, "Type_factory__c_c_h_c_l_u_BaseUniversePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_u_BaseUniversePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/universe/edit-universe-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_u_BaseUniversePage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseUniversePage createInstance(final ContextManager contextManager) {
    final BaseUniversePage instance = new BaseUniversePage();
    ...
    c_c_h_c_l_u_BaseUniversePageTemplateResource templateForBaseUniversePage = GWT.create(c_c_h_c_l_u_BaseUniversePageTemplateResource.class);
    Element parentElementForTemplateOfBaseUniversePage = TemplateUtil.getRootTemplateParentElement(templateForBaseUniversePage.getContents().getText(), "com/cloderia/helion/client/local/universe/edit-universe-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/universe/edit-universe-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseUniversePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseUniversePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.universe.BaseUniversePage", "com/cloderia/helion/client/local/universe/edit-universe-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseUniversePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseUniversePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseUniversePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseUniversePage instance) {
