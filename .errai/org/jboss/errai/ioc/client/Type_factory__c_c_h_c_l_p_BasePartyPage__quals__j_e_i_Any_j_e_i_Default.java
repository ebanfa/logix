...
public class Type_factory__c_c_h_c_l_p_BasePartyPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BasePartyPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BasePartyPage.class, "Type_factory__c_c_h_c_l_p_BasePartyPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BasePartyPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/party/edit-party-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BasePartyPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BasePartyPage createInstance(final ContextManager contextManager) {
    final BasePartyPage instance = new BasePartyPage();
    ...
    c_c_h_c_l_p_BasePartyPageTemplateResource templateForBasePartyPage = GWT.create(c_c_h_c_l_p_BasePartyPageTemplateResource.class);
    Element parentElementForTemplateOfBasePartyPage = TemplateUtil.getRootTemplateParentElement(templateForBasePartyPage.getContents().getText(), "com/cloderia/helion/client/local/party/edit-party-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/party/edit-party-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartyPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartyPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.party.BasePartyPage", "com/cloderia/helion/client/local/party/edit-party-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBasePartyPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BasePartyPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BasePartyPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BasePartyPage instance) {
