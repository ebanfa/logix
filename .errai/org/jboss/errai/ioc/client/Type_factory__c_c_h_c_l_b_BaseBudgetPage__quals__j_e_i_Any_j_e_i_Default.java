...
public class Type_factory__c_c_h_c_l_b_BaseBudgetPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseBudgetPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseBudgetPage.class, "Type_factory__c_c_h_c_l_b_BaseBudgetPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_BaseBudgetPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/budget/edit-budget-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_BaseBudgetPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseBudgetPage createInstance(final ContextManager contextManager) {
    final BaseBudgetPage instance = new BaseBudgetPage();
    ...
    c_c_h_c_l_b_BaseBudgetPageTemplateResource templateForBaseBudgetPage = GWT.create(c_c_h_c_l_b_BaseBudgetPageTemplateResource.class);
    Element parentElementForTemplateOfBaseBudgetPage = TemplateUtil.getRootTemplateParentElement(templateForBaseBudgetPage.getContents().getText(), "com/cloderia/helion/client/local/budget/edit-budget-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/budget/edit-budget-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseBudgetPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseBudgetPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budget.BaseBudgetPage", "com/cloderia/helion/client/local/budget/edit-budget-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseBudgetPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseBudgetPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseBudgetPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseBudgetPage instance) {
