...
public class Type_factory__c_c_h_c_l_i_BaseInvoicetermPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseInvoicetermPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseInvoicetermPage.class, "Type_factory__c_c_h_c_l_i_BaseInvoicetermPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_BaseInvoicetermPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_BaseInvoicetermPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseInvoicetermPage createInstance(final ContextManager contextManager) {
    final BaseInvoicetermPage instance = new BaseInvoicetermPage();
    ...
    c_c_h_c_l_i_BaseInvoicetermPageTemplateResource templateForBaseInvoicetermPage = GWT.create(c_c_h_c_l_i_BaseInvoicetermPageTemplateResource.class);
    Element parentElementForTemplateOfBaseInvoicetermPage = TemplateUtil.getRootTemplateParentElement(templateForBaseInvoicetermPage.getContents().getText(), "com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseInvoicetermPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseInvoicetermPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceterm.BaseInvoicetermPage", "com/cloderia/helion/client/local/invoiceterm/edit-invoiceterm-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseInvoicetermPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseInvoicetermPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseInvoicetermPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseInvoicetermPage instance) {
