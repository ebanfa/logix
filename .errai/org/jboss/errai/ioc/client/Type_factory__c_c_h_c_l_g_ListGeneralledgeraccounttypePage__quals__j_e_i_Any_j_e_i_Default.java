...
public class Type_factory__c_c_h_c_l_g_ListGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListGeneralledgeraccounttypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListGeneralledgeraccounttypePage.class, "Type_factory__c_c_h_c_l_g_ListGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_g_ListGeneralledgeraccounttypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/generalledgeraccounttype/list-generalledgeraccounttype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_g_ListGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListGeneralledgeraccounttypePage.class);
  ...
  public ListGeneralledgeraccounttypePage createInstance(final ContextManager contextManager) {
    final ListGeneralledgeraccounttypePage instance = new ListGeneralledgeraccounttypePage();
    ...
    final GeneralledgeraccounttypeListWidget ListGeneralledgeraccounttypePage_listWidget = (GeneralledgeraccounttypeListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_g_GeneralledgeraccounttypeListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListGeneralledgeraccounttypePage_listWidget);
    ListGeneralledgeraccounttypePage_GeneralledgeraccounttypeListWidget_listWidget(instance, ListGeneralledgeraccounttypePage_listWidget);
    ...
    c_c_h_c_l_g_ListGeneralledgeraccounttypePageTemplateResource templateForListGeneralledgeraccounttypePage = GWT.create(c_c_h_c_l_g_ListGeneralledgeraccounttypePageTemplateResource.class);
    Element parentElementForTemplateOfListGeneralledgeraccounttypePage = TemplateUtil.getRootTemplateParentElement(templateForListGeneralledgeraccounttypePage.getContents().getText(), "com/cloderia/helion/client/local/generalledgeraccounttype/list-generalledgeraccounttype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/generalledgeraccounttype/list-generalledgeraccounttype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListGeneralledgeraccounttypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListGeneralledgeraccounttypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccounttype.ListGeneralledgeraccounttypePage", "com/cloderia/helion/client/local/generalledgeraccounttype/list-generalledgeraccounttype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccounttype.ListGeneralledgeraccounttypePage", "com/cloderia/helion/client/local/generalledgeraccounttype/list-generalledgeraccounttype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListGeneralledgeraccounttypePage_GeneralledgeraccounttypeListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccounttype.ListGeneralledgeraccounttypePage", "com/cloderia/helion/client/local/generalledgeraccounttype/list-generalledgeraccounttype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListGeneralledgeraccounttypePage_AnchorElement_createNewGeneralledgeraccounttypeLink(instance));
      }
    }, dataFieldElements, "createNewGeneralledgeraccounttypeLink");
    ...
    templateFieldsMap.put("listWidget", ListGeneralledgeraccounttypePage_GeneralledgeraccounttypeListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewGeneralledgeraccounttypeLink", ElementWrapperWidget.getWidget(ListGeneralledgeraccounttypePage_AnchorElement_createNewGeneralledgeraccounttypeLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListGeneralledgeraccounttypePage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewGeneralledgeraccounttypeLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListGeneralledgeraccounttypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListGeneralledgeraccounttypePage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListGeneralledgeraccounttypePage_AnchorElement_createNewGeneralledgeraccounttypeLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListGeneralledgeraccounttypePage instance) {
  ...
  native static GeneralledgeraccounttypeListWidget ListGeneralledgeraccounttypePage_GeneralledgeraccounttypeListWidget_listWidget(ListGeneralledgeraccounttypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccounttype.ListGeneralledgeraccounttypePage::listWidget;
  }-*/;

  native static void ListGeneralledgeraccounttypePage_GeneralledgeraccounttypeListWidget_listWidget(ListGeneralledgeraccounttypePage instance, GeneralledgeraccounttypeListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccounttype.ListGeneralledgeraccounttypePage::listWidget = value;
  }-*/;

  native static AnchorElement ListGeneralledgeraccounttypePage_AnchorElement_createNewGeneralledgeraccounttypeLink(ListGeneralledgeraccounttypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccounttype.ListGeneralledgeraccounttypePage::createNewGeneralledgeraccounttypeLink;
  }-*/;

  native static void ListGeneralledgeraccounttypePage_AnchorElement_createNewGeneralledgeraccounttypeLink(ListGeneralledgeraccounttypePage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccounttype.ListGeneralledgeraccounttypePage::createNewGeneralledgeraccounttypeLink = value;
  }-*/;
