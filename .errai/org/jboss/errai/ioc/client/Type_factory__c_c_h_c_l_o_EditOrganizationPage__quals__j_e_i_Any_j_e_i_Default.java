...
public class Type_factory__c_c_h_c_l_o_EditOrganizationPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditOrganizationPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditOrganizationPage.class, "Type_factory__c_c_h_c_l_o_EditOrganizationPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_EditOrganizationPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organization/edit-organization-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_EditOrganizationPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditOrganizationPage.class);
  ...
  public EditOrganizationPage createInstance(final ContextManager contextManager) {
    final EditOrganizationPage instance = new EditOrganizationPage();
    ...
    final OrganizationEditor EditOrganizationPage_organizationEditor = (OrganizationEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_o_OrganizationEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditOrganizationPage_organizationEditor);
    EditOrganizationPage_OrganizationEditor_organizationEditor(instance, EditOrganizationPage_organizationEditor);
    ...
    c_c_h_c_l_o_EditOrganizationPageTemplateResource templateForEditOrganizationPage = GWT.create(c_c_h_c_l_o_EditOrganizationPageTemplateResource.class);
    Element parentElementForTemplateOfEditOrganizationPage = TemplateUtil.getRootTemplateParentElement(templateForEditOrganizationPage.getContents().getText(), "com/cloderia/helion/client/local/organization/edit-organization-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organization/edit-organization-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditOrganizationPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditOrganizationPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organization.EditOrganizationPage", "com/cloderia/helion/client/local/organization/edit-organization-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organization.EditOrganizationPage", "com/cloderia/helion/client/local/organization/edit-organization-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditOrganizationPage_OrganizationEditor_organizationEditor(instance));
      }
    ...
    templateFieldsMap.put("organizationEditor", TemplateWidgetMapper.get(EditOrganizationPage_OrganizationEditor_organizationEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditOrganizationPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditOrganizationPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditOrganizationPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditOrganizationPage instance) {
  ...
  native static OrganizationEditor EditOrganizationPage_OrganizationEditor_organizationEditor(EditOrganizationPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organization.EditOrganizationPage::organizationEditor;
  }-*/;

  native static void EditOrganizationPage_OrganizationEditor_organizationEditor(EditOrganizationPage instance, OrganizationEditor value) /*-{
    instance.@com.cloderia.helion.client.local.organization.EditOrganizationPage::organizationEditor = value;
  }-*/;
