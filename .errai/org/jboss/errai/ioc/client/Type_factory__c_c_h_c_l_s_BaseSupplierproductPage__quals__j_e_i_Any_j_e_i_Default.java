...
public class Type_factory__c_c_h_c_l_s_BaseSupplierproductPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseSupplierproductPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseSupplierproductPage.class, "Type_factory__c_c_h_c_l_s_BaseSupplierproductPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_s_BaseSupplierproductPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_s_BaseSupplierproductPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseSupplierproductPage createInstance(final ContextManager contextManager) {
    final BaseSupplierproductPage instance = new BaseSupplierproductPage();
    ...
    c_c_h_c_l_s_BaseSupplierproductPageTemplateResource templateForBaseSupplierproductPage = GWT.create(c_c_h_c_l_s_BaseSupplierproductPageTemplateResource.class);
    Element parentElementForTemplateOfBaseSupplierproductPage = TemplateUtil.getRootTemplateParentElement(templateForBaseSupplierproductPage.getContents().getText(), "com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseSupplierproductPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseSupplierproductPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.supplierproduct.BaseSupplierproductPage", "com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseSupplierproductPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseSupplierproductPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseSupplierproductPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseSupplierproductPage instance) {
