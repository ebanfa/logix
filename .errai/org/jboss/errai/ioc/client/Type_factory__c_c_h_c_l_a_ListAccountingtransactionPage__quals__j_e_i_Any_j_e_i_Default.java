...
public class Type_factory__c_c_h_c_l_a_ListAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListAccountingtransactionPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListAccountingtransactionPage.class, "Type_factory__c_c_h_c_l_a_ListAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_a_ListAccountingtransactionPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/accountingtransaction/list-accountingtransaction-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_a_ListAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListAccountingtransactionPage.class);
  ...
  public ListAccountingtransactionPage createInstance(final ContextManager contextManager) {
    final ListAccountingtransactionPage instance = new ListAccountingtransactionPage();
    setIncompleteInstance(instance);
    final AccountingtransactionListWidget ListAccountingtransactionPage_listWidget = (AccountingtransactionListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_a_AccountingtransactionListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListAccountingtransactionPage_listWidget);
    ListAccountingtransactionPage_AccountingtransactionListWidget_listWidget(instance, ListAccountingtransactionPage_listWidget);
    ...
    c_c_h_c_l_a_ListAccountingtransactionPageTemplateResource templateForListAccountingtransactionPage = GWT.create(c_c_h_c_l_a_ListAccountingtransactionPageTemplateResource.class);
    Element parentElementForTemplateOfListAccountingtransactionPage = TemplateUtil.getRootTemplateParentElement(templateForListAccountingtransactionPage.getContents().getText(), "com/cloderia/helion/client/local/accountingtransaction/list-accountingtransaction-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/accountingtransaction/list-accountingtransaction-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListAccountingtransactionPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListAccountingtransactionPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.accountingtransaction.ListAccountingtransactionPage", "com/cloderia/helion/client/local/accountingtransaction/list-accountingtransaction-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.accountingtransaction.ListAccountingtransactionPage", "com/cloderia/helion/client/local/accountingtransaction/list-accountingtransaction-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListAccountingtransactionPage_AccountingtransactionListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.accountingtransaction.ListAccountingtransactionPage", "com/cloderia/helion/client/local/accountingtransaction/list-accountingtransaction-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListAccountingtransactionPage_AnchorElement_createNewAccountingtransactionLink(instance));
      }
    }, dataFieldElements, "createNewAccountingtransactionLink");
    ...
    templateFieldsMap.put("listWidget", ListAccountingtransactionPage_AccountingtransactionListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewAccountingtransactionLink", ElementWrapperWidget.getWidget(ListAccountingtransactionPage_AnchorElement_createNewAccountingtransactionLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListAccountingtransactionPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewAccountingtransactionLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListAccountingtransactionPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListAccountingtransactionPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListAccountingtransactionPage_AnchorElement_createNewAccountingtransactionLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListAccountingtransactionPage instance) {
  ...
  native static AnchorElement ListAccountingtransactionPage_AnchorElement_createNewAccountingtransactionLink(ListAccountingtransactionPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.accountingtransaction.ListAccountingtransactionPage::createNewAccountingtransactionLink;
  }-*/;

  native static void ListAccountingtransactionPage_AnchorElement_createNewAccountingtransactionLink(ListAccountingtransactionPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.accountingtransaction.ListAccountingtransactionPage::createNewAccountingtransactionLink = value;
  }-*/;
  ...
  native static AccountingtransactionListWidget ListAccountingtransactionPage_AccountingtransactionListWidget_listWidget(ListAccountingtransactionPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.accountingtransaction.ListAccountingtransactionPage::listWidget;
  }-*/;

  native static void ListAccountingtransactionPage_AccountingtransactionListWidget_listWidget(ListAccountingtransactionPage instance, AccountingtransactionListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.accountingtransaction.ListAccountingtransactionPage::listWidget = value;
  }-*/;
