...
public class Type_factory__c_c_h_c_l_f_BaseFacilitytypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseFacilitytypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseFacilitytypePage.class, "Type_factory__c_c_h_c_l_f_BaseFacilitytypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_f_BaseFacilitytypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/facilitytype/edit-facilitytype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_f_BaseFacilitytypePage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseFacilitytypePage createInstance(final ContextManager contextManager) {
    final BaseFacilitytypePage instance = new BaseFacilitytypePage();
    ...
    c_c_h_c_l_f_BaseFacilitytypePageTemplateResource templateForBaseFacilitytypePage = GWT.create(c_c_h_c_l_f_BaseFacilitytypePageTemplateResource.class);
    Element parentElementForTemplateOfBaseFacilitytypePage = TemplateUtil.getRootTemplateParentElement(templateForBaseFacilitytypePage.getContents().getText(), "com/cloderia/helion/client/local/facilitytype/edit-facilitytype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/facilitytype/edit-facilitytype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseFacilitytypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseFacilitytypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facilitytype.BaseFacilitytypePage", "com/cloderia/helion/client/local/facilitytype/edit-facilitytype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseFacilitytypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseFacilitytypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseFacilitytypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseFacilitytypePage instance) {
