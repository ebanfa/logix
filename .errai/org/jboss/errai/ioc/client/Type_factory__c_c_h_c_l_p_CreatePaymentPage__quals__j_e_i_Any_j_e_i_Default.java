...
public class Type_factory__c_c_h_c_l_p_CreatePaymentPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreatePaymentPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreatePaymentPage.class, "Type_factory__c_c_h_c_l_p_CreatePaymentPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_CreatePaymentPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/payment/edit-payment-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_CreatePaymentPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreatePaymentPage.class);
  ...
  public CreatePaymentPage createInstance(final ContextManager contextManager) {
    final CreatePaymentPage instance = new CreatePaymentPage();
    ...
    final PaymentEditor CreatePaymentPage_paymentEditor = (PaymentEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PaymentEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreatePaymentPage_paymentEditor);
    CreatePaymentPage_PaymentEditor_paymentEditor(instance, CreatePaymentPage_paymentEditor);
    ...
    c_c_h_c_l_p_CreatePaymentPageTemplateResource templateForCreatePaymentPage = GWT.create(c_c_h_c_l_p_CreatePaymentPageTemplateResource.class);
    Element parentElementForTemplateOfCreatePaymentPage = TemplateUtil.getRootTemplateParentElement(templateForCreatePaymentPage.getContents().getText(), "com/cloderia/helion/client/local/payment/edit-payment-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/payment/edit-payment-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePaymentPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePaymentPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.payment.CreatePaymentPage", "com/cloderia/helion/client/local/payment/edit-payment-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.payment.CreatePaymentPage", "com/cloderia/helion/client/local/payment/edit-payment-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreatePaymentPage_PaymentEditor_paymentEditor(instance));
      }
    ...
    templateFieldsMap.put("paymentEditor", TemplateWidgetMapper.get(CreatePaymentPage_PaymentEditor_paymentEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePaymentPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreatePaymentPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreatePaymentPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreatePaymentPage instance) {
  ...
  native static PaymentEditor CreatePaymentPage_PaymentEditor_paymentEditor(CreatePaymentPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.payment.CreatePaymentPage::paymentEditor;
  }-*/;

  native static void CreatePaymentPage_PaymentEditor_paymentEditor(CreatePaymentPage instance, PaymentEditor value) /*-{
    instance.@com.cloderia.helion.client.local.payment.CreatePaymentPage::paymentEditor = value;
  }-*/;
