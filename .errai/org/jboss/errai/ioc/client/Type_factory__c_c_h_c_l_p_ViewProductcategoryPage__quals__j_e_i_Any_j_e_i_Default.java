...
public class Type_factory__c_c_h_c_l_p_ViewProductcategoryPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewProductcategoryPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewProductcategoryPage.class, "Type_factory__c_c_h_c_l_p_ViewProductcategoryPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewProductcategoryPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productcategory/view-productcategory-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewProductcategoryPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewProductcategoryPage.class);
  ...
  public ViewProductcategoryPage createInstance(final ContextManager contextManager) {
    final ViewProductcategoryPage instance = new ViewProductcategoryPage();
    ...
    final DataBinder ViewProductcategoryPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Productcategory.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewProductcategoryPage_binder);
    ViewProductcategoryPage_DataBinder_binder(instance, ViewProductcategoryPage_binder);
    final ProductcategoryDisplay ViewProductcategoryPage_entityDisplayComponent = (ProductcategoryDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductcategoryDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewProductcategoryPage_entityDisplayComponent);
    ViewProductcategoryPage_ProductcategoryDisplay_entityDisplayComponent(instance, ViewProductcategoryPage_entityDisplayComponent);
    ...
    c_c_h_c_l_p_ViewProductcategoryPageTemplateResource templateForViewProductcategoryPage = GWT.create(c_c_h_c_l_p_ViewProductcategoryPageTemplateResource.class);
    Element parentElementForTemplateOfViewProductcategoryPage = TemplateUtil.getRootTemplateParentElement(templateForViewProductcategoryPage.getContents().getText(), "com/cloderia/helion/client/local/productcategory/view-productcategory-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productcategory/view-productcategory-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductcategoryPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductcategoryPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productcategory.ViewProductcategoryPage", "com/cloderia/helion/client/local/productcategory/view-productcategory-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productcategory.ViewProductcategoryPage", "com/cloderia/helion/client/local/productcategory/view-productcategory-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewProductcategoryPage_ProductcategoryDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewProductcategoryPage_ProductcategoryDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductcategoryPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewProductcategoryPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewProductcategoryPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewProductcategoryPage instance) {
  ...
  native static DataBinder ViewProductcategoryPage_DataBinder_binder(ViewProductcategoryPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productcategory.ViewProductcategoryPage::binder;
  }-*/;

  native static void ViewProductcategoryPage_DataBinder_binder(ViewProductcategoryPage instance, DataBinder<Productcategory> value) /*-{
    instance.@com.cloderia.helion.client.local.productcategory.ViewProductcategoryPage::binder = value;
  }-*/;
  ...
  native static ProductcategoryDisplay ViewProductcategoryPage_ProductcategoryDisplay_entityDisplayComponent(ViewProductcategoryPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productcategory.ViewProductcategoryPage::entityDisplayComponent;
  }-*/;

  native static void ViewProductcategoryPage_ProductcategoryDisplay_entityDisplayComponent(ViewProductcategoryPage instance, ProductcategoryDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.productcategory.ViewProductcategoryPage::entityDisplayComponent = value;
  }-*/;
