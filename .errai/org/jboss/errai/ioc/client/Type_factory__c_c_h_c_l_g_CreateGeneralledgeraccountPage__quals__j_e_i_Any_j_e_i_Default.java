...
public class Type_factory__c_c_h_c_l_g_CreateGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateGeneralledgeraccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateGeneralledgeraccountPage.class, "Type_factory__c_c_h_c_l_g_CreateGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_g_CreateGeneralledgeraccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_g_CreateGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateGeneralledgeraccountPage.class);
  ...
  public CreateGeneralledgeraccountPage createInstance(final ContextManager contextManager) {
    final CreateGeneralledgeraccountPage instance = new CreateGeneralledgeraccountPage();
    ...
    final GeneralledgeraccountEditor CreateGeneralledgeraccountPage_generalledgeraccountEditor = (GeneralledgeraccountEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_g_GeneralledgeraccountEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateGeneralledgeraccountPage_generalledgeraccountEditor);
    CreateGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(instance, CreateGeneralledgeraccountPage_generalledgeraccountEditor);
    ...
    c_c_h_c_l_g_CreateGeneralledgeraccountPageTemplateResource templateForCreateGeneralledgeraccountPage = GWT.create(c_c_h_c_l_g_CreateGeneralledgeraccountPageTemplateResource.class);
    Element parentElementForTemplateOfCreateGeneralledgeraccountPage = TemplateUtil.getRootTemplateParentElement(templateForCreateGeneralledgeraccountPage.getContents().getText(), "com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateGeneralledgeraccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateGeneralledgeraccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccount.CreateGeneralledgeraccountPage", "com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccount.CreateGeneralledgeraccountPage", "com/cloderia/helion/client/local/generalledgeraccount/edit-generalledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(instance));
      }
    ...
    templateFieldsMap.put("generalledgeraccountEditor", TemplateWidgetMapper.get(CreateGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateGeneralledgeraccountPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateGeneralledgeraccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateGeneralledgeraccountPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateGeneralledgeraccountPage instance) {
  ...
  native static GeneralledgeraccountEditor CreateGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(CreateGeneralledgeraccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccount.CreateGeneralledgeraccountPage::generalledgeraccountEditor;
  }-*/;

  native static void CreateGeneralledgeraccountPage_GeneralledgeraccountEditor_generalledgeraccountEditor(CreateGeneralledgeraccountPage instance, GeneralledgeraccountEditor value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccount.CreateGeneralledgeraccountPage::generalledgeraccountEditor = value;
  }-*/;
