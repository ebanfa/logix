...
public class Type_factory__c_c_h_c_l_p_EditPartyrolePage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditPartyrolePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditPartyrolePage.class, "Type_factory__c_c_h_c_l_p_EditPartyrolePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditPartyrolePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditPartyrolePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditPartyrolePage.class);
  ...
  public EditPartyrolePage createInstance(final ContextManager contextManager) {
    final EditPartyrolePage instance = new EditPartyrolePage();
    ...
    final PartyroleEditor EditPartyrolePage_partyroleEditor = (PartyroleEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartyroleEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditPartyrolePage_partyroleEditor);
    EditPartyrolePage_PartyroleEditor_partyroleEditor(instance, EditPartyrolePage_partyroleEditor);
    ...
    c_c_h_c_l_p_EditPartyrolePageTemplateResource templateForEditPartyrolePage = GWT.create(c_c_h_c_l_p_EditPartyrolePageTemplateResource.class);
    Element parentElementForTemplateOfEditPartyrolePage = TemplateUtil.getRootTemplateParentElement(templateForEditPartyrolePage.getContents().getText(), "com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartyrolePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartyrolePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyrole.EditPartyrolePage", "com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyrole.EditPartyrolePage", "com/cloderia/helion/client/local/partyrole/edit-partyrole-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditPartyrolePage_PartyroleEditor_partyroleEditor(instance));
      }
    ...
    templateFieldsMap.put("partyroleEditor", TemplateWidgetMapper.get(EditPartyrolePage_PartyroleEditor_partyroleEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartyrolePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditPartyrolePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditPartyrolePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditPartyrolePage instance) {
  ...
  native static PartyroleEditor EditPartyrolePage_PartyroleEditor_partyroleEditor(EditPartyrolePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partyrole.EditPartyrolePage::partyroleEditor;
  }-*/;

  native static void EditPartyrolePage_PartyroleEditor_partyroleEditor(EditPartyrolePage instance, PartyroleEditor value) /*-{
    instance.@com.cloderia.helion.client.local.partyrole.EditPartyrolePage::partyroleEditor = value;
  }-*/;
