...
public class Type_factory__c_c_h_c_l_f_BaseFacilityPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseFacilityPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseFacilityPage.class, "Type_factory__c_c_h_c_l_f_BaseFacilityPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_f_BaseFacilityPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/facility/edit-facility-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_f_BaseFacilityPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseFacilityPage createInstance(final ContextManager contextManager) {
    final BaseFacilityPage instance = new BaseFacilityPage();
    ...
    c_c_h_c_l_f_BaseFacilityPageTemplateResource templateForBaseFacilityPage = GWT.create(c_c_h_c_l_f_BaseFacilityPageTemplateResource.class);
    Element parentElementForTemplateOfBaseFacilityPage = TemplateUtil.getRootTemplateParentElement(templateForBaseFacilityPage.getContents().getText(), "com/cloderia/helion/client/local/facility/edit-facility-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/facility/edit-facility-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseFacilityPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseFacilityPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facility.BaseFacilityPage", "com/cloderia/helion/client/local/facility/edit-facility-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseFacilityPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseFacilityPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseFacilityPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseFacilityPage instance) {
