...
public class Type_factory__c_c_h_c_l_i_ViewInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewInvoiceitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewInvoiceitemPage.class, "Type_factory__c_c_h_c_l_i_ViewInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_ViewInvoiceitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoiceitem/view-invoiceitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_ViewInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewInvoiceitemPage.class);
  ...
  public ViewInvoiceitemPage createInstance(final ContextManager contextManager) {
    final ViewInvoiceitemPage instance = new ViewInvoiceitemPage();
    ...
    final DataBinder ViewInvoiceitemPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Invoiceitem.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewInvoiceitemPage_binder);
    ViewInvoiceitemPage_DataBinder_binder(instance, ViewInvoiceitemPage_binder);
    ...
    final InvoiceitemDisplay ViewInvoiceitemPage_entityDisplayComponent = (InvoiceitemDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InvoiceitemDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewInvoiceitemPage_entityDisplayComponent);
    ViewInvoiceitemPage_InvoiceitemDisplay_entityDisplayComponent(instance, ViewInvoiceitemPage_entityDisplayComponent);
    ...
    c_c_h_c_l_i_ViewInvoiceitemPageTemplateResource templateForViewInvoiceitemPage = GWT.create(c_c_h_c_l_i_ViewInvoiceitemPageTemplateResource.class);
    Element parentElementForTemplateOfViewInvoiceitemPage = TemplateUtil.getRootTemplateParentElement(templateForViewInvoiceitemPage.getContents().getText(), "com/cloderia/helion/client/local/invoiceitem/view-invoiceitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoiceitem/view-invoiceitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInvoiceitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInvoiceitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceitem.ViewInvoiceitemPage", "com/cloderia/helion/client/local/invoiceitem/view-invoiceitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceitem.ViewInvoiceitemPage", "com/cloderia/helion/client/local/invoiceitem/view-invoiceitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewInvoiceitemPage_InvoiceitemDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewInvoiceitemPage_InvoiceitemDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInvoiceitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewInvoiceitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewInvoiceitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewInvoiceitemPage instance) {
  ...
  native static InvoiceitemDisplay ViewInvoiceitemPage_InvoiceitemDisplay_entityDisplayComponent(ViewInvoiceitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoiceitem.ViewInvoiceitemPage::entityDisplayComponent;
  }-*/;

  native static void ViewInvoiceitemPage_InvoiceitemDisplay_entityDisplayComponent(ViewInvoiceitemPage instance, InvoiceitemDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.invoiceitem.ViewInvoiceitemPage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewInvoiceitemPage_DataBinder_binder(ViewInvoiceitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoiceitem.ViewInvoiceitemPage::binder;
  }-*/;

  native static void ViewInvoiceitemPage_DataBinder_binder(ViewInvoiceitemPage instance, DataBinder<Invoiceitem> value) /*-{
    instance.@com.cloderia.helion.client.local.invoiceitem.ViewInvoiceitemPage::binder = value;
  }-*/;
