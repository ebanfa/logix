...
public class Type_factory__c_c_h_c_l_g_EditGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditGeneralledgeraccounttypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditGeneralledgeraccounttypePage.class, "Type_factory__c_c_h_c_l_g_EditGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_g_EditGeneralledgeraccounttypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_g_EditGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditGeneralledgeraccounttypePage.class);
  ...
  public EditGeneralledgeraccounttypePage createInstance(final ContextManager contextManager) {
    final EditGeneralledgeraccounttypePage instance = new EditGeneralledgeraccounttypePage();
    ...
    final GeneralledgeraccounttypeEditor EditGeneralledgeraccounttypePage_generalledgeraccounttypeEditor = (GeneralledgeraccounttypeEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_g_GeneralledgeraccounttypeEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditGeneralledgeraccounttypePage_generalledgeraccounttypeEditor);
    EditGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(instance, EditGeneralledgeraccounttypePage_generalledgeraccounttypeEditor);
    ...
    c_c_h_c_l_g_EditGeneralledgeraccounttypePageTemplateResource templateForEditGeneralledgeraccounttypePage = GWT.create(c_c_h_c_l_g_EditGeneralledgeraccounttypePageTemplateResource.class);
    Element parentElementForTemplateOfEditGeneralledgeraccounttypePage = TemplateUtil.getRootTemplateParentElement(templateForEditGeneralledgeraccounttypePage.getContents().getText(), "com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditGeneralledgeraccounttypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditGeneralledgeraccounttypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccounttype.EditGeneralledgeraccounttypePage", "com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccounttype.EditGeneralledgeraccounttypePage", "com/cloderia/helion/client/local/generalledgeraccounttype/edit-generalledgeraccounttype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(instance));
      }
    ...
    templateFieldsMap.put("generalledgeraccounttypeEditor", TemplateWidgetMapper.get(EditGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditGeneralledgeraccounttypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditGeneralledgeraccounttypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditGeneralledgeraccounttypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditGeneralledgeraccounttypePage instance) {
  ...
  native static GeneralledgeraccounttypeEditor EditGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(EditGeneralledgeraccounttypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccounttype.EditGeneralledgeraccounttypePage::generalledgeraccounttypeEditor;
  }-*/;

  native static void EditGeneralledgeraccounttypePage_GeneralledgeraccounttypeEditor_generalledgeraccounttypeEditor(EditGeneralledgeraccounttypePage instance, GeneralledgeraccounttypeEditor value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccounttype.EditGeneralledgeraccounttypePage::generalledgeraccounttypeEditor = value;
  }-*/;
