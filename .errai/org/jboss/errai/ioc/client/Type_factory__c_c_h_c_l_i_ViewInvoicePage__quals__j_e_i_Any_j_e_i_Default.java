...
public class Type_factory__c_c_h_c_l_i_ViewInvoicePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewInvoicePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewInvoicePage.class, "Type_factory__c_c_h_c_l_i_ViewInvoicePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_ViewInvoicePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoice/view-invoice-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_ViewInvoicePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewInvoicePage.class);
  ...
  public ViewInvoicePage createInstance(final ContextManager contextManager) {
    final ViewInvoicePage instance = new ViewInvoicePage();
    ...
    final DataBinder ViewInvoicePage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Invoice.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewInvoicePage_binder);
    ViewInvoicePage_DataBinder_binder(instance, ViewInvoicePage_binder);
    ...
    final InvoiceDisplay ViewInvoicePage_entityDisplayComponent = (InvoiceDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InvoiceDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewInvoicePage_entityDisplayComponent);
    ViewInvoicePage_InvoiceDisplay_entityDisplayComponent(instance, ViewInvoicePage_entityDisplayComponent);
    ...
    c_c_h_c_l_i_ViewInvoicePageTemplateResource templateForViewInvoicePage = GWT.create(c_c_h_c_l_i_ViewInvoicePageTemplateResource.class);
    Element parentElementForTemplateOfViewInvoicePage = TemplateUtil.getRootTemplateParentElement(templateForViewInvoicePage.getContents().getText(), "com/cloderia/helion/client/local/invoice/view-invoice-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoice/view-invoice-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInvoicePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInvoicePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoice.ViewInvoicePage", "com/cloderia/helion/client/local/invoice/view-invoice-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoice.ViewInvoicePage", "com/cloderia/helion/client/local/invoice/view-invoice-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewInvoicePage_InvoiceDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewInvoicePage_InvoiceDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInvoicePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewInvoicePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewInvoicePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewInvoicePage instance) {
  ...
  native static InvoiceDisplay ViewInvoicePage_InvoiceDisplay_entityDisplayComponent(ViewInvoicePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoice.ViewInvoicePage::entityDisplayComponent;
  }-*/;

  native static void ViewInvoicePage_InvoiceDisplay_entityDisplayComponent(ViewInvoicePage instance, InvoiceDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.invoice.ViewInvoicePage::entityDisplayComponent = value;
  }-*/;

  native static DataBinder ViewInvoicePage_DataBinder_binder(ViewInvoicePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoice.ViewInvoicePage::binder;
  }-*/;

  native static void ViewInvoicePage_DataBinder_binder(ViewInvoicePage instance, DataBinder<Invoice> value) /*-{
    instance.@com.cloderia.helion.client.local.invoice.ViewInvoicePage::binder = value;
  }-*/;
