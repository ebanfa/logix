...
public class Type_factory__c_c_h_c_l_s_EditSupplierproductPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditSupplierproductPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditSupplierproductPage.class, "Type_factory__c_c_h_c_l_s_EditSupplierproductPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_s_EditSupplierproductPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_s_EditSupplierproductPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditSupplierproductPage.class);
  ...
  public EditSupplierproductPage createInstance(final ContextManager contextManager) {
    final EditSupplierproductPage instance = new EditSupplierproductPage();
    setIncompleteInstance(instance);
    final SupplierproductEditor EditSupplierproductPage_supplierproductEditor = (SupplierproductEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_s_SupplierproductEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditSupplierproductPage_supplierproductEditor);
    EditSupplierproductPage_SupplierproductEditor_supplierproductEditor(instance, EditSupplierproductPage_supplierproductEditor);
    ...
    c_c_h_c_l_s_EditSupplierproductPageTemplateResource templateForEditSupplierproductPage = GWT.create(c_c_h_c_l_s_EditSupplierproductPageTemplateResource.class);
    Element parentElementForTemplateOfEditSupplierproductPage = TemplateUtil.getRootTemplateParentElement(templateForEditSupplierproductPage.getContents().getText(), "com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditSupplierproductPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditSupplierproductPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.supplierproduct.EditSupplierproductPage", "com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.supplierproduct.EditSupplierproductPage", "com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditSupplierproductPage_SupplierproductEditor_supplierproductEditor(instance));
      }
    ...
    templateFieldsMap.put("supplierproductEditor", TemplateWidgetMapper.get(EditSupplierproductPage_SupplierproductEditor_supplierproductEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditSupplierproductPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditSupplierproductPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditSupplierproductPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditSupplierproductPage instance) {
  ...
  native static SupplierproductEditor EditSupplierproductPage_SupplierproductEditor_supplierproductEditor(EditSupplierproductPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.supplierproduct.EditSupplierproductPage::supplierproductEditor;
  }-*/;

  native static void EditSupplierproductPage_SupplierproductEditor_supplierproductEditor(EditSupplierproductPage instance, SupplierproductEditor value) /*-{
    instance.@com.cloderia.helion.client.local.supplierproduct.EditSupplierproductPage::supplierproductEditor = value;
  }-*/;
