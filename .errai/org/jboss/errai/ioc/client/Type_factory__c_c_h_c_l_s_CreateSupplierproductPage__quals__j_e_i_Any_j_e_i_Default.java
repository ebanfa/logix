...
public class Type_factory__c_c_h_c_l_s_CreateSupplierproductPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateSupplierproductPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateSupplierproductPage.class, "Type_factory__c_c_h_c_l_s_CreateSupplierproductPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_s_CreateSupplierproductPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_s_CreateSupplierproductPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateSupplierproductPage.class);
  ...
  public CreateSupplierproductPage createInstance(final ContextManager contextManager) {
    final CreateSupplierproductPage instance = new CreateSupplierproductPage();
    ...
    final SupplierproductEditor CreateSupplierproductPage_supplierproductEditor = (SupplierproductEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_s_SupplierproductEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateSupplierproductPage_supplierproductEditor);
    CreateSupplierproductPage_SupplierproductEditor_supplierproductEditor(instance, CreateSupplierproductPage_supplierproductEditor);
    ...
    c_c_h_c_l_s_CreateSupplierproductPageTemplateResource templateForCreateSupplierproductPage = GWT.create(c_c_h_c_l_s_CreateSupplierproductPageTemplateResource.class);
    Element parentElementForTemplateOfCreateSupplierproductPage = TemplateUtil.getRootTemplateParentElement(templateForCreateSupplierproductPage.getContents().getText(), "com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateSupplierproductPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateSupplierproductPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.supplierproduct.CreateSupplierproductPage", "com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.supplierproduct.CreateSupplierproductPage", "com/cloderia/helion/client/local/supplierproduct/edit-supplierproduct-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateSupplierproductPage_SupplierproductEditor_supplierproductEditor(instance));
      }
    ...
    templateFieldsMap.put("supplierproductEditor", TemplateWidgetMapper.get(CreateSupplierproductPage_SupplierproductEditor_supplierproductEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateSupplierproductPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateSupplierproductPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateSupplierproductPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateSupplierproductPage instance) {
  ...
  native static SupplierproductEditor CreateSupplierproductPage_SupplierproductEditor_supplierproductEditor(CreateSupplierproductPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.supplierproduct.CreateSupplierproductPage::supplierproductEditor;
  }-*/;

  native static void CreateSupplierproductPage_SupplierproductEditor_supplierproductEditor(CreateSupplierproductPage instance, SupplierproductEditor value) /*-{
    instance.@com.cloderia.helion.client.local.supplierproduct.CreateSupplierproductPage::supplierproductEditor = value;
  }-*/;
