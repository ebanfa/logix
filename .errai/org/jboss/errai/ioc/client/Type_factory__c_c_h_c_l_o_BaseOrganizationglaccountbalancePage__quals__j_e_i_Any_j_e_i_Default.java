...
public class Type_factory__c_c_h_c_l_o_BaseOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseOrganizationglaccountbalancePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseOrganizationglaccountbalancePage.class, "Type_factory__c_c_h_c_l_o_BaseOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_BaseOrganizationglaccountbalancePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_BaseOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseOrganizationglaccountbalancePage createInstance(final ContextManager contextManager) {
    final BaseOrganizationglaccountbalancePage instance = new BaseOrganizationglaccountbalancePage();
    ...
    c_c_h_c_l_o_BaseOrganizationglaccountbalancePageTemplateResource templateForBaseOrganizationglaccountbalancePage = GWT.create(c_c_h_c_l_o_BaseOrganizationglaccountbalancePageTemplateResource.class);
    Element parentElementForTemplateOfBaseOrganizationglaccountbalancePage = TemplateUtil.getRootTemplateParentElement(templateForBaseOrganizationglaccountbalancePage.getContents().getText(), "com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseOrganizationglaccountbalancePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseOrganizationglaccountbalancePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationglaccountbalance.BaseOrganizationglaccountbalancePage", "com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseOrganizationglaccountbalancePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseOrganizationglaccountbalancePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseOrganizationglaccountbalancePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseOrganizationglaccountbalancePage instance) {
