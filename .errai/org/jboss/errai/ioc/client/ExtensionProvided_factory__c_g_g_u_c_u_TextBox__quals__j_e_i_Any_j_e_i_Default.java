...
public class ExtensionProvided_factory__c_g_g_u_c_u_TextBox__quals__j_e_i_Any_j_e_i_Default extends Factory<TextBox> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(TextBox.class, "ExtensionProvided_factory__c_g_g_u_c_u_TextBox__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public ExtensionProvided_factory__c_g_g_u_c_u_TextBox__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(TextBox.class);
    handle.addAssignableType(TextBoxBase.class);
    handle.addAssignableType(ValueBoxBase.class);
    ...
    handle.addAssignableType(Target.class);
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((TextBox) instance, contextManager);
  }

  public void destroyInstanceHelper(final TextBox instance, final ContextManager contextManager) {

  }

  public void invokePostConstructs(final TextBox instance) {
