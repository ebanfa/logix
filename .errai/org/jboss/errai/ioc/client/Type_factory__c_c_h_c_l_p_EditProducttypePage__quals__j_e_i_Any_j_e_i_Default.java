...
public class Type_factory__c_c_h_c_l_p_EditProducttypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditProducttypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditProducttypePage.class, "Type_factory__c_c_h_c_l_p_EditProducttypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditProducttypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/producttype/edit-producttype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditProducttypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditProducttypePage.class);
  ...
  public EditProducttypePage createInstance(final ContextManager contextManager) {
    final EditProducttypePage instance = new EditProducttypePage();
    ...
    final ProducttypeEditor EditProducttypePage_producttypeEditor = (ProducttypeEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProducttypeEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditProducttypePage_producttypeEditor);
    EditProducttypePage_ProducttypeEditor_producttypeEditor(instance, EditProducttypePage_producttypeEditor);
    ...
    c_c_h_c_l_p_EditProducttypePageTemplateResource templateForEditProducttypePage = GWT.create(c_c_h_c_l_p_EditProducttypePageTemplateResource.class);
    Element parentElementForTemplateOfEditProducttypePage = TemplateUtil.getRootTemplateParentElement(templateForEditProducttypePage.getContents().getText(), "com/cloderia/helion/client/local/producttype/edit-producttype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/producttype/edit-producttype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProducttypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProducttypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.producttype.EditProducttypePage", "com/cloderia/helion/client/local/producttype/edit-producttype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.producttype.EditProducttypePage", "com/cloderia/helion/client/local/producttype/edit-producttype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditProducttypePage_ProducttypeEditor_producttypeEditor(instance));
      }
    ...
    templateFieldsMap.put("producttypeEditor", TemplateWidgetMapper.get(EditProducttypePage_ProducttypeEditor_producttypeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProducttypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditProducttypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditProducttypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditProducttypePage instance) {
  ...
  native static ProducttypeEditor EditProducttypePage_ProducttypeEditor_producttypeEditor(EditProducttypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.producttype.EditProducttypePage::producttypeEditor;
  }-*/;

  native static void EditProducttypePage_ProducttypeEditor_producttypeEditor(EditProducttypePage instance, ProducttypeEditor value) /*-{
    instance.@com.cloderia.helion.client.local.producttype.EditProducttypePage::producttypeEditor = value;
  }-*/;
