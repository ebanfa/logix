...
public class Type_factory__c_c_h_c_l_p_BaseProducttypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseProducttypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseProducttypePage.class, "Type_factory__c_c_h_c_l_p_BaseProducttypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BaseProducttypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/producttype/edit-producttype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BaseProducttypePage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseProducttypePage createInstance(final ContextManager contextManager) {
    final BaseProducttypePage instance = new BaseProducttypePage();
    ...
    c_c_h_c_l_p_BaseProducttypePageTemplateResource templateForBaseProducttypePage = GWT.create(c_c_h_c_l_p_BaseProducttypePageTemplateResource.class);
    Element parentElementForTemplateOfBaseProducttypePage = TemplateUtil.getRootTemplateParentElement(templateForBaseProducttypePage.getContents().getText(), "com/cloderia/helion/client/local/producttype/edit-producttype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/producttype/edit-producttype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProducttypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProducttypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.producttype.BaseProducttypePage", "com/cloderia/helion/client/local/producttype/edit-producttype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProducttypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseProducttypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseProducttypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseProducttypePage instance) {
