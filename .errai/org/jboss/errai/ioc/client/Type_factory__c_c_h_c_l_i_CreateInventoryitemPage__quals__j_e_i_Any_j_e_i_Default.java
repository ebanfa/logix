...
public class Type_factory__c_c_h_c_l_i_CreateInventoryitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateInventoryitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateInventoryitemPage.class, "Type_factory__c_c_h_c_l_i_CreateInventoryitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_CreateInventoryitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_CreateInventoryitemPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateInventoryitemPage.class);
  ...
  public CreateInventoryitemPage createInstance(final ContextManager contextManager) {
    final CreateInventoryitemPage instance = new CreateInventoryitemPage();
    ...
    final InventoryitemEditor CreateInventoryitemPage_inventoryitemEditor = (InventoryitemEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InventoryitemEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateInventoryitemPage_inventoryitemEditor);
    CreateInventoryitemPage_InventoryitemEditor_inventoryitemEditor(instance, CreateInventoryitemPage_inventoryitemEditor);
    ...
    c_c_h_c_l_i_CreateInventoryitemPageTemplateResource templateForCreateInventoryitemPage = GWT.create(c_c_h_c_l_i_CreateInventoryitemPageTemplateResource.class);
    Element parentElementForTemplateOfCreateInventoryitemPage = TemplateUtil.getRootTemplateParentElement(templateForCreateInventoryitemPage.getContents().getText(), "com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInventoryitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInventoryitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.inventoryitem.CreateInventoryitemPage", "com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.inventoryitem.CreateInventoryitemPage", "com/cloderia/helion/client/local/inventoryitem/edit-inventoryitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateInventoryitemPage_InventoryitemEditor_inventoryitemEditor(instance));
      }
    ...
    templateFieldsMap.put("inventoryitemEditor", TemplateWidgetMapper.get(CreateInventoryitemPage_InventoryitemEditor_inventoryitemEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInventoryitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateInventoryitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateInventoryitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateInventoryitemPage instance) {
  ...
  native static InventoryitemEditor CreateInventoryitemPage_InventoryitemEditor_inventoryitemEditor(CreateInventoryitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.inventoryitem.CreateInventoryitemPage::inventoryitemEditor;
  }-*/;

  native static void CreateInventoryitemPage_InventoryitemEditor_inventoryitemEditor(CreateInventoryitemPage instance, InventoryitemEditor value) /*-{
    instance.@com.cloderia.helion.client.local.inventoryitem.CreateInventoryitemPage::inventoryitemEditor = value;
  }-*/;
