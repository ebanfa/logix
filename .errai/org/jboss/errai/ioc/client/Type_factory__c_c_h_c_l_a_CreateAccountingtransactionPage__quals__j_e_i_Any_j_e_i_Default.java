...
public class Type_factory__c_c_h_c_l_a_CreateAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateAccountingtransactionPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateAccountingtransactionPage.class, "Type_factory__c_c_h_c_l_a_CreateAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_a_CreateAccountingtransactionPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/accountingtransaction/edit-accountingtransaction-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_a_CreateAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateAccountingtransactionPage.class);
  ...
  public CreateAccountingtransactionPage createInstance(final ContextManager contextManager) {
    final CreateAccountingtransactionPage instance = new CreateAccountingtransactionPage();
    ...
    final AccountingtransactionEditor CreateAccountingtransactionPage_accountingtransactionEditor = (AccountingtransactionEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_a_AccountingtransactionEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateAccountingtransactionPage_accountingtransactionEditor);
    CreateAccountingtransactionPage_AccountingtransactionEditor_accountingtransactionEditor(instance, CreateAccountingtransactionPage_accountingtransactionEditor);
    ...
    c_c_h_c_l_a_CreateAccountingtransactionPageTemplateResource templateForCreateAccountingtransactionPage = GWT.create(c_c_h_c_l_a_CreateAccountingtransactionPageTemplateResource.class);
    Element parentElementForTemplateOfCreateAccountingtransactionPage = TemplateUtil.getRootTemplateParentElement(templateForCreateAccountingtransactionPage.getContents().getText(), "com/cloderia/helion/client/local/accountingtransaction/edit-accountingtransaction-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/accountingtransaction/edit-accountingtransaction-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateAccountingtransactionPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateAccountingtransactionPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.accountingtransaction.CreateAccountingtransactionPage", "com/cloderia/helion/client/local/accountingtransaction/edit-accountingtransaction-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.accountingtransaction.CreateAccountingtransactionPage", "com/cloderia/helion/client/local/accountingtransaction/edit-accountingtransaction-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateAccountingtransactionPage_AccountingtransactionEditor_accountingtransactionEditor(instance));
      }
    ...
    templateFieldsMap.put("accountingtransactionEditor", TemplateWidgetMapper.get(CreateAccountingtransactionPage_AccountingtransactionEditor_accountingtransactionEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateAccountingtransactionPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateAccountingtransactionPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateAccountingtransactionPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateAccountingtransactionPage instance) {
  ...
  native static AccountingtransactionEditor CreateAccountingtransactionPage_AccountingtransactionEditor_accountingtransactionEditor(CreateAccountingtransactionPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.accountingtransaction.CreateAccountingtransactionPage::accountingtransactionEditor;
  }-*/;

  native static void CreateAccountingtransactionPage_AccountingtransactionEditor_accountingtransactionEditor(CreateAccountingtransactionPage instance, AccountingtransactionEditor value) /*-{
    instance.@com.cloderia.helion.client.local.accountingtransaction.CreateAccountingtransactionPage::accountingtransactionEditor = value;
  }-*/;
