...
public class Type_factory__c_c_h_c_l_u_ListUniversePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListUniversePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListUniversePage.class, "Type_factory__c_c_h_c_l_u_ListUniversePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_u_ListUniversePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/universe/list-universe-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_u_ListUniversePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListUniversePage.class);
  ...
  public ListUniversePage createInstance(final ContextManager contextManager) {
    final ListUniversePage instance = new ListUniversePage();
    ...
    final UniverseListWidget ListUniversePage_listWidget = (UniverseListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_u_UniverseListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListUniversePage_listWidget);
    ListUniversePage_UniverseListWidget_listWidget(instance, ListUniversePage_listWidget);
    ...
    c_c_h_c_l_u_ListUniversePageTemplateResource templateForListUniversePage = GWT.create(c_c_h_c_l_u_ListUniversePageTemplateResource.class);
    Element parentElementForTemplateOfListUniversePage = TemplateUtil.getRootTemplateParentElement(templateForListUniversePage.getContents().getText(), "com/cloderia/helion/client/local/universe/list-universe-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/universe/list-universe-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListUniversePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListUniversePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.universe.ListUniversePage", "com/cloderia/helion/client/local/universe/list-universe-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.universe.ListUniversePage", "com/cloderia/helion/client/local/universe/list-universe-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListUniversePage_UniverseListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.universe.ListUniversePage", "com/cloderia/helion/client/local/universe/list-universe-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListUniversePage_AnchorElement_createNewUniverseLink(instance));
      }
    }, dataFieldElements, "createNewUniverseLink");
    ...
    templateFieldsMap.put("listWidget", ListUniversePage_UniverseListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewUniverseLink", ElementWrapperWidget.getWidget(ListUniversePage_AnchorElement_createNewUniverseLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListUniversePage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewUniverseLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListUniversePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListUniversePage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListUniversePage_AnchorElement_createNewUniverseLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListUniversePage instance) {
  ...
  native static UniverseListWidget ListUniversePage_UniverseListWidget_listWidget(ListUniversePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.universe.ListUniversePage::listWidget;
  }-*/;

  native static void ListUniversePage_UniverseListWidget_listWidget(ListUniversePage instance, UniverseListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.universe.ListUniversePage::listWidget = value;
  }-*/;
  ...
  native static AnchorElement ListUniversePage_AnchorElement_createNewUniverseLink(ListUniversePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.universe.ListUniversePage::createNewUniverseLink;
  }-*/;

  native static void ListUniversePage_AnchorElement_createNewUniverseLink(ListUniversePage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.universe.ListUniversePage::createNewUniverseLink = value;
  }-*/;
