...
public class Type_factory__c_c_h_c_l_b_BaseBillingaccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseBillingaccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseBillingaccountPage.class, "Type_factory__c_c_h_c_l_b_BaseBillingaccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_BaseBillingaccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_BaseBillingaccountPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseBillingaccountPage createInstance(final ContextManager contextManager) {
    final BaseBillingaccountPage instance = new BaseBillingaccountPage();
    ...
    c_c_h_c_l_b_BaseBillingaccountPageTemplateResource templateForBaseBillingaccountPage = GWT.create(c_c_h_c_l_b_BaseBillingaccountPageTemplateResource.class);
    Element parentElementForTemplateOfBaseBillingaccountPage = TemplateUtil.getRootTemplateParentElement(templateForBaseBillingaccountPage.getContents().getText(), "com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseBillingaccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseBillingaccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.billingaccount.BaseBillingaccountPage", "com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseBillingaccountPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseBillingaccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseBillingaccountPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseBillingaccountPage instance) {
