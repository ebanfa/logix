...
public class Type_factory__c_c_h_c_l_p_ViewPartyroletypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewPartyroletypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewPartyroletypePage.class, "Type_factory__c_c_h_c_l_p_ViewPartyroletypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewPartyroletypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partyroletype/view-partyroletype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewPartyroletypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewPartyroletypePage.class);
  ...
  public ViewPartyroletypePage createInstance(final ContextManager contextManager) {
    final ViewPartyroletypePage instance = new ViewPartyroletypePage();
    ...
    final DataBinder ViewPartyroletypePage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Partyroletype.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewPartyroletypePage_binder);
    ViewPartyroletypePage_DataBinder_binder(instance, ViewPartyroletypePage_binder);
    ...
    final PartyroletypeDisplay ViewPartyroletypePage_entityDisplayComponent = (PartyroletypeDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartyroletypeDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewPartyroletypePage_entityDisplayComponent);
    ViewPartyroletypePage_PartyroletypeDisplay_entityDisplayComponent(instance, ViewPartyroletypePage_entityDisplayComponent);
    ...
    c_c_h_c_l_p_ViewPartyroletypePageTemplateResource templateForViewPartyroletypePage = GWT.create(c_c_h_c_l_p_ViewPartyroletypePageTemplateResource.class);
    Element parentElementForTemplateOfViewPartyroletypePage = TemplateUtil.getRootTemplateParentElement(templateForViewPartyroletypePage.getContents().getText(), "com/cloderia/helion/client/local/partyroletype/view-partyroletype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partyroletype/view-partyroletype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartyroletypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartyroletypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyroletype.ViewPartyroletypePage", "com/cloderia/helion/client/local/partyroletype/view-partyroletype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyroletype.ViewPartyroletypePage", "com/cloderia/helion/client/local/partyroletype/view-partyroletype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewPartyroletypePage_PartyroletypeDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewPartyroletypePage_PartyroletypeDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartyroletypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewPartyroletypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewPartyroletypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewPartyroletypePage instance) {
  ...
  native static DataBinder ViewPartyroletypePage_DataBinder_binder(ViewPartyroletypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partyroletype.ViewPartyroletypePage::binder;
  }-*/;

  native static void ViewPartyroletypePage_DataBinder_binder(ViewPartyroletypePage instance, DataBinder<Partyroletype> value) /*-{
    instance.@com.cloderia.helion.client.local.partyroletype.ViewPartyroletypePage::binder = value;
  }-*/;

  native static PartyroletypeDisplay ViewPartyroletypePage_PartyroletypeDisplay_entityDisplayComponent(ViewPartyroletypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partyroletype.ViewPartyroletypePage::entityDisplayComponent;
  }-*/;

  native static void ViewPartyroletypePage_PartyroletypeDisplay_entityDisplayComponent(ViewPartyroletypePage instance, PartyroletypeDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.partyroletype.ViewPartyroletypePage::entityDisplayComponent = value;
  }-*/;
