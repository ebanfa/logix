...
public class Type_factory__c_c_h_c_l_o_ListOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListOrganizationglaccountbalancePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListOrganizationglaccountbalancePage.class, "Type_factory__c_c_h_c_l_o_ListOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_ListOrganizationglaccountbalancePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organizationglaccountbalance/list-organizationglaccountbalance-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_ListOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListOrganizationglaccountbalancePage.class);
  ...
  public ListOrganizationglaccountbalancePage createInstance(final ContextManager contextManager) {
    final ListOrganizationglaccountbalancePage instance = new ListOrganizationglaccountbalancePage();
    ...
    final OrganizationglaccountbalanceListWidget ListOrganizationglaccountbalancePage_listWidget = (OrganizationglaccountbalanceListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_o_OrganizationglaccountbalanceListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListOrganizationglaccountbalancePage_listWidget);
    ListOrganizationglaccountbalancePage_OrganizationglaccountbalanceListWidget_listWidget(instance, ListOrganizationglaccountbalancePage_listWidget);
    ...
    c_c_h_c_l_o_ListOrganizationglaccountbalancePageTemplateResource templateForListOrganizationglaccountbalancePage = GWT.create(c_c_h_c_l_o_ListOrganizationglaccountbalancePageTemplateResource.class);
    Element parentElementForTemplateOfListOrganizationglaccountbalancePage = TemplateUtil.getRootTemplateParentElement(templateForListOrganizationglaccountbalancePage.getContents().getText(), "com/cloderia/helion/client/local/organizationglaccountbalance/list-organizationglaccountbalance-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organizationglaccountbalance/list-organizationglaccountbalance-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListOrganizationglaccountbalancePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListOrganizationglaccountbalancePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationglaccountbalance.ListOrganizationglaccountbalancePage", "com/cloderia/helion/client/local/organizationglaccountbalance/list-organizationglaccountbalance-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationglaccountbalance.ListOrganizationglaccountbalancePage", "com/cloderia/helion/client/local/organizationglaccountbalance/list-organizationglaccountbalance-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListOrganizationglaccountbalancePage_OrganizationglaccountbalanceListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationglaccountbalance.ListOrganizationglaccountbalancePage", "com/cloderia/helion/client/local/organizationglaccountbalance/list-organizationglaccountbalance-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListOrganizationglaccountbalancePage_AnchorElement_createNewOrganizationglaccountbalanceLink(instance));
      }
    }, dataFieldElements, "createNewOrganizationglaccountbalanceLink");
    ...
    templateFieldsMap.put("listWidget", ListOrganizationglaccountbalancePage_OrganizationglaccountbalanceListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewOrganizationglaccountbalanceLink", ElementWrapperWidget.getWidget(ListOrganizationglaccountbalancePage_AnchorElement_createNewOrganizationglaccountbalanceLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListOrganizationglaccountbalancePage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewOrganizationglaccountbalanceLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListOrganizationglaccountbalancePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListOrganizationglaccountbalancePage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListOrganizationglaccountbalancePage_AnchorElement_createNewOrganizationglaccountbalanceLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListOrganizationglaccountbalancePage instance) {
  ...
  native static AnchorElement ListOrganizationglaccountbalancePage_AnchorElement_createNewOrganizationglaccountbalanceLink(ListOrganizationglaccountbalancePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organizationglaccountbalance.ListOrganizationglaccountbalancePage::createNewOrganizationglaccountbalanceLink;
  }-*/;

  native static void ListOrganizationglaccountbalancePage_AnchorElement_createNewOrganizationglaccountbalanceLink(ListOrganizationglaccountbalancePage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.organizationglaccountbalance.ListOrganizationglaccountbalancePage::createNewOrganizationglaccountbalanceLink = value;
  }-*/;
  ...
  native static OrganizationglaccountbalanceListWidget ListOrganizationglaccountbalancePage_OrganizationglaccountbalanceListWidget_listWidget(ListOrganizationglaccountbalancePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organizationglaccountbalance.ListOrganizationglaccountbalancePage::listWidget;
  }-*/;

  native static void ListOrganizationglaccountbalancePage_OrganizationglaccountbalanceListWidget_listWidget(ListOrganizationglaccountbalancePage instance, OrganizationglaccountbalanceListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.organizationglaccountbalance.ListOrganizationglaccountbalancePage::listWidget = value;
  }-*/;
