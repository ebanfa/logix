...
public class Type_factory__c_c_h_c_l_o_ListOrganizationgeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListOrganizationgeneralledgeraccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListOrganizationgeneralledgeraccountPage.class, "Type_factory__c_c_h_c_l_o_ListOrganizationgeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_ListOrganizationgeneralledgeraccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organizationgeneralledgeraccount/list-organizationgeneralledgeraccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_ListOrganizationgeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListOrganizationgeneralledgeraccountPage.class);
  ...
  public ListOrganizationgeneralledgeraccountPage createInstance(final ContextManager contextManager) {
    final ListOrganizationgeneralledgeraccountPage instance = new ListOrganizationgeneralledgeraccountPage();
    ...
    final OrganizationgeneralledgeraccountListWidget ListOrganizationgeneralledgeraccountPage_listWidget = (OrganizationgeneralledgeraccountListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_o_OrganizationgeneralledgeraccountListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListOrganizationgeneralledgeraccountPage_listWidget);
    ListOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountListWidget_listWidget(instance, ListOrganizationgeneralledgeraccountPage_listWidget);
    ...
    c_c_h_c_l_o_ListOrganizationgeneralledgeraccountPageTemplateResource templateForListOrganizationgeneralledgeraccountPage = GWT.create(c_c_h_c_l_o_ListOrganizationgeneralledgeraccountPageTemplateResource.class);
    Element parentElementForTemplateOfListOrganizationgeneralledgeraccountPage = TemplateUtil.getRootTemplateParentElement(templateForListOrganizationgeneralledgeraccountPage.getContents().getText(), "com/cloderia/helion/client/local/organizationgeneralledgeraccount/list-organizationgeneralledgeraccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organizationgeneralledgeraccount/list-organizationgeneralledgeraccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListOrganizationgeneralledgeraccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListOrganizationgeneralledgeraccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationgeneralledgeraccount.ListOrganizationgeneralledgeraccountPage", "com/cloderia/helion/client/local/organizationgeneralledgeraccount/list-organizationgeneralledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationgeneralledgeraccount.ListOrganizationgeneralledgeraccountPage", "com/cloderia/helion/client/local/organizationgeneralledgeraccount/list-organizationgeneralledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationgeneralledgeraccount.ListOrganizationgeneralledgeraccountPage", "com/cloderia/helion/client/local/organizationgeneralledgeraccount/list-organizationgeneralledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListOrganizationgeneralledgeraccountPage_AnchorElement_createNewOrganizationgeneralledgeraccountLink(instance));
      }
    }, dataFieldElements, "createNewOrganizationgeneralledgeraccountLink");
    ...
    templateFieldsMap.put("listWidget", ListOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewOrganizationgeneralledgeraccountLink", ElementWrapperWidget.getWidget(ListOrganizationgeneralledgeraccountPage_AnchorElement_createNewOrganizationgeneralledgeraccountLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListOrganizationgeneralledgeraccountPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewOrganizationgeneralledgeraccountLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListOrganizationgeneralledgeraccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListOrganizationgeneralledgeraccountPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListOrganizationgeneralledgeraccountPage_AnchorElement_createNewOrganizationgeneralledgeraccountLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListOrganizationgeneralledgeraccountPage instance) {
  ...
  native static OrganizationgeneralledgeraccountListWidget ListOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountListWidget_listWidget(ListOrganizationgeneralledgeraccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organizationgeneralledgeraccount.ListOrganizationgeneralledgeraccountPage::listWidget;
  }-*/;

  native static void ListOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountListWidget_listWidget(ListOrganizationgeneralledgeraccountPage instance, OrganizationgeneralledgeraccountListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.organizationgeneralledgeraccount.ListOrganizationgeneralledgeraccountPage::listWidget = value;
  }-*/;
  ...
  native static AnchorElement ListOrganizationgeneralledgeraccountPage_AnchorElement_createNewOrganizationgeneralledgeraccountLink(ListOrganizationgeneralledgeraccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organizationgeneralledgeraccount.ListOrganizationgeneralledgeraccountPage::createNewOrganizationgeneralledgeraccountLink;
  }-*/;

  native static void ListOrganizationgeneralledgeraccountPage_AnchorElement_createNewOrganizationgeneralledgeraccountLink(ListOrganizationgeneralledgeraccountPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.organizationgeneralledgeraccount.ListOrganizationgeneralledgeraccountPage::createNewOrganizationgeneralledgeraccountLink = value;
  }-*/;
