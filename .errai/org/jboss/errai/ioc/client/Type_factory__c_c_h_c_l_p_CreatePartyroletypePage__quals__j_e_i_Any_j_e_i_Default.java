...
public class Type_factory__c_c_h_c_l_p_CreatePartyroletypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreatePartyroletypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreatePartyroletypePage.class, "Type_factory__c_c_h_c_l_p_CreatePartyroletypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_CreatePartyroletypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_CreatePartyroletypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreatePartyroletypePage.class);
  ...
  public CreatePartyroletypePage createInstance(final ContextManager contextManager) {
    final CreatePartyroletypePage instance = new CreatePartyroletypePage();
    ...
    final PartyroletypeEditor CreatePartyroletypePage_partyroletypeEditor = (PartyroletypeEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartyroletypeEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreatePartyroletypePage_partyroletypeEditor);
    CreatePartyroletypePage_PartyroletypeEditor_partyroletypeEditor(instance, CreatePartyroletypePage_partyroletypeEditor);
    ...
    c_c_h_c_l_p_CreatePartyroletypePageTemplateResource templateForCreatePartyroletypePage = GWT.create(c_c_h_c_l_p_CreatePartyroletypePageTemplateResource.class);
    Element parentElementForTemplateOfCreatePartyroletypePage = TemplateUtil.getRootTemplateParentElement(templateForCreatePartyroletypePage.getContents().getText(), "com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePartyroletypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePartyroletypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyroletype.CreatePartyroletypePage", "com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyroletype.CreatePartyroletypePage", "com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreatePartyroletypePage_PartyroletypeEditor_partyroletypeEditor(instance));
      }
    ...
    templateFieldsMap.put("partyroletypeEditor", TemplateWidgetMapper.get(CreatePartyroletypePage_PartyroletypeEditor_partyroletypeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePartyroletypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreatePartyroletypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreatePartyroletypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreatePartyroletypePage instance) {
  ...
  native static PartyroletypeEditor CreatePartyroletypePage_PartyroletypeEditor_partyroletypeEditor(CreatePartyroletypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partyroletype.CreatePartyroletypePage::partyroletypeEditor;
  }-*/;

  native static void CreatePartyroletypePage_PartyroletypeEditor_partyroletypeEditor(CreatePartyroletypePage instance, PartyroletypeEditor value) /*-{
    instance.@com.cloderia.helion.client.local.partyroletype.CreatePartyroletypePage::partyroletypeEditor = value;
  }-*/;
