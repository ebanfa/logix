...
public class Type_factory__c_c_h_c_l_u_CreateUniversePage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateUniversePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateUniversePage.class, "Type_factory__c_c_h_c_l_u_CreateUniversePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_u_CreateUniversePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/universe/edit-universe-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_u_CreateUniversePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateUniversePage.class);
  ...
  public CreateUniversePage createInstance(final ContextManager contextManager) {
    final CreateUniversePage instance = new CreateUniversePage();
    ...
    final UniverseEditor CreateUniversePage_universeEditor = (UniverseEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_u_UniverseEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateUniversePage_universeEditor);
    CreateUniversePage_UniverseEditor_universeEditor(instance, CreateUniversePage_universeEditor);
    ...
    c_c_h_c_l_u_CreateUniversePageTemplateResource templateForCreateUniversePage = GWT.create(c_c_h_c_l_u_CreateUniversePageTemplateResource.class);
    Element parentElementForTemplateOfCreateUniversePage = TemplateUtil.getRootTemplateParentElement(templateForCreateUniversePage.getContents().getText(), "com/cloderia/helion/client/local/universe/edit-universe-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/universe/edit-universe-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateUniversePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateUniversePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.universe.CreateUniversePage", "com/cloderia/helion/client/local/universe/edit-universe-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.universe.CreateUniversePage", "com/cloderia/helion/client/local/universe/edit-universe-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateUniversePage_UniverseEditor_universeEditor(instance));
      }
    ...
    templateFieldsMap.put("universeEditor", TemplateWidgetMapper.get(CreateUniversePage_UniverseEditor_universeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateUniversePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateUniversePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateUniversePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateUniversePage instance) {
  ...
  native static UniverseEditor CreateUniversePage_UniverseEditor_universeEditor(CreateUniversePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.universe.CreateUniversePage::universeEditor;
  }-*/;

  native static void CreateUniversePage_UniverseEditor_universeEditor(CreateUniversePage instance, UniverseEditor value) /*-{
    instance.@com.cloderia.helion.client.local.universe.CreateUniversePage::universeEditor = value;
  }-*/;
