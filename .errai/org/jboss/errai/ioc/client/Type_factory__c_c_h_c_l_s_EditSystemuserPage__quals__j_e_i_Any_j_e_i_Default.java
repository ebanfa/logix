...
public class Type_factory__c_c_h_c_l_s_EditSystemuserPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditSystemuserPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditSystemuserPage.class, "Type_factory__c_c_h_c_l_s_EditSystemuserPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_s_EditSystemuserPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/systemuser/edit-systemuser-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_s_EditSystemuserPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditSystemuserPage.class);
  ...
  public EditSystemuserPage createInstance(final ContextManager contextManager) {
    final EditSystemuserPage instance = new EditSystemuserPage();
    ...
    final SystemuserEditor EditSystemuserPage_systemuserEditor = (SystemuserEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_s_SystemuserEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditSystemuserPage_systemuserEditor);
    EditSystemuserPage_SystemuserEditor_systemuserEditor(instance, EditSystemuserPage_systemuserEditor);
    ...
    c_c_h_c_l_s_EditSystemuserPageTemplateResource templateForEditSystemuserPage = GWT.create(c_c_h_c_l_s_EditSystemuserPageTemplateResource.class);
    Element parentElementForTemplateOfEditSystemuserPage = TemplateUtil.getRootTemplateParentElement(templateForEditSystemuserPage.getContents().getText(), "com/cloderia/helion/client/local/systemuser/edit-systemuser-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/systemuser/edit-systemuser-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditSystemuserPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditSystemuserPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.systemuser.EditSystemuserPage", "com/cloderia/helion/client/local/systemuser/edit-systemuser-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.systemuser.EditSystemuserPage", "com/cloderia/helion/client/local/systemuser/edit-systemuser-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditSystemuserPage_SystemuserEditor_systemuserEditor(instance));
      }
    ...
    templateFieldsMap.put("systemuserEditor", TemplateWidgetMapper.get(EditSystemuserPage_SystemuserEditor_systemuserEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditSystemuserPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditSystemuserPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditSystemuserPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditSystemuserPage instance) {
  ...
  native static SystemuserEditor EditSystemuserPage_SystemuserEditor_systemuserEditor(EditSystemuserPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.systemuser.EditSystemuserPage::systemuserEditor;
  }-*/;

  native static void EditSystemuserPage_SystemuserEditor_systemuserEditor(EditSystemuserPage instance, SystemuserEditor value) /*-{
    instance.@com.cloderia.helion.client.local.systemuser.EditSystemuserPage::systemuserEditor = value;
  }-*/;
