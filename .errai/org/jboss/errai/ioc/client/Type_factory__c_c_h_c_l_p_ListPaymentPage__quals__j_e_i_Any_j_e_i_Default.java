...
public class Type_factory__c_c_h_c_l_p_ListPaymentPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListPaymentPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListPaymentPage.class, "Type_factory__c_c_h_c_l_p_ListPaymentPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ListPaymentPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/payment/list-payment-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ListPaymentPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListPaymentPage.class);
  ...
  public ListPaymentPage createInstance(final ContextManager contextManager) {
    final ListPaymentPage instance = new ListPaymentPage();
    ...
    final PaymentListWidget ListPaymentPage_listWidget = (PaymentListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PaymentListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListPaymentPage_listWidget);
    ListPaymentPage_PaymentListWidget_listWidget(instance, ListPaymentPage_listWidget);
    ...
    c_c_h_c_l_p_ListPaymentPageTemplateResource templateForListPaymentPage = GWT.create(c_c_h_c_l_p_ListPaymentPageTemplateResource.class);
    Element parentElementForTemplateOfListPaymentPage = TemplateUtil.getRootTemplateParentElement(templateForListPaymentPage.getContents().getText(), "com/cloderia/helion/client/local/payment/list-payment-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/payment/list-payment-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPaymentPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPaymentPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.payment.ListPaymentPage", "com/cloderia/helion/client/local/payment/list-payment-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.payment.ListPaymentPage", "com/cloderia/helion/client/local/payment/list-payment-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListPaymentPage_PaymentListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.payment.ListPaymentPage", "com/cloderia/helion/client/local/payment/list-payment-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListPaymentPage_AnchorElement_createNewPaymentLink(instance));
      }
    }, dataFieldElements, "createNewPaymentLink");
    ...
    templateFieldsMap.put("listWidget", ListPaymentPage_PaymentListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewPaymentLink", ElementWrapperWidget.getWidget(ListPaymentPage_AnchorElement_createNewPaymentLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPaymentPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewPaymentLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListPaymentPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListPaymentPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListPaymentPage_AnchorElement_createNewPaymentLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListPaymentPage instance) {
  ...
  native static PaymentListWidget ListPaymentPage_PaymentListWidget_listWidget(ListPaymentPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.payment.ListPaymentPage::listWidget;
  }-*/;

  native static void ListPaymentPage_PaymentListWidget_listWidget(ListPaymentPage instance, PaymentListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.payment.ListPaymentPage::listWidget = value;
  }-*/;
  ...
  native static AnchorElement ListPaymentPage_AnchorElement_createNewPaymentLink(ListPaymentPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.payment.ListPaymentPage::createNewPaymentLink;
  }-*/;

  native static void ListPaymentPage_AnchorElement_createNewPaymentLink(ListPaymentPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.payment.ListPaymentPage::createNewPaymentLink = value;
  }-*/;
}