...
public class QualifierEqualityFactoryImpl implements QualifierEqualityFactory {
  ...
  public QualifierEqualityFactoryImpl() {
    comparatorMap.put("com.cloderia.helion.client.shared.Operation", new AnnotationComparator<Operation>() {
      @Override public boolean isEqual(Operation a1, Operation a2) {
        if (!a1.value().equals(a2.value())) {
          return false;
        }
        return true;
      }
      public int hashCodeOf(Operation a1) {
