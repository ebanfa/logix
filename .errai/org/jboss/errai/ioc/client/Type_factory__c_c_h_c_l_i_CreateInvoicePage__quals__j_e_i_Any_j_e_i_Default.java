...
public class Type_factory__c_c_h_c_l_i_CreateInvoicePage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateInvoicePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateInvoicePage.class, "Type_factory__c_c_h_c_l_i_CreateInvoicePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_CreateInvoicePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoice/edit-invoice-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_CreateInvoicePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateInvoicePage.class);
  ...
  public CreateInvoicePage createInstance(final ContextManager contextManager) {
    final CreateInvoicePage instance = new CreateInvoicePage();
    ...
    final InvoiceEditor CreateInvoicePage_invoiceEditor = (InvoiceEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InvoiceEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateInvoicePage_invoiceEditor);
    CreateInvoicePage_InvoiceEditor_invoiceEditor(instance, CreateInvoicePage_invoiceEditor);
    ...
    c_c_h_c_l_i_CreateInvoicePageTemplateResource templateForCreateInvoicePage = GWT.create(c_c_h_c_l_i_CreateInvoicePageTemplateResource.class);
    Element parentElementForTemplateOfCreateInvoicePage = TemplateUtil.getRootTemplateParentElement(templateForCreateInvoicePage.getContents().getText(), "com/cloderia/helion/client/local/invoice/edit-invoice-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoice/edit-invoice-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInvoicePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInvoicePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoice.CreateInvoicePage", "com/cloderia/helion/client/local/invoice/edit-invoice-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoice.CreateInvoicePage", "com/cloderia/helion/client/local/invoice/edit-invoice-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateInvoicePage_InvoiceEditor_invoiceEditor(instance));
      }
    ...
    templateFieldsMap.put("invoiceEditor", TemplateWidgetMapper.get(CreateInvoicePage_InvoiceEditor_invoiceEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInvoicePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateInvoicePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateInvoicePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateInvoicePage instance) {
  ...
  native static InvoiceEditor CreateInvoicePage_InvoiceEditor_invoiceEditor(CreateInvoicePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoice.CreateInvoicePage::invoiceEditor;
  }-*/;

  native static void CreateInvoicePage_InvoiceEditor_invoiceEditor(CreateInvoicePage instance, InvoiceEditor value) /*-{
    instance.@com.cloderia.helion.client.local.invoice.CreateInvoicePage::invoiceEditor = value;
  }-*/;
