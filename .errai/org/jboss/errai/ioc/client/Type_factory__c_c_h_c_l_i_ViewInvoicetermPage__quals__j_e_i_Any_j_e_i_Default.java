...
public class Type_factory__c_c_h_c_l_i_ViewInvoicetermPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewInvoicetermPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewInvoicetermPage.class, "Type_factory__c_c_h_c_l_i_ViewInvoicetermPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_ViewInvoicetermPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoiceterm/view-invoiceterm-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_ViewInvoicetermPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewInvoicetermPage.class);
  ...
  public ViewInvoicetermPage createInstance(final ContextManager contextManager) {
    final ViewInvoicetermPage instance = new ViewInvoicetermPage();
    ...
    final DataBinder ViewInvoicetermPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Invoiceterm.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewInvoicetermPage_binder);
    ViewInvoicetermPage_DataBinder_binder(instance, ViewInvoicetermPage_binder);
    ...
    final InvoicetermDisplay ViewInvoicetermPage_entityDisplayComponent = (InvoicetermDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InvoicetermDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewInvoicetermPage_entityDisplayComponent);
    ViewInvoicetermPage_InvoicetermDisplay_entityDisplayComponent(instance, ViewInvoicetermPage_entityDisplayComponent);
    ...
    c_c_h_c_l_i_ViewInvoicetermPageTemplateResource templateForViewInvoicetermPage = GWT.create(c_c_h_c_l_i_ViewInvoicetermPageTemplateResource.class);
    Element parentElementForTemplateOfViewInvoicetermPage = TemplateUtil.getRootTemplateParentElement(templateForViewInvoicetermPage.getContents().getText(), "com/cloderia/helion/client/local/invoiceterm/view-invoiceterm-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoiceterm/view-invoiceterm-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInvoicetermPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInvoicetermPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceterm.ViewInvoicetermPage", "com/cloderia/helion/client/local/invoiceterm/view-invoiceterm-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceterm.ViewInvoicetermPage", "com/cloderia/helion/client/local/invoiceterm/view-invoiceterm-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewInvoicetermPage_InvoicetermDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewInvoicetermPage_InvoicetermDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInvoicetermPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewInvoicetermPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewInvoicetermPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewInvoicetermPage instance) {
  ...
  native static DataBinder ViewInvoicetermPage_DataBinder_binder(ViewInvoicetermPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoiceterm.ViewInvoicetermPage::binder;
  }-*/;

  native static void ViewInvoicetermPage_DataBinder_binder(ViewInvoicetermPage instance, DataBinder<Invoiceterm> value) /*-{
    instance.@com.cloderia.helion.client.local.invoiceterm.ViewInvoicetermPage::binder = value;
  }-*/;
  ...
  native static InvoicetermDisplay ViewInvoicetermPage_InvoicetermDisplay_entityDisplayComponent(ViewInvoicetermPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoiceterm.ViewInvoicetermPage::entityDisplayComponent;
  }-*/;

  native static void ViewInvoicetermPage_InvoicetermDisplay_entityDisplayComponent(ViewInvoicetermPage instance, InvoicetermDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.invoiceterm.ViewInvoicetermPage::entityDisplayComponent = value;
  }-*/;
