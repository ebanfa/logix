...
public class Type_factory__c_c_h_c_l_p_ViewProductfeaturePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewProductfeaturePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewProductfeaturePage.class, "Type_factory__c_c_h_c_l_p_ViewProductfeaturePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewProductfeaturePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productfeature/view-productfeature-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewProductfeaturePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewProductfeaturePage.class);
  ...
  public ViewProductfeaturePage createInstance(final ContextManager contextManager) {
    final ViewProductfeaturePage instance = new ViewProductfeaturePage();
    setIncompleteInstance(instance);
    final ProductfeatureDisplay ViewProductfeaturePage_entityDisplayComponent = (ProductfeatureDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductfeatureDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewProductfeaturePage_entityDisplayComponent);
    ViewProductfeaturePage_ProductfeatureDisplay_entityDisplayComponent(instance, ViewProductfeaturePage_entityDisplayComponent);
    ...
    final DataBinder ViewProductfeaturePage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Productfeature.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewProductfeaturePage_binder);
    ViewProductfeaturePage_DataBinder_binder(instance, ViewProductfeaturePage_binder);
    ...
    c_c_h_c_l_p_ViewProductfeaturePageTemplateResource templateForViewProductfeaturePage = GWT.create(c_c_h_c_l_p_ViewProductfeaturePageTemplateResource.class);
    Element parentElementForTemplateOfViewProductfeaturePage = TemplateUtil.getRootTemplateParentElement(templateForViewProductfeaturePage.getContents().getText(), "com/cloderia/helion/client/local/productfeature/view-productfeature-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productfeature/view-productfeature-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductfeaturePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductfeaturePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeature.ViewProductfeaturePage", "com/cloderia/helion/client/local/productfeature/view-productfeature-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeature.ViewProductfeaturePage", "com/cloderia/helion/client/local/productfeature/view-productfeature-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewProductfeaturePage_ProductfeatureDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewProductfeaturePage_ProductfeatureDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductfeaturePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewProductfeaturePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewProductfeaturePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewProductfeaturePage instance) {
  ...
  native static DataBinder ViewProductfeaturePage_DataBinder_binder(ViewProductfeaturePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeature.ViewProductfeaturePage::binder;
  }-*/;

  native static void ViewProductfeaturePage_DataBinder_binder(ViewProductfeaturePage instance, DataBinder<Productfeature> value) /*-{
    instance.@com.cloderia.helion.client.local.productfeature.ViewProductfeaturePage::binder = value;
  }-*/;
  ...
  native static ProductfeatureDisplay ViewProductfeaturePage_ProductfeatureDisplay_entityDisplayComponent(ViewProductfeaturePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeature.ViewProductfeaturePage::entityDisplayComponent;
  }-*/;

  native static void ViewProductfeaturePage_ProductfeatureDisplay_entityDisplayComponent(ViewProductfeaturePage instance, ProductfeatureDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.productfeature.ViewProductfeaturePage::entityDisplayComponent = value;
  }-*/;
