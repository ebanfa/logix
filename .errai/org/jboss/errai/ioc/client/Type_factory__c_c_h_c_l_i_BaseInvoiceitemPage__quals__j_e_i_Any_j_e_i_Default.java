...
public class Type_factory__c_c_h_c_l_i_BaseInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseInvoiceitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseInvoiceitemPage.class, "Type_factory__c_c_h_c_l_i_BaseInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_BaseInvoiceitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_BaseInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseInvoiceitemPage createInstance(final ContextManager contextManager) {
    final BaseInvoiceitemPage instance = new BaseInvoiceitemPage();
    ...
    c_c_h_c_l_i_BaseInvoiceitemPageTemplateResource templateForBaseInvoiceitemPage = GWT.create(c_c_h_c_l_i_BaseInvoiceitemPageTemplateResource.class);
    Element parentElementForTemplateOfBaseInvoiceitemPage = TemplateUtil.getRootTemplateParentElement(templateForBaseInvoiceitemPage.getContents().getText(), "com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseInvoiceitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseInvoiceitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceitem.BaseInvoiceitemPage", "com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseInvoiceitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseInvoiceitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseInvoiceitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseInvoiceitemPage instance) {
