...
public class Type_factory__c_c_h_c_l_p_CreateProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateProductfeaturetypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateProductfeaturetypePage.class, "Type_factory__c_c_h_c_l_p_CreateProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_CreateProductfeaturetypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_CreateProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateProductfeaturetypePage.class);
  ...
  public CreateProductfeaturetypePage createInstance(final ContextManager contextManager) {
    final CreateProductfeaturetypePage instance = new CreateProductfeaturetypePage();
    ...
    final ProductfeaturetypeEditor CreateProductfeaturetypePage_productfeaturetypeEditor = (ProductfeaturetypeEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductfeaturetypeEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateProductfeaturetypePage_productfeaturetypeEditor);
    CreateProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(instance, CreateProductfeaturetypePage_productfeaturetypeEditor);
    ...
    c_c_h_c_l_p_CreateProductfeaturetypePageTemplateResource templateForCreateProductfeaturetypePage = GWT.create(c_c_h_c_l_p_CreateProductfeaturetypePageTemplateResource.class);
    Element parentElementForTemplateOfCreateProductfeaturetypePage = TemplateUtil.getRootTemplateParentElement(templateForCreateProductfeaturetypePage.getContents().getText(), "com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductfeaturetypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductfeaturetypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeaturetype.CreateProductfeaturetypePage", "com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeaturetype.CreateProductfeaturetypePage", "com/cloderia/helion/client/local/productfeaturetype/edit-productfeaturetype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(instance));
      }
    ...
    templateFieldsMap.put("productfeaturetypeEditor", TemplateWidgetMapper.get(CreateProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductfeaturetypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateProductfeaturetypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateProductfeaturetypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateProductfeaturetypePage instance) {
  ...
  native static ProductfeaturetypeEditor CreateProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(CreateProductfeaturetypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeaturetype.CreateProductfeaturetypePage::productfeaturetypeEditor;
  }-*/;

  native static void CreateProductfeaturetypePage_ProductfeaturetypeEditor_productfeaturetypeEditor(CreateProductfeaturetypePage instance, ProductfeaturetypeEditor value) /*-{
    instance.@com.cloderia.helion.client.local.productfeaturetype.CreateProductfeaturetypePage::productfeaturetypeEditor = value;
  }-*/;
