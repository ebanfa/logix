...
public class Type_factory__c_c_h_c_l_o_EditOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditOrganizationglaccountbalancePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditOrganizationglaccountbalancePage.class, "Type_factory__c_c_h_c_l_o_EditOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_EditOrganizationglaccountbalancePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_EditOrganizationglaccountbalancePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditOrganizationglaccountbalancePage.class);
  ...
  public EditOrganizationglaccountbalancePage createInstance(final ContextManager contextManager) {
    final EditOrganizationglaccountbalancePage instance = new EditOrganizationglaccountbalancePage();
    ...
    final OrganizationglaccountbalanceEditor EditOrganizationglaccountbalancePage_organizationglaccountbalanceEditor = (OrganizationglaccountbalanceEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_o_OrganizationglaccountbalanceEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditOrganizationglaccountbalancePage_organizationglaccountbalanceEditor);
    EditOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(instance, EditOrganizationglaccountbalancePage_organizationglaccountbalanceEditor);
    ...
    c_c_h_c_l_o_EditOrganizationglaccountbalancePageTemplateResource templateForEditOrganizationglaccountbalancePage = GWT.create(c_c_h_c_l_o_EditOrganizationglaccountbalancePageTemplateResource.class);
    Element parentElementForTemplateOfEditOrganizationglaccountbalancePage = TemplateUtil.getRootTemplateParentElement(templateForEditOrganizationglaccountbalancePage.getContents().getText(), "com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditOrganizationglaccountbalancePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditOrganizationglaccountbalancePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationglaccountbalance.EditOrganizationglaccountbalancePage", "com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationglaccountbalance.EditOrganizationglaccountbalancePage", "com/cloderia/helion/client/local/organizationglaccountbalance/edit-organizationglaccountbalance-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(instance));
      }
    ...
    templateFieldsMap.put("organizationglaccountbalanceEditor", TemplateWidgetMapper.get(EditOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditOrganizationglaccountbalancePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditOrganizationglaccountbalancePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditOrganizationglaccountbalancePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditOrganizationglaccountbalancePage instance) {
  ...
  native static OrganizationglaccountbalanceEditor EditOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(EditOrganizationglaccountbalancePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organizationglaccountbalance.EditOrganizationglaccountbalancePage::organizationglaccountbalanceEditor;
  }-*/;

  native static void EditOrganizationglaccountbalancePage_OrganizationglaccountbalanceEditor_organizationglaccountbalanceEditor(EditOrganizationglaccountbalancePage instance, OrganizationglaccountbalanceEditor value) /*-{
    instance.@com.cloderia.helion.client.local.organizationglaccountbalance.EditOrganizationglaccountbalancePage::organizationglaccountbalanceEditor = value;
  }-*/;
