...
public class Type_factory__c_c_h_c_l_p_CreateProductPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateProductPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateProductPage.class, "Type_factory__c_c_h_c_l_p_CreateProductPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_CreateProductPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/product/edit-product-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_CreateProductPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateProductPage.class);
  ...
  public CreateProductPage createInstance(final ContextManager contextManager) {
    final CreateProductPage instance = new CreateProductPage();
    ...
    final ProductEditor CreateProductPage_productEditor = (ProductEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateProductPage_productEditor);
    CreateProductPage_ProductEditor_productEditor(instance, CreateProductPage_productEditor);
    ...
    c_c_h_c_l_p_CreateProductPageTemplateResource templateForCreateProductPage = GWT.create(c_c_h_c_l_p_CreateProductPageTemplateResource.class);
    Element parentElementForTemplateOfCreateProductPage = TemplateUtil.getRootTemplateParentElement(templateForCreateProductPage.getContents().getText(), "com/cloderia/helion/client/local/product/edit-product-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/product/edit-product-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.product.CreateProductPage", "com/cloderia/helion/client/local/product/edit-product-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.product.CreateProductPage", "com/cloderia/helion/client/local/product/edit-product-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateProductPage_ProductEditor_productEditor(instance));
      }
    ...
    templateFieldsMap.put("productEditor", TemplateWidgetMapper.get(CreateProductPage_ProductEditor_productEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateProductPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateProductPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateProductPage instance) {
  ...
  native static ProductEditor CreateProductPage_ProductEditor_productEditor(CreateProductPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.product.CreateProductPage::productEditor;
  }-*/;

  native static void CreateProductPage_ProductEditor_productEditor(CreateProductPage instance, ProductEditor value) /*-{
    instance.@com.cloderia.helion.client.local.product.CreateProductPage::productEditor = value;
  }-*/;
