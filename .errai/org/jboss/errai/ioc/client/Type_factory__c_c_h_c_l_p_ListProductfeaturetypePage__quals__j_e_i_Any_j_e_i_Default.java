...
public class Type_factory__c_c_h_c_l_p_ListProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListProductfeaturetypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListProductfeaturetypePage.class, "Type_factory__c_c_h_c_l_p_ListProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ListProductfeaturetypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productfeaturetype/list-productfeaturetype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ListProductfeaturetypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListProductfeaturetypePage.class);
  ...
  public ListProductfeaturetypePage createInstance(final ContextManager contextManager) {
    final ListProductfeaturetypePage instance = new ListProductfeaturetypePage();
    setIncompleteInstance(instance);
    final ProductfeaturetypeListWidget ListProductfeaturetypePage_listWidget = (ProductfeaturetypeListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductfeaturetypeListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListProductfeaturetypePage_listWidget);
    ListProductfeaturetypePage_ProductfeaturetypeListWidget_listWidget(instance, ListProductfeaturetypePage_listWidget);
    ...
    c_c_h_c_l_p_ListProductfeaturetypePageTemplateResource templateForListProductfeaturetypePage = GWT.create(c_c_h_c_l_p_ListProductfeaturetypePageTemplateResource.class);
    Element parentElementForTemplateOfListProductfeaturetypePage = TemplateUtil.getRootTemplateParentElement(templateForListProductfeaturetypePage.getContents().getText(), "com/cloderia/helion/client/local/productfeaturetype/list-productfeaturetype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productfeaturetype/list-productfeaturetype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListProductfeaturetypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListProductfeaturetypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeaturetype.ListProductfeaturetypePage", "com/cloderia/helion/client/local/productfeaturetype/list-productfeaturetype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeaturetype.ListProductfeaturetypePage", "com/cloderia/helion/client/local/productfeaturetype/list-productfeaturetype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListProductfeaturetypePage_ProductfeaturetypeListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productfeaturetype.ListProductfeaturetypePage", "com/cloderia/helion/client/local/productfeaturetype/list-productfeaturetype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListProductfeaturetypePage_AnchorElement_createNewProductfeaturetypeLink(instance));
      }
    }, dataFieldElements, "createNewProductfeaturetypeLink");
    ...
    templateFieldsMap.put("listWidget", ListProductfeaturetypePage_ProductfeaturetypeListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewProductfeaturetypeLink", ElementWrapperWidget.getWidget(ListProductfeaturetypePage_AnchorElement_createNewProductfeaturetypeLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListProductfeaturetypePage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewProductfeaturetypeLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListProductfeaturetypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListProductfeaturetypePage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListProductfeaturetypePage_AnchorElement_createNewProductfeaturetypeLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListProductfeaturetypePage instance) {
  ...
  native static ProductfeaturetypeListWidget ListProductfeaturetypePage_ProductfeaturetypeListWidget_listWidget(ListProductfeaturetypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeaturetype.ListProductfeaturetypePage::listWidget;
  }-*/;

  native static void ListProductfeaturetypePage_ProductfeaturetypeListWidget_listWidget(ListProductfeaturetypePage instance, ProductfeaturetypeListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.productfeaturetype.ListProductfeaturetypePage::listWidget = value;
  }-*/;
  ...
  native static AnchorElement ListProductfeaturetypePage_AnchorElement_createNewProductfeaturetypeLink(ListProductfeaturetypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productfeaturetype.ListProductfeaturetypePage::createNewProductfeaturetypeLink;
  }-*/;

  native static void ListProductfeaturetypePage_AnchorElement_createNewProductfeaturetypeLink(ListProductfeaturetypePage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.productfeaturetype.ListProductfeaturetypePage::createNewProductfeaturetypeLink = value;
  }-*/;
