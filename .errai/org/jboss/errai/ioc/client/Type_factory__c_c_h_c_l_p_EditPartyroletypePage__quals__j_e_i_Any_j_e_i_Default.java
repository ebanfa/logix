...
public class Type_factory__c_c_h_c_l_p_EditPartyroletypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditPartyroletypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditPartyroletypePage.class, "Type_factory__c_c_h_c_l_p_EditPartyroletypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditPartyroletypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditPartyroletypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditPartyroletypePage.class);
  ...
  public EditPartyroletypePage createInstance(final ContextManager contextManager) {
    final EditPartyroletypePage instance = new EditPartyroletypePage();
    ...
    final PartyroletypeEditor EditPartyroletypePage_partyroletypeEditor = (PartyroletypeEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartyroletypeEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditPartyroletypePage_partyroletypeEditor);
    EditPartyroletypePage_PartyroletypeEditor_partyroletypeEditor(instance, EditPartyroletypePage_partyroletypeEditor);
    ...
    c_c_h_c_l_p_EditPartyroletypePageTemplateResource templateForEditPartyroletypePage = GWT.create(c_c_h_c_l_p_EditPartyroletypePageTemplateResource.class);
    Element parentElementForTemplateOfEditPartyroletypePage = TemplateUtil.getRootTemplateParentElement(templateForEditPartyroletypePage.getContents().getText(), "com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartyroletypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartyroletypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyroletype.EditPartyroletypePage", "com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyroletype.EditPartyroletypePage", "com/cloderia/helion/client/local/partyroletype/edit-partyroletype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditPartyroletypePage_PartyroletypeEditor_partyroletypeEditor(instance));
      }
    ...
    templateFieldsMap.put("partyroletypeEditor", TemplateWidgetMapper.get(EditPartyroletypePage_PartyroletypeEditor_partyroletypeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartyroletypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditPartyroletypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditPartyroletypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditPartyroletypePage instance) {
  ...
  native static PartyroletypeEditor EditPartyroletypePage_PartyroletypeEditor_partyroletypeEditor(EditPartyroletypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partyroletype.EditPartyroletypePage::partyroletypeEditor;
  }-*/;

  native static void EditPartyroletypePage_PartyroletypeEditor_partyroletypeEditor(EditPartyroletypePage instance, PartyroletypeEditor value) /*-{
    instance.@com.cloderia.helion.client.local.partyroletype.EditPartyroletypePage::partyroletypeEditor = value;
  }-*/;
