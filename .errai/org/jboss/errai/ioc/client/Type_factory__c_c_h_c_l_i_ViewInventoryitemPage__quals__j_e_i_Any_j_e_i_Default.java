...
public class Type_factory__c_c_h_c_l_i_ViewInventoryitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewInventoryitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewInventoryitemPage.class, "Type_factory__c_c_h_c_l_i_ViewInventoryitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_ViewInventoryitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/inventoryitem/view-inventoryitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_ViewInventoryitemPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewInventoryitemPage.class);
  ...
  public ViewInventoryitemPage createInstance(final ContextManager contextManager) {
    final ViewInventoryitemPage instance = new ViewInventoryitemPage();
    ...
    final DataBinder ViewInventoryitemPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Inventoryitem.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewInventoryitemPage_binder);
    ViewInventoryitemPage_DataBinder_binder(instance, ViewInventoryitemPage_binder);
    ...
    final InventoryitemDisplay ViewInventoryitemPage_entityDisplayComponent = (InventoryitemDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InventoryitemDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewInventoryitemPage_entityDisplayComponent);
    ViewInventoryitemPage_InventoryitemDisplay_entityDisplayComponent(instance, ViewInventoryitemPage_entityDisplayComponent);
    ...
    c_c_h_c_l_i_ViewInventoryitemPageTemplateResource templateForViewInventoryitemPage = GWT.create(c_c_h_c_l_i_ViewInventoryitemPageTemplateResource.class);
    Element parentElementForTemplateOfViewInventoryitemPage = TemplateUtil.getRootTemplateParentElement(templateForViewInventoryitemPage.getContents().getText(), "com/cloderia/helion/client/local/inventoryitem/view-inventoryitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/inventoryitem/view-inventoryitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInventoryitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInventoryitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.inventoryitem.ViewInventoryitemPage", "com/cloderia/helion/client/local/inventoryitem/view-inventoryitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.inventoryitem.ViewInventoryitemPage", "com/cloderia/helion/client/local/inventoryitem/view-inventoryitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewInventoryitemPage_InventoryitemDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewInventoryitemPage_InventoryitemDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewInventoryitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewInventoryitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewInventoryitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewInventoryitemPage instance) {
  ...
  native static DataBinder ViewInventoryitemPage_DataBinder_binder(ViewInventoryitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.inventoryitem.ViewInventoryitemPage::binder;
  }-*/;

  native static void ViewInventoryitemPage_DataBinder_binder(ViewInventoryitemPage instance, DataBinder<Inventoryitem> value) /*-{
    instance.@com.cloderia.helion.client.local.inventoryitem.ViewInventoryitemPage::binder = value;
  }-*/;
  ...
  native static InventoryitemDisplay ViewInventoryitemPage_InventoryitemDisplay_entityDisplayComponent(ViewInventoryitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.inventoryitem.ViewInventoryitemPage::entityDisplayComponent;
  }-*/;

  native static void ViewInventoryitemPage_InventoryitemDisplay_entityDisplayComponent(ViewInventoryitemPage instance, InventoryitemDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.inventoryitem.ViewInventoryitemPage::entityDisplayComponent = value;
  }-*/;
