...
public class Type_factory__c_c_h_c_l_p_CreateProductcategoryPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateProductcategoryPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateProductcategoryPage.class, "Type_factory__c_c_h_c_l_p_CreateProductcategoryPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_CreateProductcategoryPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productcategory/edit-productcategory-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_CreateProductcategoryPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateProductcategoryPage.class);
  ...
  public CreateProductcategoryPage createInstance(final ContextManager contextManager) {
    final CreateProductcategoryPage instance = new CreateProductcategoryPage();
    ...
    final ProductcategoryEditor CreateProductcategoryPage_productcategoryEditor = (ProductcategoryEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductcategoryEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateProductcategoryPage_productcategoryEditor);
    CreateProductcategoryPage_ProductcategoryEditor_productcategoryEditor(instance, CreateProductcategoryPage_productcategoryEditor);
    ...
    c_c_h_c_l_p_CreateProductcategoryPageTemplateResource templateForCreateProductcategoryPage = GWT.create(c_c_h_c_l_p_CreateProductcategoryPageTemplateResource.class);
    Element parentElementForTemplateOfCreateProductcategoryPage = TemplateUtil.getRootTemplateParentElement(templateForCreateProductcategoryPage.getContents().getText(), "com/cloderia/helion/client/local/productcategory/edit-productcategory-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productcategory/edit-productcategory-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductcategoryPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductcategoryPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productcategory.CreateProductcategoryPage", "com/cloderia/helion/client/local/productcategory/edit-productcategory-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productcategory.CreateProductcategoryPage", "com/cloderia/helion/client/local/productcategory/edit-productcategory-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateProductcategoryPage_ProductcategoryEditor_productcategoryEditor(instance));
      }
    ...
    templateFieldsMap.put("productcategoryEditor", TemplateWidgetMapper.get(CreateProductcategoryPage_ProductcategoryEditor_productcategoryEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProductcategoryPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateProductcategoryPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateProductcategoryPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateProductcategoryPage instance) {
  ...
  native static ProductcategoryEditor CreateProductcategoryPage_ProductcategoryEditor_productcategoryEditor(CreateProductcategoryPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productcategory.CreateProductcategoryPage::productcategoryEditor;
  }-*/;

  native static void CreateProductcategoryPage_ProductcategoryEditor_productcategoryEditor(CreateProductcategoryPage instance, ProductcategoryEditor value) /*-{
    instance.@com.cloderia.helion.client.local.productcategory.CreateProductcategoryPage::productcategoryEditor = value;
  }-*/;
