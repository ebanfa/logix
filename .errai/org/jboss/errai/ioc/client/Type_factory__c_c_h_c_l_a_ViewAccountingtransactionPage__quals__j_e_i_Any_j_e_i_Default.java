...
public class Type_factory__c_c_h_c_l_a_ViewAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewAccountingtransactionPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewAccountingtransactionPage.class, "Type_factory__c_c_h_c_l_a_ViewAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_a_ViewAccountingtransactionPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/accountingtransaction/view-accountingtransaction-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_a_ViewAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewAccountingtransactionPage.class);
  ...
  public ViewAccountingtransactionPage createInstance(final ContextManager contextManager) {
    final ViewAccountingtransactionPage instance = new ViewAccountingtransactionPage();
    ...
    final AccountingtransactionDisplay ViewAccountingtransactionPage_entityDisplayComponent = (AccountingtransactionDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_a_AccountingtransactionDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewAccountingtransactionPage_entityDisplayComponent);
    ViewAccountingtransactionPage_AccountingtransactionDisplay_entityDisplayComponent(instance, ViewAccountingtransactionPage_entityDisplayComponent);
    ...
    final DataBinder ViewAccountingtransactionPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Accountingtransaction.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewAccountingtransactionPage_binder);
    ViewAccountingtransactionPage_DataBinder_binder(instance, ViewAccountingtransactionPage_binder);
    ...
    c_c_h_c_l_a_ViewAccountingtransactionPageTemplateResource templateForViewAccountingtransactionPage = GWT.create(c_c_h_c_l_a_ViewAccountingtransactionPageTemplateResource.class);
    Element parentElementForTemplateOfViewAccountingtransactionPage = TemplateUtil.getRootTemplateParentElement(templateForViewAccountingtransactionPage.getContents().getText(), "com/cloderia/helion/client/local/accountingtransaction/view-accountingtransaction-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/accountingtransaction/view-accountingtransaction-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewAccountingtransactionPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewAccountingtransactionPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.accountingtransaction.ViewAccountingtransactionPage", "com/cloderia/helion/client/local/accountingtransaction/view-accountingtransaction-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.accountingtransaction.ViewAccountingtransactionPage", "com/cloderia/helion/client/local/accountingtransaction/view-accountingtransaction-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewAccountingtransactionPage_AccountingtransactionDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewAccountingtransactionPage_AccountingtransactionDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewAccountingtransactionPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewAccountingtransactionPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewAccountingtransactionPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewAccountingtransactionPage instance) {
  ...
  native static AccountingtransactionDisplay ViewAccountingtransactionPage_AccountingtransactionDisplay_entityDisplayComponent(ViewAccountingtransactionPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.accountingtransaction.ViewAccountingtransactionPage::entityDisplayComponent;
  }-*/;

  native static void ViewAccountingtransactionPage_AccountingtransactionDisplay_entityDisplayComponent(ViewAccountingtransactionPage instance, AccountingtransactionDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.accountingtransaction.ViewAccountingtransactionPage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewAccountingtransactionPage_DataBinder_binder(ViewAccountingtransactionPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.accountingtransaction.ViewAccountingtransactionPage::binder;
  }-*/;

  native static void ViewAccountingtransactionPage_DataBinder_binder(ViewAccountingtransactionPage instance, DataBinder<Accountingtransaction> value) /*-{
    instance.@com.cloderia.helion.client.local.accountingtransaction.ViewAccountingtransactionPage::binder = value;
  }-*/;
