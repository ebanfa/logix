...
public class Type_factory__c_c_h_c_l_a_BaseAgreementPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseAgreementPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseAgreementPage.class, "Type_factory__c_c_h_c_l_a_BaseAgreementPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_a_BaseAgreementPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/agreement/edit-agreement-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_a_BaseAgreementPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseAgreementPage createInstance(final ContextManager contextManager) {
    final BaseAgreementPage instance = new BaseAgreementPage();
    ...
    c_c_h_c_l_a_BaseAgreementPageTemplateResource templateForBaseAgreementPage = GWT.create(c_c_h_c_l_a_BaseAgreementPageTemplateResource.class);
    Element parentElementForTemplateOfBaseAgreementPage = TemplateUtil.getRootTemplateParentElement(templateForBaseAgreementPage.getContents().getText(), "com/cloderia/helion/client/local/agreement/edit-agreement-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/agreement/edit-agreement-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseAgreementPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseAgreementPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.agreement.BaseAgreementPage", "com/cloderia/helion/client/local/agreement/edit-agreement-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseAgreementPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseAgreementPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseAgreementPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseAgreementPage instance) {
