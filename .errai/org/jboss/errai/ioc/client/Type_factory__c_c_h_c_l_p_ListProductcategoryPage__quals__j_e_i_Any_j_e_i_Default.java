...
public class Type_factory__c_c_h_c_l_p_ListProductcategoryPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListProductcategoryPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListProductcategoryPage.class, "Type_factory__c_c_h_c_l_p_ListProductcategoryPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ListProductcategoryPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/productcategory/list-productcategory-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ListProductcategoryPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListProductcategoryPage.class);
  ...
  public ListProductcategoryPage createInstance(final ContextManager contextManager) {
    final ListProductcategoryPage instance = new ListProductcategoryPage();
    ...
    final ProductcategoryListWidget ListProductcategoryPage_listWidget = (ProductcategoryListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductcategoryListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListProductcategoryPage_listWidget);
    ListProductcategoryPage_ProductcategoryListWidget_listWidget(instance, ListProductcategoryPage_listWidget);
    ...
    c_c_h_c_l_p_ListProductcategoryPageTemplateResource templateForListProductcategoryPage = GWT.create(c_c_h_c_l_p_ListProductcategoryPageTemplateResource.class);
    Element parentElementForTemplateOfListProductcategoryPage = TemplateUtil.getRootTemplateParentElement(templateForListProductcategoryPage.getContents().getText(), "com/cloderia/helion/client/local/productcategory/list-productcategory-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/productcategory/list-productcategory-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListProductcategoryPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListProductcategoryPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productcategory.ListProductcategoryPage", "com/cloderia/helion/client/local/productcategory/list-productcategory-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productcategory.ListProductcategoryPage", "com/cloderia/helion/client/local/productcategory/list-productcategory-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListProductcategoryPage_ProductcategoryListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.productcategory.ListProductcategoryPage", "com/cloderia/helion/client/local/productcategory/list-productcategory-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListProductcategoryPage_AnchorElement_createNewProductcategoryLink(instance));
      }
    }, dataFieldElements, "createNewProductcategoryLink");
    ...
    templateFieldsMap.put("listWidget", ListProductcategoryPage_ProductcategoryListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewProductcategoryLink", ElementWrapperWidget.getWidget(ListProductcategoryPage_AnchorElement_createNewProductcategoryLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListProductcategoryPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewProductcategoryLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListProductcategoryPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListProductcategoryPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListProductcategoryPage_AnchorElement_createNewProductcategoryLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListProductcategoryPage instance) {
  ...
  native static ProductcategoryListWidget ListProductcategoryPage_ProductcategoryListWidget_listWidget(ListProductcategoryPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productcategory.ListProductcategoryPage::listWidget;
  }-*/;

  native static void ListProductcategoryPage_ProductcategoryListWidget_listWidget(ListProductcategoryPage instance, ProductcategoryListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.productcategory.ListProductcategoryPage::listWidget = value;
  }-*/;

  native static AnchorElement ListProductcategoryPage_AnchorElement_createNewProductcategoryLink(ListProductcategoryPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.productcategory.ListProductcategoryPage::createNewProductcategoryLink;
  }-*/;

  native static void ListProductcategoryPage_AnchorElement_createNewProductcategoryLink(ListProductcategoryPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.productcategory.ListProductcategoryPage::createNewProductcategoryLink = value;
  }-*/;
