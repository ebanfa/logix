...
public class Type_factory__c_c_h_c_l_i_BaseInvoicePage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseInvoicePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseInvoicePage.class, "Type_factory__c_c_h_c_l_i_BaseInvoicePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_BaseInvoicePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoice/edit-invoice-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_BaseInvoicePage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseInvoicePage createInstance(final ContextManager contextManager) {
    final BaseInvoicePage instance = new BaseInvoicePage();
    ...
    c_c_h_c_l_i_BaseInvoicePageTemplateResource templateForBaseInvoicePage = GWT.create(c_c_h_c_l_i_BaseInvoicePageTemplateResource.class);
    Element parentElementForTemplateOfBaseInvoicePage = TemplateUtil.getRootTemplateParentElement(templateForBaseInvoicePage.getContents().getText(), "com/cloderia/helion/client/local/invoice/edit-invoice-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoice/edit-invoice-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseInvoicePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseInvoicePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoice.BaseInvoicePage", "com/cloderia/helion/client/local/invoice/edit-invoice-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseInvoicePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseInvoicePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseInvoicePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseInvoicePage instance) {
