...
public class Type_factory__c_c_h_c_l_a_BaseAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseAccountingtransactionPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseAccountingtransactionPage.class, "Type_factory__c_c_h_c_l_a_BaseAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_a_BaseAccountingtransactionPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/accountingtransaction/edit-accountingtransaction-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_a_BaseAccountingtransactionPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseAccountingtransactionPage createInstance(final ContextManager contextManager) {
    final BaseAccountingtransactionPage instance = new BaseAccountingtransactionPage();
    ...
    c_c_h_c_l_a_BaseAccountingtransactionPageTemplateResource templateForBaseAccountingtransactionPage = GWT.create(c_c_h_c_l_a_BaseAccountingtransactionPageTemplateResource.class);
    Element parentElementForTemplateOfBaseAccountingtransactionPage = TemplateUtil.getRootTemplateParentElement(templateForBaseAccountingtransactionPage.getContents().getText(), "com/cloderia/helion/client/local/accountingtransaction/edit-accountingtransaction-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/accountingtransaction/edit-accountingtransaction-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseAccountingtransactionPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseAccountingtransactionPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.accountingtransaction.BaseAccountingtransactionPage", "com/cloderia/helion/client/local/accountingtransaction/edit-accountingtransaction-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseAccountingtransactionPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseAccountingtransactionPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseAccountingtransactionPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseAccountingtransactionPage instance) {
