...
public class Type_factory__c_c_h_c_l_p_ViewPartyrolePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewPartyrolePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewPartyrolePage.class, "Type_factory__c_c_h_c_l_p_ViewPartyrolePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewPartyrolePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partyrole/view-partyrole-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewPartyrolePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewPartyrolePage.class);
  ...
  public ViewPartyrolePage createInstance(final ContextManager contextManager) {
    final ViewPartyrolePage instance = new ViewPartyrolePage();
    ...
    final DataBinder ViewPartyrolePage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Partyrole.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewPartyrolePage_binder);
    ViewPartyrolePage_DataBinder_binder(instance, ViewPartyrolePage_binder);
    ...
    final PartyroleDisplay ViewPartyrolePage_entityDisplayComponent = (PartyroleDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartyroleDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewPartyrolePage_entityDisplayComponent);
    ViewPartyrolePage_PartyroleDisplay_entityDisplayComponent(instance, ViewPartyrolePage_entityDisplayComponent);
    ...
    c_c_h_c_l_p_ViewPartyrolePageTemplateResource templateForViewPartyrolePage = GWT.create(c_c_h_c_l_p_ViewPartyrolePageTemplateResource.class);
    Element parentElementForTemplateOfViewPartyrolePage = TemplateUtil.getRootTemplateParentElement(templateForViewPartyrolePage.getContents().getText(), "com/cloderia/helion/client/local/partyrole/view-partyrole-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partyrole/view-partyrole-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartyrolePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartyrolePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyrole.ViewPartyrolePage", "com/cloderia/helion/client/local/partyrole/view-partyrole-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partyrole.ViewPartyrolePage", "com/cloderia/helion/client/local/partyrole/view-partyrole-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewPartyrolePage_PartyroleDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewPartyrolePage_PartyroleDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewPartyrolePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewPartyrolePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewPartyrolePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewPartyrolePage instance) {
  ...
  native static PartyroleDisplay ViewPartyrolePage_PartyroleDisplay_entityDisplayComponent(ViewPartyrolePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partyrole.ViewPartyrolePage::entityDisplayComponent;
  }-*/;

  native static void ViewPartyrolePage_PartyroleDisplay_entityDisplayComponent(ViewPartyrolePage instance, PartyroleDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.partyrole.ViewPartyrolePage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewPartyrolePage_DataBinder_binder(ViewPartyrolePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partyrole.ViewPartyrolePage::binder;
  }-*/;

  native static void ViewPartyrolePage_DataBinder_binder(ViewPartyrolePage instance, DataBinder<Partyrole> value) /*-{
    instance.@com.cloderia.helion.client.local.partyrole.ViewPartyrolePage::binder = value;
  }-*/;
