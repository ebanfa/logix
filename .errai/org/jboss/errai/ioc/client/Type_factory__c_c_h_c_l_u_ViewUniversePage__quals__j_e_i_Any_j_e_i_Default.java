...
public class Type_factory__c_c_h_c_l_u_ViewUniversePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewUniversePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewUniversePage.class, "Type_factory__c_c_h_c_l_u_ViewUniversePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_u_ViewUniversePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/universe/view-universe-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_u_ViewUniversePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewUniversePage.class);
  ...
  public ViewUniversePage createInstance(final ContextManager contextManager) {
    final ViewUniversePage instance = new ViewUniversePage();
    ...
    final DataBinder ViewUniversePage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Universe.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewUniversePage_binder);
    ViewUniversePage_DataBinder_binder(instance, ViewUniversePage_binder);
    final UniverseDisplay ViewUniversePage_entityDisplayComponent = (UniverseDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_u_UniverseDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewUniversePage_entityDisplayComponent);
    ViewUniversePage_UniverseDisplay_entityDisplayComponent(instance, ViewUniversePage_entityDisplayComponent);
    ...
    c_c_h_c_l_u_ViewUniversePageTemplateResource templateForViewUniversePage = GWT.create(c_c_h_c_l_u_ViewUniversePageTemplateResource.class);
    Element parentElementForTemplateOfViewUniversePage = TemplateUtil.getRootTemplateParentElement(templateForViewUniversePage.getContents().getText(), "com/cloderia/helion/client/local/universe/view-universe-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/universe/view-universe-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewUniversePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewUniversePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.universe.ViewUniversePage", "com/cloderia/helion/client/local/universe/view-universe-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.universe.ViewUniversePage", "com/cloderia/helion/client/local/universe/view-universe-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewUniversePage_UniverseDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewUniversePage_UniverseDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewUniversePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewUniversePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewUniversePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewUniversePage instance) {
  ...
  native static UniverseDisplay ViewUniversePage_UniverseDisplay_entityDisplayComponent(ViewUniversePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.universe.ViewUniversePage::entityDisplayComponent;
  }-*/;

  native static void ViewUniversePage_UniverseDisplay_entityDisplayComponent(ViewUniversePage instance, UniverseDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.universe.ViewUniversePage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewUniversePage_DataBinder_binder(ViewUniversePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.universe.ViewUniversePage::binder;
  }-*/;

  native static void ViewUniversePage_DataBinder_binder(ViewUniversePage instance, DataBinder<Universe> value) /*-{
    instance.@com.cloderia.helion.client.local.universe.ViewUniversePage::binder = value;
  }-*/;
