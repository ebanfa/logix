...
public class Type_factory__c_c_h_c_l_f_ListFacilityPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListFacilityPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListFacilityPage.class, "Type_factory__c_c_h_c_l_f_ListFacilityPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_f_ListFacilityPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/facility/list-facility-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_f_ListFacilityPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListFacilityPage.class);
  ...
  public ListFacilityPage createInstance(final ContextManager contextManager) {
    final ListFacilityPage instance = new ListFacilityPage();
    ...
    final FacilityListWidget ListFacilityPage_listWidget = (FacilityListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_f_FacilityListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListFacilityPage_listWidget);
    ListFacilityPage_FacilityListWidget_listWidget(instance, ListFacilityPage_listWidget);
    ...
    c_c_h_c_l_f_ListFacilityPageTemplateResource templateForListFacilityPage = GWT.create(c_c_h_c_l_f_ListFacilityPageTemplateResource.class);
    Element parentElementForTemplateOfListFacilityPage = TemplateUtil.getRootTemplateParentElement(templateForListFacilityPage.getContents().getText(), "com/cloderia/helion/client/local/facility/list-facility-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/facility/list-facility-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListFacilityPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListFacilityPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facility.ListFacilityPage", "com/cloderia/helion/client/local/facility/list-facility-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facility.ListFacilityPage", "com/cloderia/helion/client/local/facility/list-facility-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListFacilityPage_FacilityListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facility.ListFacilityPage", "com/cloderia/helion/client/local/facility/list-facility-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListFacilityPage_AnchorElement_createNewFacilityLink(instance));
      }
    }, dataFieldElements, "createNewFacilityLink");
    ...
    templateFieldsMap.put("listWidget", ListFacilityPage_FacilityListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewFacilityLink", ElementWrapperWidget.getWidget(ListFacilityPage_AnchorElement_createNewFacilityLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListFacilityPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewFacilityLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListFacilityPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListFacilityPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListFacilityPage_AnchorElement_createNewFacilityLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListFacilityPage instance) {
  ...
  native static AnchorElement ListFacilityPage_AnchorElement_createNewFacilityLink(ListFacilityPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facility.ListFacilityPage::createNewFacilityLink;
  }-*/;

  native static void ListFacilityPage_AnchorElement_createNewFacilityLink(ListFacilityPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.facility.ListFacilityPage::createNewFacilityLink = value;
  }-*/;
  ...
  native static FacilityListWidget ListFacilityPage_FacilityListWidget_listWidget(ListFacilityPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facility.ListFacilityPage::listWidget;
  }-*/;

  native static void ListFacilityPage_FacilityListWidget_listWidget(ListFacilityPage instance, FacilityListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.facility.ListFacilityPage::listWidget = value;
  }-*/;
