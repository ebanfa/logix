...
public class Type_factory__c_c_h_c_l_p_EditPartyPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditPartyPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditPartyPage.class, "Type_factory__c_c_h_c_l_p_EditPartyPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditPartyPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/party/edit-party-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditPartyPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditPartyPage.class);
  ...
  public EditPartyPage createInstance(final ContextManager contextManager) {
    final EditPartyPage instance = new EditPartyPage();
    ...
    final PartyEditor EditPartyPage_partyEditor = (PartyEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartyEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditPartyPage_partyEditor);
    EditPartyPage_PartyEditor_partyEditor(instance, EditPartyPage_partyEditor);
    ...
    c_c_h_c_l_p_EditPartyPageTemplateResource templateForEditPartyPage = GWT.create(c_c_h_c_l_p_EditPartyPageTemplateResource.class);
    Element parentElementForTemplateOfEditPartyPage = TemplateUtil.getRootTemplateParentElement(templateForEditPartyPage.getContents().getText(), "com/cloderia/helion/client/local/party/edit-party-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/party/edit-party-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartyPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartyPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.party.EditPartyPage", "com/cloderia/helion/client/local/party/edit-party-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.party.EditPartyPage", "com/cloderia/helion/client/local/party/edit-party-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditPartyPage_PartyEditor_partyEditor(instance));
      }
    ...
    templateFieldsMap.put("partyEditor", TemplateWidgetMapper.get(EditPartyPage_PartyEditor_partyEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditPartyPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditPartyPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditPartyPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditPartyPage instance) {
  ...
  native static PartyEditor EditPartyPage_PartyEditor_partyEditor(EditPartyPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.party.EditPartyPage::partyEditor;
  }-*/;

  native static void EditPartyPage_PartyEditor_partyEditor(EditPartyPage instance, PartyEditor value) /*-{
    instance.@com.cloderia.helion.client.local.party.EditPartyPage::partyEditor = value;
  }-*/;
