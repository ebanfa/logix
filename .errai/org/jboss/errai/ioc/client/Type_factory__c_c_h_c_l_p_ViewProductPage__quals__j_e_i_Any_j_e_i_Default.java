...
public class Type_factory__c_c_h_c_l_p_ViewProductPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewProductPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewProductPage.class, "Type_factory__c_c_h_c_l_p_ViewProductPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ViewProductPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/product/view-product-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ViewProductPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewProductPage.class);
  ...
  public ViewProductPage createInstance(final ContextManager contextManager) {
    final ViewProductPage instance = new ViewProductPage();
    ...
    final DataBinder ViewProductPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Product.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewProductPage_binder);
    ViewProductPage_DataBinder_binder(instance, ViewProductPage_binder);
    ...
    final ProductDisplay ViewProductPage_entityDisplayComponent = (ProductDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewProductPage_entityDisplayComponent);
    ViewProductPage_ProductDisplay_entityDisplayComponent(instance, ViewProductPage_entityDisplayComponent);
    ...
    c_c_h_c_l_p_ViewProductPageTemplateResource templateForViewProductPage = GWT.create(c_c_h_c_l_p_ViewProductPageTemplateResource.class);
    Element parentElementForTemplateOfViewProductPage = TemplateUtil.getRootTemplateParentElement(templateForViewProductPage.getContents().getText(), "com/cloderia/helion/client/local/product/view-product-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/product/view-product-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.product.ViewProductPage", "com/cloderia/helion/client/local/product/view-product-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.product.ViewProductPage", "com/cloderia/helion/client/local/product/view-product-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewProductPage_ProductDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewProductPage_ProductDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewProductPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewProductPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewProductPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewProductPage instance) {
  ...
  native static DataBinder ViewProductPage_DataBinder_binder(ViewProductPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.product.ViewProductPage::binder;
  }-*/;

  native static void ViewProductPage_DataBinder_binder(ViewProductPage instance, DataBinder<Product> value) /*-{
    instance.@com.cloderia.helion.client.local.product.ViewProductPage::binder = value;
  }-*/;
  ...
  native static ProductDisplay ViewProductPage_ProductDisplay_entityDisplayComponent(ViewProductPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.product.ViewProductPage::entityDisplayComponent;
  }-*/;

  native static void ViewProductPage_ProductDisplay_entityDisplayComponent(ViewProductPage instance, ProductDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.product.ViewProductPage::entityDisplayComponent = value;
  }-*/;
