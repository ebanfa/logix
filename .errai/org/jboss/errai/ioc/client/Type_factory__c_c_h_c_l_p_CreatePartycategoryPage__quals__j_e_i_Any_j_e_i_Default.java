...
public class Type_factory__c_c_h_c_l_p_CreatePartycategoryPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreatePartycategoryPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreatePartycategoryPage.class, "Type_factory__c_c_h_c_l_p_CreatePartycategoryPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_CreatePartycategoryPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_CreatePartycategoryPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreatePartycategoryPage.class);
  ...
  public CreatePartycategoryPage createInstance(final ContextManager contextManager) {
    final CreatePartycategoryPage instance = new CreatePartycategoryPage();
    ...
    final PartycategoryEditor CreatePartycategoryPage_partycategoryEditor = (PartycategoryEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartycategoryEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreatePartycategoryPage_partycategoryEditor);
    CreatePartycategoryPage_PartycategoryEditor_partycategoryEditor(instance, CreatePartycategoryPage_partycategoryEditor);
    ...
    c_c_h_c_l_p_CreatePartycategoryPageTemplateResource templateForCreatePartycategoryPage = GWT.create(c_c_h_c_l_p_CreatePartycategoryPageTemplateResource.class);
    Element parentElementForTemplateOfCreatePartycategoryPage = TemplateUtil.getRootTemplateParentElement(templateForCreatePartycategoryPage.getContents().getText(), "com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePartycategoryPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePartycategoryPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partycategory.CreatePartycategoryPage", "com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partycategory.CreatePartycategoryPage", "com/cloderia/helion/client/local/partycategory/edit-partycategory-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreatePartycategoryPage_PartycategoryEditor_partycategoryEditor(instance));
      }
    ...
    templateFieldsMap.put("partycategoryEditor", TemplateWidgetMapper.get(CreatePartycategoryPage_PartycategoryEditor_partycategoryEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreatePartycategoryPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreatePartycategoryPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreatePartycategoryPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreatePartycategoryPage instance) {
  ...
  native static PartycategoryEditor CreatePartycategoryPage_PartycategoryEditor_partycategoryEditor(CreatePartycategoryPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partycategory.CreatePartycategoryPage::partycategoryEditor;
  }-*/;

  native static void CreatePartycategoryPage_PartycategoryEditor_partycategoryEditor(CreatePartycategoryPage instance, PartycategoryEditor value) /*-{
    instance.@com.cloderia.helion.client.local.partycategory.CreatePartycategoryPage::partycategoryEditor = value;
  }-*/;
