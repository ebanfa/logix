...
public class Type_factory__c_c_h_c_l_f_ViewFacilitytypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewFacilitytypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewFacilitytypePage.class, "Type_factory__c_c_h_c_l_f_ViewFacilitytypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_f_ViewFacilitytypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/facilitytype/view-facilitytype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_f_ViewFacilitytypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewFacilitytypePage.class);
  ...
  public ViewFacilitytypePage createInstance(final ContextManager contextManager) {
    final ViewFacilitytypePage instance = new ViewFacilitytypePage();
    ...
    final FacilitytypeDisplay ViewFacilitytypePage_entityDisplayComponent = (FacilitytypeDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_f_FacilitytypeDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewFacilitytypePage_entityDisplayComponent);
    ViewFacilitytypePage_FacilitytypeDisplay_entityDisplayComponent(instance, ViewFacilitytypePage_entityDisplayComponent);
    ...
    final DataBinder ViewFacilitytypePage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Facilitytype.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewFacilitytypePage_binder);
    ViewFacilitytypePage_DataBinder_binder(instance, ViewFacilitytypePage_binder);
    ...
    c_c_h_c_l_f_ViewFacilitytypePageTemplateResource templateForViewFacilitytypePage = GWT.create(c_c_h_c_l_f_ViewFacilitytypePageTemplateResource.class);
    Element parentElementForTemplateOfViewFacilitytypePage = TemplateUtil.getRootTemplateParentElement(templateForViewFacilitytypePage.getContents().getText(), "com/cloderia/helion/client/local/facilitytype/view-facilitytype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/facilitytype/view-facilitytype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewFacilitytypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewFacilitytypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facilitytype.ViewFacilitytypePage", "com/cloderia/helion/client/local/facilitytype/view-facilitytype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facilitytype.ViewFacilitytypePage", "com/cloderia/helion/client/local/facilitytype/view-facilitytype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewFacilitytypePage_FacilitytypeDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewFacilitytypePage_FacilitytypeDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewFacilitytypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewFacilitytypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewFacilitytypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewFacilitytypePage instance) {
  ...
  native static DataBinder ViewFacilitytypePage_DataBinder_binder(ViewFacilitytypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facilitytype.ViewFacilitytypePage::binder;
  }-*/;

  native static void ViewFacilitytypePage_DataBinder_binder(ViewFacilitytypePage instance, DataBinder<Facilitytype> value) /*-{
    instance.@com.cloderia.helion.client.local.facilitytype.ViewFacilitytypePage::binder = value;
  }-*/;

  native static FacilitytypeDisplay ViewFacilitytypePage_FacilitytypeDisplay_entityDisplayComponent(ViewFacilitytypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facilitytype.ViewFacilitytypePage::entityDisplayComponent;
  }-*/;

  native static void ViewFacilitytypePage_FacilitytypeDisplay_entityDisplayComponent(ViewFacilitytypePage instance, FacilitytypeDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.facilitytype.ViewFacilitytypePage::entityDisplayComponent = value;
  }-*/;
