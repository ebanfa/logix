...
public class Type_factory__c_c_h_c_l_p_BaseProductPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseProductPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseProductPage.class, "Type_factory__c_c_h_c_l_p_BaseProductPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_BaseProductPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/product/edit-product-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_BaseProductPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseProductPage createInstance(final ContextManager contextManager) {
    final BaseProductPage instance = new BaseProductPage();
    ...
    c_c_h_c_l_p_BaseProductPageTemplateResource templateForBaseProductPage = GWT.create(c_c_h_c_l_p_BaseProductPageTemplateResource.class);
    Element parentElementForTemplateOfBaseProductPage = TemplateUtil.getRootTemplateParentElement(templateForBaseProductPage.getContents().getText(), "com/cloderia/helion/client/local/product/edit-product-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/product/edit-product-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProductPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProductPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.product.BaseProductPage", "com/cloderia/helion/client/local/product/edit-product-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseProductPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseProductPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseProductPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseProductPage instance) {
