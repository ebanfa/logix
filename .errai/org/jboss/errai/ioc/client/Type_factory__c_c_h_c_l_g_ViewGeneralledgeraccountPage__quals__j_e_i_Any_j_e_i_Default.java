...
public class Type_factory__c_c_h_c_l_g_ViewGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewGeneralledgeraccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewGeneralledgeraccountPage.class, "Type_factory__c_c_h_c_l_g_ViewGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_g_ViewGeneralledgeraccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/generalledgeraccount/view-generalledgeraccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_g_ViewGeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewGeneralledgeraccountPage.class);
  ...
  public ViewGeneralledgeraccountPage createInstance(final ContextManager contextManager) {
    final ViewGeneralledgeraccountPage instance = new ViewGeneralledgeraccountPage();
    ...
    final DataBinder ViewGeneralledgeraccountPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Generalledgeraccount.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewGeneralledgeraccountPage_binder);
    ViewGeneralledgeraccountPage_DataBinder_binder(instance, ViewGeneralledgeraccountPage_binder);
    ...
    final GeneralledgeraccountDisplay ViewGeneralledgeraccountPage_entityDisplayComponent = (GeneralledgeraccountDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_g_GeneralledgeraccountDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewGeneralledgeraccountPage_entityDisplayComponent);
    ViewGeneralledgeraccountPage_GeneralledgeraccountDisplay_entityDisplayComponent(instance, ViewGeneralledgeraccountPage_entityDisplayComponent);
    ...
    c_c_h_c_l_g_ViewGeneralledgeraccountPageTemplateResource templateForViewGeneralledgeraccountPage = GWT.create(c_c_h_c_l_g_ViewGeneralledgeraccountPageTemplateResource.class);
    Element parentElementForTemplateOfViewGeneralledgeraccountPage = TemplateUtil.getRootTemplateParentElement(templateForViewGeneralledgeraccountPage.getContents().getText(), "com/cloderia/helion/client/local/generalledgeraccount/view-generalledgeraccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/generalledgeraccount/view-generalledgeraccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewGeneralledgeraccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewGeneralledgeraccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccount.ViewGeneralledgeraccountPage", "com/cloderia/helion/client/local/generalledgeraccount/view-generalledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccount.ViewGeneralledgeraccountPage", "com/cloderia/helion/client/local/generalledgeraccount/view-generalledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewGeneralledgeraccountPage_GeneralledgeraccountDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewGeneralledgeraccountPage_GeneralledgeraccountDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewGeneralledgeraccountPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewGeneralledgeraccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewGeneralledgeraccountPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewGeneralledgeraccountPage instance) {
  ...
  native static GeneralledgeraccountDisplay ViewGeneralledgeraccountPage_GeneralledgeraccountDisplay_entityDisplayComponent(ViewGeneralledgeraccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccount.ViewGeneralledgeraccountPage::entityDisplayComponent;
  }-*/;

  native static void ViewGeneralledgeraccountPage_GeneralledgeraccountDisplay_entityDisplayComponent(ViewGeneralledgeraccountPage instance, GeneralledgeraccountDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccount.ViewGeneralledgeraccountPage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewGeneralledgeraccountPage_DataBinder_binder(ViewGeneralledgeraccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccount.ViewGeneralledgeraccountPage::binder;
  }-*/;

  native static void ViewGeneralledgeraccountPage_DataBinder_binder(ViewGeneralledgeraccountPage instance, DataBinder<Generalledgeraccount> value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccount.ViewGeneralledgeraccountPage::binder = value;
  }-*/;
