...
public class Type_factory__c_c_h_c_l_i_CreateInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateInvoiceitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateInvoiceitemPage.class, "Type_factory__c_c_h_c_l_i_CreateInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_i_CreateInvoiceitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_i_CreateInvoiceitemPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateInvoiceitemPage.class);
  ...
  public CreateInvoiceitemPage createInstance(final ContextManager contextManager) {
    final CreateInvoiceitemPage instance = new CreateInvoiceitemPage();
    setIncompleteInstance(instance);
    final InvoiceitemEditor CreateInvoiceitemPage_invoiceitemEditor = (InvoiceitemEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_i_InvoiceitemEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateInvoiceitemPage_invoiceitemEditor);
    CreateInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(instance, CreateInvoiceitemPage_invoiceitemEditor);
    ...
    c_c_h_c_l_i_CreateInvoiceitemPageTemplateResource templateForCreateInvoiceitemPage = GWT.create(c_c_h_c_l_i_CreateInvoiceitemPageTemplateResource.class);
    Element parentElementForTemplateOfCreateInvoiceitemPage = TemplateUtil.getRootTemplateParentElement(templateForCreateInvoiceitemPage.getContents().getText(), "com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInvoiceitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInvoiceitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceitem.CreateInvoiceitemPage", "com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.invoiceitem.CreateInvoiceitemPage", "com/cloderia/helion/client/local/invoiceitem/edit-invoiceitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(instance));
      }
    ...
    templateFieldsMap.put("invoiceitemEditor", TemplateWidgetMapper.get(CreateInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateInvoiceitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateInvoiceitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateInvoiceitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateInvoiceitemPage instance) {
  ...
  native static InvoiceitemEditor CreateInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(CreateInvoiceitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.invoiceitem.CreateInvoiceitemPage::invoiceitemEditor;
  }-*/;

  native static void CreateInvoiceitemPage_InvoiceitemEditor_invoiceitemEditor(CreateInvoiceitemPage instance, InvoiceitemEditor value) /*-{
    instance.@com.cloderia.helion.client.local.invoiceitem.CreateInvoiceitemPage::invoiceitemEditor = value;
  }-*/;
