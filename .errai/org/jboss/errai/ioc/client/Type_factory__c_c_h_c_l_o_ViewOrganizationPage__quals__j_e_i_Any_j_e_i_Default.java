...
public class Type_factory__c_c_h_c_l_o_ViewOrganizationPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewOrganizationPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewOrganizationPage.class, "Type_factory__c_c_h_c_l_o_ViewOrganizationPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_ViewOrganizationPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organization/view-organization-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_ViewOrganizationPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewOrganizationPage.class);
  ...
  public ViewOrganizationPage createInstance(final ContextManager contextManager) {
    final ViewOrganizationPage instance = new ViewOrganizationPage();
    setIncompleteInstance(instance);
    final DataBinder ViewOrganizationPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Organization.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewOrganizationPage_binder);
    ViewOrganizationPage_DataBinder_binder(instance, ViewOrganizationPage_binder);
    final OrganizationDisplay ViewOrganizationPage_entityDisplayComponent = (OrganizationDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_o_OrganizationDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewOrganizationPage_entityDisplayComponent);
    ViewOrganizationPage_OrganizationDisplay_entityDisplayComponent(instance, ViewOrganizationPage_entityDisplayComponent);
    ...
    c_c_h_c_l_o_ViewOrganizationPageTemplateResource templateForViewOrganizationPage = GWT.create(c_c_h_c_l_o_ViewOrganizationPageTemplateResource.class);
    Element parentElementForTemplateOfViewOrganizationPage = TemplateUtil.getRootTemplateParentElement(templateForViewOrganizationPage.getContents().getText(), "com/cloderia/helion/client/local/organization/view-organization-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organization/view-organization-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewOrganizationPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewOrganizationPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organization.ViewOrganizationPage", "com/cloderia/helion/client/local/organization/view-organization-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organization.ViewOrganizationPage", "com/cloderia/helion/client/local/organization/view-organization-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewOrganizationPage_OrganizationDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewOrganizationPage_OrganizationDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewOrganizationPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewOrganizationPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewOrganizationPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewOrganizationPage instance) {
  ...
  native static DataBinder ViewOrganizationPage_DataBinder_binder(ViewOrganizationPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organization.ViewOrganizationPage::binder;
  }-*/;

  native static void ViewOrganizationPage_DataBinder_binder(ViewOrganizationPage instance, DataBinder<Organization> value) /*-{
    instance.@com.cloderia.helion.client.local.organization.ViewOrganizationPage::binder = value;
  }-*/;

  native static OrganizationDisplay ViewOrganizationPage_OrganizationDisplay_entityDisplayComponent(ViewOrganizationPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organization.ViewOrganizationPage::entityDisplayComponent;
  }-*/;

  native static void ViewOrganizationPage_OrganizationDisplay_entityDisplayComponent(ViewOrganizationPage instance, OrganizationDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.organization.ViewOrganizationPage::entityDisplayComponent = value;
  }-*/;
