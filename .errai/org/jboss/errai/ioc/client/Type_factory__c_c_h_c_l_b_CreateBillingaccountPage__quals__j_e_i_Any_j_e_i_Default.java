...
public class Type_factory__c_c_h_c_l_b_CreateBillingaccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateBillingaccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateBillingaccountPage.class, "Type_factory__c_c_h_c_l_b_CreateBillingaccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_CreateBillingaccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_CreateBillingaccountPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateBillingaccountPage.class);
  ...
  public CreateBillingaccountPage createInstance(final ContextManager contextManager) {
    final CreateBillingaccountPage instance = new CreateBillingaccountPage();
    ...
    final BillingaccountEditor CreateBillingaccountPage_billingaccountEditor = (BillingaccountEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_b_BillingaccountEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateBillingaccountPage_billingaccountEditor);
    CreateBillingaccountPage_BillingaccountEditor_billingaccountEditor(instance, CreateBillingaccountPage_billingaccountEditor);
    ...
    c_c_h_c_l_b_CreateBillingaccountPageTemplateResource templateForCreateBillingaccountPage = GWT.create(c_c_h_c_l_b_CreateBillingaccountPageTemplateResource.class);
    Element parentElementForTemplateOfCreateBillingaccountPage = TemplateUtil.getRootTemplateParentElement(templateForCreateBillingaccountPage.getContents().getText(), "com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateBillingaccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateBillingaccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.billingaccount.CreateBillingaccountPage", "com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.billingaccount.CreateBillingaccountPage", "com/cloderia/helion/client/local/billingaccount/edit-billingaccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateBillingaccountPage_BillingaccountEditor_billingaccountEditor(instance));
      }
    ...
    templateFieldsMap.put("billingaccountEditor", TemplateWidgetMapper.get(CreateBillingaccountPage_BillingaccountEditor_billingaccountEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateBillingaccountPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateBillingaccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateBillingaccountPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateBillingaccountPage instance) {
  ...
  native static BillingaccountEditor CreateBillingaccountPage_BillingaccountEditor_billingaccountEditor(CreateBillingaccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.billingaccount.CreateBillingaccountPage::billingaccountEditor;
  }-*/;

  native static void CreateBillingaccountPage_BillingaccountEditor_billingaccountEditor(CreateBillingaccountPage instance, BillingaccountEditor value) /*-{
    instance.@com.cloderia.helion.client.local.billingaccount.CreateBillingaccountPage::billingaccountEditor = value;
  }-*/;
