...
public class Type_factory__c_c_h_c_l_p_ListPartycategoryPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ListPartycategoryPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ListPartycategoryPage.class, "Type_factory__c_c_h_c_l_p_ListPartycategoryPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_ListPartycategoryPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/partycategory/list-partycategory-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_ListPartycategoryPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ListPartycategoryPage.class);
  ...
  public ListPartycategoryPage createInstance(final ContextManager contextManager) {
    final ListPartycategoryPage instance = new ListPartycategoryPage();
    ...
    final PartycategoryListWidget ListPartycategoryPage_listWidget = (PartycategoryListWidget) contextManager.getInstance("Type_factory__c_c_h_c_l_p_PartycategoryListWidget__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ListPartycategoryPage_listWidget);
    ListPartycategoryPage_PartycategoryListWidget_listWidget(instance, ListPartycategoryPage_listWidget);
    ...
    c_c_h_c_l_p_ListPartycategoryPageTemplateResource templateForListPartycategoryPage = GWT.create(c_c_h_c_l_p_ListPartycategoryPageTemplateResource.class);
    Element parentElementForTemplateOfListPartycategoryPage = TemplateUtil.getRootTemplateParentElement(templateForListPartycategoryPage.getContents().getText(), "com/cloderia/helion/client/local/partycategory/list-partycategory-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/partycategory/list-partycategory-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPartycategoryPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPartycategoryPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partycategory.ListPartycategoryPage", "com/cloderia/helion/client/local/partycategory/list-partycategory-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partycategory.ListPartycategoryPage", "com/cloderia/helion/client/local/partycategory/list-partycategory-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ListPartycategoryPage_PartycategoryListWidget_listWidget(instance).asWidget();
      }
    }, dataFieldElements, "listWidget");
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.partycategory.ListPartycategoryPage", "com/cloderia/helion/client/local/partycategory/list-partycategory-page.html", new Supplier<Widget>() {
      public Widget get() {
        return ElementWrapperWidget.getWidget(ListPartycategoryPage_AnchorElement_createNewPartycategoryLink(instance));
      }
    }, dataFieldElements, "createNewPartycategoryLink");
    ...
    templateFieldsMap.put("listWidget", ListPartycategoryPage_PartycategoryListWidget_listWidget(instance).asWidget());
    templateFieldsMap.put("createNewPartycategoryLink", ElementWrapperWidget.getWidget(ListPartycategoryPage_AnchorElement_createNewPartycategoryLink(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfListPartycategoryPage), templateFieldsMap.values());
    TemplateUtil.setupWrappedElementEventHandler(templateFieldsMap.get("createNewPartycategoryLink"), new ClickHandler() {
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ListPartycategoryPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ListPartycategoryPage instance, final ContextManager contextManager) {
    ...
    ElementWrapperWidget.removeWidget(ElementWrapperWidget.getWidget(ListPartycategoryPage_AnchorElement_createNewPartycategoryLink(instance)));
    TemplateUtil.cleanupWidget(instance);
  }

  public void invokePostConstructs(final ListPartycategoryPage instance) {
  ...
  native static AnchorElement ListPartycategoryPage_AnchorElement_createNewPartycategoryLink(ListPartycategoryPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partycategory.ListPartycategoryPage::createNewPartycategoryLink;
  }-*/;

  native static void ListPartycategoryPage_AnchorElement_createNewPartycategoryLink(ListPartycategoryPage instance, AnchorElement value) /*-{
    instance.@com.cloderia.helion.client.local.partycategory.ListPartycategoryPage::createNewPartycategoryLink = value;
  }-*/;
  ...
  native static PartycategoryListWidget ListPartycategoryPage_PartycategoryListWidget_listWidget(ListPartycategoryPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.partycategory.ListPartycategoryPage::listWidget;
  }-*/;

  native static void ListPartycategoryPage_PartycategoryListWidget_listWidget(ListPartycategoryPage instance, PartycategoryListWidget value) /*-{
    instance.@com.cloderia.helion.client.local.partycategory.ListPartycategoryPage::listWidget = value;
  }-*/;
