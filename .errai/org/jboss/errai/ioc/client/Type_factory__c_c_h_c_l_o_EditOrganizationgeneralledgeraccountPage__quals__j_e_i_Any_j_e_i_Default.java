...
public class Type_factory__c_c_h_c_l_o_EditOrganizationgeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditOrganizationgeneralledgeraccountPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditOrganizationgeneralledgeraccountPage.class, "Type_factory__c_c_h_c_l_o_EditOrganizationgeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_o_EditOrganizationgeneralledgeraccountPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/organizationgeneralledgeraccount/edit-organizationgeneralledgeraccount-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_o_EditOrganizationgeneralledgeraccountPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditOrganizationgeneralledgeraccountPage.class);
  ...
  public EditOrganizationgeneralledgeraccountPage createInstance(final ContextManager contextManager) {
    final EditOrganizationgeneralledgeraccountPage instance = new EditOrganizationgeneralledgeraccountPage();
    ...
    final OrganizationgeneralledgeraccountEditor EditOrganizationgeneralledgeraccountPage_organizationgeneralledgeraccountEditor = (OrganizationgeneralledgeraccountEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_o_OrganizationgeneralledgeraccountEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditOrganizationgeneralledgeraccountPage_organizationgeneralledgeraccountEditor);
    EditOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountEditor_organizationgeneralledgeraccountEditor(instance, EditOrganizationgeneralledgeraccountPage_organizationgeneralledgeraccountEditor);
    ...
    c_c_h_c_l_o_EditOrganizationgeneralledgeraccountPageTemplateResource templateForEditOrganizationgeneralledgeraccountPage = GWT.create(c_c_h_c_l_o_EditOrganizationgeneralledgeraccountPageTemplateResource.class);
    Element parentElementForTemplateOfEditOrganizationgeneralledgeraccountPage = TemplateUtil.getRootTemplateParentElement(templateForEditOrganizationgeneralledgeraccountPage.getContents().getText(), "com/cloderia/helion/client/local/organizationgeneralledgeraccount/edit-organizationgeneralledgeraccount-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/organizationgeneralledgeraccount/edit-organizationgeneralledgeraccount-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditOrganizationgeneralledgeraccountPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditOrganizationgeneralledgeraccountPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationgeneralledgeraccount.EditOrganizationgeneralledgeraccountPage", "com/cloderia/helion/client/local/organizationgeneralledgeraccount/edit-organizationgeneralledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.organizationgeneralledgeraccount.EditOrganizationgeneralledgeraccountPage", "com/cloderia/helion/client/local/organizationgeneralledgeraccount/edit-organizationgeneralledgeraccount-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountEditor_organizationgeneralledgeraccountEditor(instance));
      }
    ...
    templateFieldsMap.put("organizationgeneralledgeraccountEditor", TemplateWidgetMapper.get(EditOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountEditor_organizationgeneralledgeraccountEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditOrganizationgeneralledgeraccountPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditOrganizationgeneralledgeraccountPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditOrganizationgeneralledgeraccountPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditOrganizationgeneralledgeraccountPage instance) {
  ...
  native static OrganizationgeneralledgeraccountEditor EditOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountEditor_organizationgeneralledgeraccountEditor(EditOrganizationgeneralledgeraccountPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.organizationgeneralledgeraccount.EditOrganizationgeneralledgeraccountPage::organizationgeneralledgeraccountEditor;
  }-*/;

  native static void EditOrganizationgeneralledgeraccountPage_OrganizationgeneralledgeraccountEditor_organizationgeneralledgeraccountEditor(EditOrganizationgeneralledgeraccountPage instance, OrganizationgeneralledgeraccountEditor value) /*-{
    instance.@com.cloderia.helion.client.local.organizationgeneralledgeraccount.EditOrganizationgeneralledgeraccountPage::organizationgeneralledgeraccountEditor = value;
  }-*/;
