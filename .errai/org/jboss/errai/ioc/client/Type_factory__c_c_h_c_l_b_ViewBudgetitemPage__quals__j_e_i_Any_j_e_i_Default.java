...
public class Type_factory__c_c_h_c_l_b_ViewBudgetitemPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewBudgetitemPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewBudgetitemPage.class, "Type_factory__c_c_h_c_l_b_ViewBudgetitemPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_b_ViewBudgetitemPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/budgetitem/view-budgetitem-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_b_ViewBudgetitemPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewBudgetitemPage.class);
  ...
  public ViewBudgetitemPage createInstance(final ContextManager contextManager) {
    final ViewBudgetitemPage instance = new ViewBudgetitemPage();
    ...
    final DataBinder ViewBudgetitemPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Budgetitem.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewBudgetitemPage_binder);
    ViewBudgetitemPage_DataBinder_binder(instance, ViewBudgetitemPage_binder);
    final BudgetitemDisplay ViewBudgetitemPage_entityDisplayComponent = (BudgetitemDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_b_BudgetitemDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewBudgetitemPage_entityDisplayComponent);
    ViewBudgetitemPage_BudgetitemDisplay_entityDisplayComponent(instance, ViewBudgetitemPage_entityDisplayComponent);
    ...
    c_c_h_c_l_b_ViewBudgetitemPageTemplateResource templateForViewBudgetitemPage = GWT.create(c_c_h_c_l_b_ViewBudgetitemPageTemplateResource.class);
    Element parentElementForTemplateOfViewBudgetitemPage = TemplateUtil.getRootTemplateParentElement(templateForViewBudgetitemPage.getContents().getText(), "com/cloderia/helion/client/local/budgetitem/view-budgetitem-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/budgetitem/view-budgetitem-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewBudgetitemPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewBudgetitemPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budgetitem.ViewBudgetitemPage", "com/cloderia/helion/client/local/budgetitem/view-budgetitem-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.budgetitem.ViewBudgetitemPage", "com/cloderia/helion/client/local/budgetitem/view-budgetitem-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewBudgetitemPage_BudgetitemDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewBudgetitemPage_BudgetitemDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewBudgetitemPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewBudgetitemPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewBudgetitemPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewBudgetitemPage instance) {
  ...
  native static BudgetitemDisplay ViewBudgetitemPage_BudgetitemDisplay_entityDisplayComponent(ViewBudgetitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.budgetitem.ViewBudgetitemPage::entityDisplayComponent;
  }-*/;

  native static void ViewBudgetitemPage_BudgetitemDisplay_entityDisplayComponent(ViewBudgetitemPage instance, BudgetitemDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.budgetitem.ViewBudgetitemPage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewBudgetitemPage_DataBinder_binder(ViewBudgetitemPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.budgetitem.ViewBudgetitemPage::binder;
  }-*/;

  native static void ViewBudgetitemPage_DataBinder_binder(ViewBudgetitemPage instance, DataBinder<Budgetitem> value) /*-{
    instance.@com.cloderia.helion.client.local.budgetitem.ViewBudgetitemPage::binder = value;
  }-*/;
