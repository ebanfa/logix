...
public class Type_factory__c_c_h_c_l_a_ViewAgreementPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewAgreementPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewAgreementPage.class, "Type_factory__c_c_h_c_l_a_ViewAgreementPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_a_ViewAgreementPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/agreement/view-agreement-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_a_ViewAgreementPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewAgreementPage.class);
  ...
  public ViewAgreementPage createInstance(final ContextManager contextManager) {
    final ViewAgreementPage instance = new ViewAgreementPage();
    ...
    final DataBinder ViewAgreementPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Agreement.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewAgreementPage_binder);
    ViewAgreementPage_DataBinder_binder(instance, ViewAgreementPage_binder);
    ...
    final AgreementDisplay ViewAgreementPage_entityDisplayComponent = (AgreementDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_a_AgreementDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewAgreementPage_entityDisplayComponent);
    ViewAgreementPage_AgreementDisplay_entityDisplayComponent(instance, ViewAgreementPage_entityDisplayComponent);
    ...
    c_c_h_c_l_a_ViewAgreementPageTemplateResource templateForViewAgreementPage = GWT.create(c_c_h_c_l_a_ViewAgreementPageTemplateResource.class);
    Element parentElementForTemplateOfViewAgreementPage = TemplateUtil.getRootTemplateParentElement(templateForViewAgreementPage.getContents().getText(), "com/cloderia/helion/client/local/agreement/view-agreement-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/agreement/view-agreement-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewAgreementPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewAgreementPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.agreement.ViewAgreementPage", "com/cloderia/helion/client/local/agreement/view-agreement-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.agreement.ViewAgreementPage", "com/cloderia/helion/client/local/agreement/view-agreement-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewAgreementPage_AgreementDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewAgreementPage_AgreementDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewAgreementPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewAgreementPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewAgreementPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewAgreementPage instance) {
  ...
  native static AgreementDisplay ViewAgreementPage_AgreementDisplay_entityDisplayComponent(ViewAgreementPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.agreement.ViewAgreementPage::entityDisplayComponent;
  }-*/;

  native static void ViewAgreementPage_AgreementDisplay_entityDisplayComponent(ViewAgreementPage instance, AgreementDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.agreement.ViewAgreementPage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewAgreementPage_DataBinder_binder(ViewAgreementPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.agreement.ViewAgreementPage::binder;
  }-*/;

  native static void ViewAgreementPage_DataBinder_binder(ViewAgreementPage instance, DataBinder<Agreement> value) /*-{
    instance.@com.cloderia.helion.client.local.agreement.ViewAgreementPage::binder = value;
  }-*/;
