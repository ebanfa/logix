...
public class Type_factory__c_c_h_c_l_g_ViewGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewGeneralledgeraccounttypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewGeneralledgeraccounttypePage.class, "Type_factory__c_c_h_c_l_g_ViewGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_g_ViewGeneralledgeraccounttypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/generalledgeraccounttype/view-generalledgeraccounttype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_g_ViewGeneralledgeraccounttypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewGeneralledgeraccounttypePage.class);
  ...
  public ViewGeneralledgeraccounttypePage createInstance(final ContextManager contextManager) {
    final ViewGeneralledgeraccounttypePage instance = new ViewGeneralledgeraccounttypePage();
    setIncompleteInstance(instance);
    final GeneralledgeraccounttypeDisplay ViewGeneralledgeraccounttypePage_entityDisplayComponent = (GeneralledgeraccounttypeDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_g_GeneralledgeraccounttypeDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewGeneralledgeraccounttypePage_entityDisplayComponent);
    ViewGeneralledgeraccounttypePage_GeneralledgeraccounttypeDisplay_entityDisplayComponent(instance, ViewGeneralledgeraccounttypePage_entityDisplayComponent);
    ...
    final DataBinder ViewGeneralledgeraccounttypePage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Generalledgeraccounttype.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewGeneralledgeraccounttypePage_binder);
    ViewGeneralledgeraccounttypePage_DataBinder_binder(instance, ViewGeneralledgeraccounttypePage_binder);
    ...
    c_c_h_c_l_g_ViewGeneralledgeraccounttypePageTemplateResource templateForViewGeneralledgeraccounttypePage = GWT.create(c_c_h_c_l_g_ViewGeneralledgeraccounttypePageTemplateResource.class);
    Element parentElementForTemplateOfViewGeneralledgeraccounttypePage = TemplateUtil.getRootTemplateParentElement(templateForViewGeneralledgeraccounttypePage.getContents().getText(), "com/cloderia/helion/client/local/generalledgeraccounttype/view-generalledgeraccounttype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/generalledgeraccounttype/view-generalledgeraccounttype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewGeneralledgeraccounttypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewGeneralledgeraccounttypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccounttype.ViewGeneralledgeraccounttypePage", "com/cloderia/helion/client/local/generalledgeraccounttype/view-generalledgeraccounttype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.generalledgeraccounttype.ViewGeneralledgeraccounttypePage", "com/cloderia/helion/client/local/generalledgeraccounttype/view-generalledgeraccounttype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewGeneralledgeraccounttypePage_GeneralledgeraccounttypeDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewGeneralledgeraccounttypePage_GeneralledgeraccounttypeDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewGeneralledgeraccounttypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewGeneralledgeraccounttypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewGeneralledgeraccounttypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewGeneralledgeraccounttypePage instance) {
  ...
  native static GeneralledgeraccounttypeDisplay ViewGeneralledgeraccounttypePage_GeneralledgeraccounttypeDisplay_entityDisplayComponent(ViewGeneralledgeraccounttypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccounttype.ViewGeneralledgeraccounttypePage::entityDisplayComponent;
  }-*/;

  native static void ViewGeneralledgeraccounttypePage_GeneralledgeraccounttypeDisplay_entityDisplayComponent(ViewGeneralledgeraccounttypePage instance, GeneralledgeraccounttypeDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccounttype.ViewGeneralledgeraccounttypePage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewGeneralledgeraccounttypePage_DataBinder_binder(ViewGeneralledgeraccounttypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.generalledgeraccounttype.ViewGeneralledgeraccounttypePage::binder;
  }-*/;

  native static void ViewGeneralledgeraccounttypePage_DataBinder_binder(ViewGeneralledgeraccounttypePage instance, DataBinder<Generalledgeraccounttype> value) /*-{
    instance.@com.cloderia.helion.client.local.generalledgeraccounttype.ViewGeneralledgeraccounttypePage::binder = value;
  }-*/;
