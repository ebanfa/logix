...
public class Type_factory__c_c_h_c_l_f_ViewFacilityPage__quals__j_e_i_Any_j_e_i_Default extends Factory<ViewFacilityPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(ViewFacilityPage.class, "Type_factory__c_c_h_c_l_f_ViewFacilityPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_f_ViewFacilityPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/facility/view-facility-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_f_ViewFacilityPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(ViewFacilityPage.class);
  ...
  public ViewFacilityPage createInstance(final ContextManager contextManager) {
    final ViewFacilityPage instance = new ViewFacilityPage();
    ...
    final DataBinder ViewFacilityPage_binder = (DataBinder) contextManager.getContextualInstance("ContextualProvider_factory__o_j_e_d_c_a_DataBinder__quals__Universal", new Class[] { Facility.class }, new Annotation[] { });
    registerDependentScopedReference(instance, ViewFacilityPage_binder);
    ViewFacilityPage_DataBinder_binder(instance, ViewFacilityPage_binder);
    ...
    final FacilityDisplay ViewFacilityPage_entityDisplayComponent = (FacilityDisplay) contextManager.getInstance("Type_factory__c_c_h_c_l_f_FacilityDisplay__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, ViewFacilityPage_entityDisplayComponent);
    ViewFacilityPage_FacilityDisplay_entityDisplayComponent(instance, ViewFacilityPage_entityDisplayComponent);
    ...
    c_c_h_c_l_f_ViewFacilityPageTemplateResource templateForViewFacilityPage = GWT.create(c_c_h_c_l_f_ViewFacilityPageTemplateResource.class);
    Element parentElementForTemplateOfViewFacilityPage = TemplateUtil.getRootTemplateParentElement(templateForViewFacilityPage.getContents().getText(), "com/cloderia/helion/client/local/facility/view-facility-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/facility/view-facility-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewFacilityPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewFacilityPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facility.ViewFacilityPage", "com/cloderia/helion/client/local/facility/view-facility-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facility.ViewFacilityPage", "com/cloderia/helion/client/local/facility/view-facility-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(ViewFacilityPage_FacilityDisplay_entityDisplayComponent(instance));
      }
    ...
    templateFieldsMap.put("entityDisplayComponent", TemplateWidgetMapper.get(ViewFacilityPage_FacilityDisplay_entityDisplayComponent(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfViewFacilityPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((ViewFacilityPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final ViewFacilityPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final ViewFacilityPage instance) {
  ...
  native static FacilityDisplay ViewFacilityPage_FacilityDisplay_entityDisplayComponent(ViewFacilityPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facility.ViewFacilityPage::entityDisplayComponent;
  }-*/;

  native static void ViewFacilityPage_FacilityDisplay_entityDisplayComponent(ViewFacilityPage instance, FacilityDisplay value) /*-{
    instance.@com.cloderia.helion.client.local.facility.ViewFacilityPage::entityDisplayComponent = value;
  }-*/;
  ...
  native static DataBinder ViewFacilityPage_DataBinder_binder(ViewFacilityPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facility.ViewFacilityPage::binder;
  }-*/;

  native static void ViewFacilityPage_DataBinder_binder(ViewFacilityPage instance, DataBinder<Facility> value) /*-{
    instance.@com.cloderia.helion.client.local.facility.ViewFacilityPage::binder = value;
  }-*/;
