...
public class Type_factory__c_c_h_c_l_f_EditFacilityPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditFacilityPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditFacilityPage.class, "Type_factory__c_c_h_c_l_f_EditFacilityPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_f_EditFacilityPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/facility/edit-facility-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_f_EditFacilityPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditFacilityPage.class);
  ...
  public EditFacilityPage createInstance(final ContextManager contextManager) {
    final EditFacilityPage instance = new EditFacilityPage();
    ...
    final FacilityEditor EditFacilityPage_facilityEditor = (FacilityEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_f_FacilityEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditFacilityPage_facilityEditor);
    EditFacilityPage_FacilityEditor_facilityEditor(instance, EditFacilityPage_facilityEditor);
    ...
    c_c_h_c_l_f_EditFacilityPageTemplateResource templateForEditFacilityPage = GWT.create(c_c_h_c_l_f_EditFacilityPageTemplateResource.class);
    Element parentElementForTemplateOfEditFacilityPage = TemplateUtil.getRootTemplateParentElement(templateForEditFacilityPage.getContents().getText(), "com/cloderia/helion/client/local/facility/edit-facility-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/facility/edit-facility-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditFacilityPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditFacilityPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facility.EditFacilityPage", "com/cloderia/helion/client/local/facility/edit-facility-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.facility.EditFacilityPage", "com/cloderia/helion/client/local/facility/edit-facility-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditFacilityPage_FacilityEditor_facilityEditor(instance));
      }
    ...
    templateFieldsMap.put("facilityEditor", TemplateWidgetMapper.get(EditFacilityPage_FacilityEditor_facilityEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditFacilityPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditFacilityPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditFacilityPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditFacilityPage instance) {
  ...
  native static FacilityEditor EditFacilityPage_FacilityEditor_facilityEditor(EditFacilityPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.facility.EditFacilityPage::facilityEditor;
  }-*/;

  native static void EditFacilityPage_FacilityEditor_facilityEditor(EditFacilityPage instance, FacilityEditor value) /*-{
    instance.@com.cloderia.helion.client.local.facility.EditFacilityPage::facilityEditor = value;
  }-*/;
