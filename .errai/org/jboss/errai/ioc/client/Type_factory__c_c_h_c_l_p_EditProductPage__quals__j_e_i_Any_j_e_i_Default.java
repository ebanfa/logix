...
public class Type_factory__c_c_h_c_l_p_EditProductPage__quals__j_e_i_Any_j_e_i_Default extends Factory<EditProductPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(EditProductPage.class, "Type_factory__c_c_h_c_l_p_EditProductPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_EditProductPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/product/edit-product-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_EditProductPage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(EditProductPage.class);
  ...
  public EditProductPage createInstance(final ContextManager contextManager) {
    final EditProductPage instance = new EditProductPage();
    ...
    final ProductEditor EditProductPage_productEditor = (ProductEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProductEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, EditProductPage_productEditor);
    EditProductPage_ProductEditor_productEditor(instance, EditProductPage_productEditor);
    ...
    c_c_h_c_l_p_EditProductPageTemplateResource templateForEditProductPage = GWT.create(c_c_h_c_l_p_EditProductPageTemplateResource.class);
    Element parentElementForTemplateOfEditProductPage = TemplateUtil.getRootTemplateParentElement(templateForEditProductPage.getContents().getText(), "com/cloderia/helion/client/local/product/edit-product-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/product/edit-product-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProductPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProductPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.product.EditProductPage", "com/cloderia/helion/client/local/product/edit-product-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.product.EditProductPage", "com/cloderia/helion/client/local/product/edit-product-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(EditProductPage_ProductEditor_productEditor(instance));
      }
    ...
    templateFieldsMap.put("productEditor", TemplateWidgetMapper.get(EditProductPage_ProductEditor_productEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfEditProductPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((EditProductPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final EditProductPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final EditProductPage instance) {
  ...
  native static ProductEditor EditProductPage_ProductEditor_productEditor(EditProductPage instance) /*-{
    return instance.@com.cloderia.helion.client.local.product.EditProductPage::productEditor;
  }-*/;

  native static void EditProductPage_ProductEditor_productEditor(EditProductPage instance, ProductEditor value) /*-{
    instance.@com.cloderia.helion.client.local.product.EditProductPage::productEditor = value;
  }-*/;
