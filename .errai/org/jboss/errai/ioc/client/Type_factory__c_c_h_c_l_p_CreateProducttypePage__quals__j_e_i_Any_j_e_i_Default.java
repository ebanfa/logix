...
public class Type_factory__c_c_h_c_l_p_CreateProducttypePage__quals__j_e_i_Any_j_e_i_Default extends Factory<CreateProducttypePage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(CreateProducttypePage.class, "Type_factory__c_c_h_c_l_p_CreateProducttypePage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_p_CreateProducttypePageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/producttype/edit-producttype-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_p_CreateProducttypePage__quals__j_e_i_Any_j_e_i_Default() {
    handle.addAssignableType(CreateProducttypePage.class);
  ...
  public CreateProducttypePage createInstance(final ContextManager contextManager) {
    final CreateProducttypePage instance = new CreateProducttypePage();
    ...
    final ProducttypeEditor CreateProducttypePage_producttypeEditor = (ProducttypeEditor) contextManager.getInstance("Type_factory__c_c_h_c_l_p_ProducttypeEditor__quals__j_e_i_Any_j_e_i_Default");
    registerDependentScopedReference(instance, CreateProducttypePage_producttypeEditor);
    CreateProducttypePage_ProducttypeEditor_producttypeEditor(instance, CreateProducttypePage_producttypeEditor);
    ...
    c_c_h_c_l_p_CreateProducttypePageTemplateResource templateForCreateProducttypePage = GWT.create(c_c_h_c_l_p_CreateProducttypePageTemplateResource.class);
    Element parentElementForTemplateOfCreateProducttypePage = TemplateUtil.getRootTemplateParentElement(templateForCreateProducttypePage.getContents().getText(), "com/cloderia/helion/client/local/producttype/edit-producttype-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/producttype/edit-producttype-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProducttypePage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProducttypePage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.producttype.CreateProducttypePage", "com/cloderia/helion/client/local/producttype/edit-producttype-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.producttype.CreateProducttypePage", "com/cloderia/helion/client/local/producttype/edit-producttype-page.html", new Supplier<Widget>() {
      public Widget get() {
        return TemplateWidgetMapper.get(CreateProducttypePage_ProducttypeEditor_producttypeEditor(instance));
      }
    ...
    templateFieldsMap.put("producttypeEditor", TemplateWidgetMapper.get(CreateProducttypePage_ProducttypeEditor_producttypeEditor(instance)));
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfCreateProducttypePage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((CreateProducttypePage) instance, contextManager);
  }

  public void destroyInstanceHelper(final CreateProducttypePage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final CreateProducttypePage instance) {
  ...
  native static ProducttypeEditor CreateProducttypePage_ProducttypeEditor_producttypeEditor(CreateProducttypePage instance) /*-{
    return instance.@com.cloderia.helion.client.local.producttype.CreateProducttypePage::producttypeEditor;
  }-*/;

  native static void CreateProducttypePage_ProducttypeEditor_producttypeEditor(CreateProducttypePage instance, ProducttypeEditor value) /*-{
    instance.@com.cloderia.helion.client.local.producttype.CreateProducttypePage::producttypeEditor = value;
  }-*/;
