...
public class Type_factory__c_c_h_c_l_s_BaseSystemuserPage__quals__j_e_i_Any_j_e_i_Default extends Factory<BaseSystemuserPage> {
  private FactoryHandleImpl handle = new FactoryHandleImpl(BaseSystemuserPage.class, "Type_factory__c_c_h_c_l_s_BaseSystemuserPage__quals__j_e_i_Any_j_e_i_Default", Dependent.class, false, null, true);
  public interface c_c_h_c_l_s_BaseSystemuserPageTemplateResource extends Template, ClientBundle { @Source("com/cloderia/helion/client/local/systemuser/edit-systemuser-page.html") public TextResource getContents(); }
  public Type_factory__c_c_h_c_l_s_BaseSystemuserPage__quals__j_e_i_Any_j_e_i_Default() {
  ...
  public BaseSystemuserPage createInstance(final ContextManager contextManager) {
    final BaseSystemuserPage instance = new BaseSystemuserPage();
    ...
    c_c_h_c_l_s_BaseSystemuserPageTemplateResource templateForBaseSystemuserPage = GWT.create(c_c_h_c_l_s_BaseSystemuserPageTemplateResource.class);
    Element parentElementForTemplateOfBaseSystemuserPage = TemplateUtil.getRootTemplateParentElement(templateForBaseSystemuserPage.getContents().getText(), "com/cloderia/helion/client/local/systemuser/edit-systemuser-page.html", "app-container");
    TemplateUtil.translateTemplate("com/cloderia/helion/client/local/systemuser/edit-systemuser-page.html", TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseSystemuserPage));
    Map<String, Element> dataFieldElements = TemplateUtil.getDataFieldElements(TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseSystemuserPage));
    Map<String, Widget> templateFieldsMap = new LinkedHashMap<String, Widget>();
    TemplateUtil.compositeComponentReplace("com.cloderia.helion.client.local.systemuser.BaseSystemuserPage", "com/cloderia/helion/client/local/systemuser/edit-systemuser-page.html", new Supplier<Widget>() {
      public Widget get() {
    ...
    TemplateUtil.initWidget(instance, TemplateUtil.getRootTemplateElement(parentElementForTemplateOfBaseSystemuserPage), templateFieldsMap.values());
  ...
  public void generatedDestroyInstance(final Object instance, final ContextManager contextManager) {
    destroyInstanceHelper((BaseSystemuserPage) instance, contextManager);
  }

  public void destroyInstanceHelper(final BaseSystemuserPage instance, final ContextManager contextManager) {
  ...
  public void invokePostConstructs(final BaseSystemuserPage instance) {
