...
public class Marshaller_c_c_h_c_s_m_Containertype_1_Impl implements GeneratedMarshaller<Containertype> {
  private Containertype[] EMPTY_ARRAY = new Containertype[0];
  ...
  public Containertype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Containertype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Containertype.class, objId);
    }
  ...
  public String marshall(Containertype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Containertype\",\"^ObjectID\"");
