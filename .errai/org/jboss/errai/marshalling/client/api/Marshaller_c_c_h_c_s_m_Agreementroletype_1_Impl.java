...
public class Marshaller_c_c_h_c_s_m_Agreementroletype_1_Impl implements GeneratedMarshaller<Agreementroletype> {
  private Agreementroletype[] EMPTY_ARRAY = new Agreementroletype[0];
  ...
  public Agreementroletype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Agreementroletype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Agreementroletype.class, objId);
    }
    Agreementroletype entity = new Agreementroletype();
  ...
  public String marshall(Agreementroletype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Agreementroletype\",\"^ObjectID\"");
