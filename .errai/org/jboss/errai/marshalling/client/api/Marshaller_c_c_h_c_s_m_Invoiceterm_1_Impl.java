...
public class Marshaller_c_c_h_c_s_m_Invoiceterm_1_Impl implements GeneratedMarshaller<Invoiceterm> {
  private Invoiceterm[] EMPTY_ARRAY = new Invoiceterm[0];
  ...
  public Invoiceterm[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Invoiceterm demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Invoiceterm.class, objId);
    }
  ...
  public String marshall(Invoiceterm a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Invoiceterm\",\"^ObjectID\"");
