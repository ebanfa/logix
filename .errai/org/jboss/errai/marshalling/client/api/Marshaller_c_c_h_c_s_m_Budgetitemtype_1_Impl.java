...
public class Marshaller_c_c_h_c_s_m_Budgetitemtype_1_Impl implements GeneratedMarshaller<Budgetitemtype> {
  private Budgetitemtype[] EMPTY_ARRAY = new Budgetitemtype[0];
  ...
  public Budgetitemtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Budgetitemtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Budgetitemtype.class, objId);
    }
    Budgetitemtype entity = new Budgetitemtype();
  ...
  public String marshall(Budgetitemtype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Budgetitemtype\",\"^ObjectID\"");
