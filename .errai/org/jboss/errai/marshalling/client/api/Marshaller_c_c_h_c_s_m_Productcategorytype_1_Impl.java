...
public class Marshaller_c_c_h_c_s_m_Productcategorytype_1_Impl implements GeneratedMarshaller<Productcategorytype> {
  private Productcategorytype[] EMPTY_ARRAY = new Productcategorytype[0];
  ...
  public Productcategorytype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Productcategorytype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Productcategorytype.class, objId);
    }
    Productcategorytype entity = new Productcategorytype();
  ...
  public String marshall(Productcategorytype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Productcategorytype\",\"^ObjectID\"");
