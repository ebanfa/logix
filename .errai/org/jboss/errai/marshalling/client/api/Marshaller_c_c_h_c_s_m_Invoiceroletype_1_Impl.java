...
public class Marshaller_c_c_h_c_s_m_Invoiceroletype_1_Impl implements GeneratedMarshaller<Invoiceroletype> {
  private Invoiceroletype[] EMPTY_ARRAY = new Invoiceroletype[0];
  ...
  public Invoiceroletype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Invoiceroletype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Invoiceroletype.class, objId);
    }
    Invoiceroletype entity = new Invoiceroletype();
  ...
  public String marshall(Invoiceroletype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Invoiceroletype\",\"^ObjectID\"");
