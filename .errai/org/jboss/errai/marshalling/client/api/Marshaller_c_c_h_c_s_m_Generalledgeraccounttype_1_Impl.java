...
public class Marshaller_c_c_h_c_s_m_Generalledgeraccounttype_1_Impl implements GeneratedMarshaller<Generalledgeraccounttype> {
  private Generalledgeraccounttype[] EMPTY_ARRAY = new Generalledgeraccounttype[0];
  ...
  public Generalledgeraccounttype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Generalledgeraccounttype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Generalledgeraccounttype.class, objId);
    }
    Generalledgeraccounttype entity = new Generalledgeraccounttype();
  ...
  public String marshall(Generalledgeraccounttype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Generalledgeraccounttype\",\"^ObjectID\"");
