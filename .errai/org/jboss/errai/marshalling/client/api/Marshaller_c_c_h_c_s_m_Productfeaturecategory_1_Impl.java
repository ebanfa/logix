...
public class Marshaller_c_c_h_c_s_m_Productfeaturecategory_1_Impl implements GeneratedMarshaller<Productfeaturecategory> {
  private Productfeaturecategory[] EMPTY_ARRAY = new Productfeaturecategory[0];
  ...
  public Productfeaturecategory[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Productfeaturecategory demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Productfeaturecategory.class, objId);
    }
    Productfeaturecategory entity = new Productfeaturecategory();
  ...
  public String marshall(Productfeaturecategory a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Productfeaturecategory\",\"^ObjectID\"");
