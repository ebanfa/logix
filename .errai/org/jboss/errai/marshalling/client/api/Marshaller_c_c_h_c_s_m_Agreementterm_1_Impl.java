...
public class Marshaller_c_c_h_c_s_m_Agreementterm_1_Impl implements GeneratedMarshaller<Agreementterm> {
  private Agreementterm[] EMPTY_ARRAY = new Agreementterm[0];
  ...
  public Agreementterm[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Agreementterm demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Agreementterm.class, objId);
    }
    Agreementterm entity = new Agreementterm();
    ...
    if ((obj.containsKey("termTy")) && (!obj.get("termTy").isNull())) {
      entity.setTermTy(com_cloderia_helion_client_shared_model_Termtype.demarshall(obj.get("termTy"), a1));
    }
    ...
    if ((obj.containsKey("termValue")) && (!obj.get("termValue").isNull())) {
      entity.setTermValue(java_lang_Integer.demarshall(obj.get("termValue"), a1));
    }
