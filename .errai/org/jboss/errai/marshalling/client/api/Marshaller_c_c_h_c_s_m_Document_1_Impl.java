...
public class Marshaller_c_c_h_c_s_m_Document_1_Impl implements GeneratedMarshaller<Document> {
  private Document[] EMPTY_ARRAY = new Document[0];
  ...
  public Document[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Document demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Document.class, objId);
    }
    ...
    if ((obj.containsKey("docTy")) && (!obj.get("docTy").isNull())) {
      entity.setDocTy(com_cloderia_helion_client_shared_model_Documenttype.demarshall(obj.get("docTy"), a1));
    }
