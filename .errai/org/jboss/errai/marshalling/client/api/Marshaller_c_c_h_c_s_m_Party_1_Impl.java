...
public class Marshaller_c_c_h_c_s_m_Party_1_Impl implements GeneratedMarshaller<Party> {
  private Party[] EMPTY_ARRAY = new Party[0];
  ...
  public Party[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Party demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Party.class, objId);
    }
    ...
    if ((obj.containsKey("partyTy")) && (!obj.get("partyTy").isNull())) {
      entity.setPartyTy(com_cloderia_helion_client_shared_model_Partytype.demarshall(obj.get("partyTy"), a1));
    }
