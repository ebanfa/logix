...
public class Marshaller_c_c_h_c_s_m_Paymentapplication_1_Impl implements GeneratedMarshaller<Paymentapplication> {
  private Paymentapplication[] EMPTY_ARRAY = new Paymentapplication[0];
  ...
  public Paymentapplication[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Paymentapplication demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Paymentapplication.class, objId);
    }
    ...
    if ((obj.containsKey("billingAcct")) && (!obj.get("billingAcct").isNull())) {
      entity.setBillingAcct(com_cloderia_helion_client_shared_model_Billingaccount.demarshall(obj.get("billingAcct"), a1));
    }
    ...
    if ((obj.containsKey("amountApplied")) && (!obj.get("amountApplied").isNull())) {
      entity.setAmountApplied(java_math_BigDecimal.demarshall(obj.get("amountApplied"), a1));
    }
