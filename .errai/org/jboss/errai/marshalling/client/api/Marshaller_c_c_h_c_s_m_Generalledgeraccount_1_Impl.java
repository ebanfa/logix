...
public class Marshaller_c_c_h_c_s_m_Generalledgeraccount_1_Impl implements GeneratedMarshaller<Generalledgeraccount> {
  private Generalledgeraccount[] EMPTY_ARRAY = new Generalledgeraccount[0];
  ...
  public Generalledgeraccount[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Generalledgeraccount demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Generalledgeraccount.class, objId);
    }
    Generalledgeraccount entity = new Generalledgeraccount();
    ...
    if ((obj.containsKey("glAcctTy")) && (!obj.get("glAcctTy").isNull())) {
      entity.setGlAcctTy(com_cloderia_helion_client_shared_model_Generalledgeraccounttype.demarshall(obj.get("glAcctTy"), a1));
    }
