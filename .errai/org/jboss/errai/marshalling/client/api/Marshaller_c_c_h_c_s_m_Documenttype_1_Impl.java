...
public class Marshaller_c_c_h_c_s_m_Documenttype_1_Impl implements GeneratedMarshaller<Documenttype> {
  private Documenttype[] EMPTY_ARRAY = new Documenttype[0];
  ...
  public Documenttype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Documenttype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Documenttype.class, objId);
    }
    ...
    if ((obj.containsKey("parentTy")) && (!obj.get("parentTy").isNull())) {
      entity.setParentTy(com_cloderia_helion_client_shared_model_Documenttype.demarshall(obj.get("parentTy"), a1));
    }
  ...
  private void lazyInit() {
    ...
    if (com_cloderia_helion_client_shared_model_Documenttype == null) {
      com_cloderia_helion_client_shared_model_Documenttype = this;
    }
  }
}