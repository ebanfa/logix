...
public class Marshaller_c_c_h_c_s_m_Financialaccounttype_1_Impl implements GeneratedMarshaller<Financialaccounttype> {
  private Financialaccounttype[] EMPTY_ARRAY = new Financialaccounttype[0];
  ...
  public Financialaccounttype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Financialaccounttype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Financialaccounttype.class, objId);
    }
    Financialaccounttype entity = new Financialaccounttype();
  ...
  public String marshall(Financialaccounttype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Financialaccounttype\",\"^ObjectID\"");
