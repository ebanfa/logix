...
public class Marshaller_c_c_h_c_s_m_Facility_1_Impl implements GeneratedMarshaller<Facility> {
  private Facility[] EMPTY_ARRAY = new Facility[0];
  ...
  public Facility[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Facility demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Facility.class, objId);
    }
    ...
    if ((obj.containsKey("facilityTy")) && (!obj.get("facilityTy").isNull())) {
      entity.setFacilityTy(com_cloderia_helion_client_shared_model_Facilitytype.demarshall(obj.get("facilityTy"), a1));
    }
