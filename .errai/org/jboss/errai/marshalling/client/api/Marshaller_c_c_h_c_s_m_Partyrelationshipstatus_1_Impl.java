...
public class Marshaller_c_c_h_c_s_m_Partyrelationshipstatus_1_Impl implements GeneratedMarshaller<Partyrelationshipstatus> {
  private Partyrelationshipstatus[] EMPTY_ARRAY = new Partyrelationshipstatus[0];
  ...
  public Partyrelationshipstatus[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Partyrelationshipstatus demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Partyrelationshipstatus.class, objId);
    }
    Partyrelationshipstatus entity = new Partyrelationshipstatus();
  ...
  public String marshall(Partyrelationshipstatus a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Partyrelationshipstatus\",\"^ObjectID\"");
