...
public class Marshaller_c_c_h_c_s_m_Preferencetype_1_Impl implements GeneratedMarshaller<Preferencetype> {
  private Preferencetype[] EMPTY_ARRAY = new Preferencetype[0];
  ...
  public Preferencetype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Preferencetype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Preferencetype.class, objId);
    }
    Preferencetype entity = new Preferencetype();
  ...
  public String marshall(Preferencetype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Preferencetype\",\"^ObjectID\"");
