...
public class Marshaller_c_c_h_c_s_m_Financialaccounttransactiontype_1_Impl implements GeneratedMarshaller<Financialaccounttransactiontype> {
  private Financialaccounttransactiontype[] EMPTY_ARRAY = new Financialaccounttransactiontype[0];
  ...
  public Financialaccounttransactiontype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Financialaccounttransactiontype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Financialaccounttransactiontype.class, objId);
    }
    Financialaccounttransactiontype entity = new Financialaccounttransactiontype();
  ...
  public String marshall(Financialaccounttransactiontype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Financialaccounttransactiontype\",\"^ObjectID\"");
