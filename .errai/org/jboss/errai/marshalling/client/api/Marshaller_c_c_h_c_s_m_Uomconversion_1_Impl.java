...
public class Marshaller_c_c_h_c_s_m_Uomconversion_1_Impl implements GeneratedMarshaller<Uomconversion> {
  private Uomconversion[] EMPTY_ARRAY = new Uomconversion[0];
  ...
  public Uomconversion[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Uomconversion demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Uomconversion.class, objId);
    }
    ...
    if ((obj.containsKey("fromUom")) && (!obj.get("fromUom").isNull())) {
      entity.setFromUom(com_cloderia_helion_client_shared_model_Uom.demarshall(obj.get("fromUom"), a1));
    }
    if ((obj.containsKey("toUom")) && (!obj.get("toUom").isNull())) {
      entity.setToUom(com_cloderia_helion_client_shared_model_Uom.demarshall(obj.get("toUom"), a1));
    }
    ...
    if ((obj.containsKey("conversionFactor")) && (!obj.get("conversionFactor").isNull())) {
      entity.setConversionFactor(java_lang_Integer.demarshall(obj.get("conversionFactor"), a1));
    }
