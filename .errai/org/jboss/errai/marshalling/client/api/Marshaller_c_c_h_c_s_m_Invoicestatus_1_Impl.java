...
public class Marshaller_c_c_h_c_s_m_Invoicestatus_1_Impl implements GeneratedMarshaller<Invoicestatus> {
  private Invoicestatus[] EMPTY_ARRAY = new Invoicestatus[0];
  ...
  public Invoicestatus[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Invoicestatus demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Invoicestatus.class, objId);
    }
    ...
    if ((obj.containsKey("invoiceStatTy")) && (!obj.get("invoiceStatTy").isNull())) {
      entity.setInvoiceStatTy(com_cloderia_helion_client_shared_model_Invoicestatustype.demarshall(obj.get("invoiceStatTy"), a1));
    }
