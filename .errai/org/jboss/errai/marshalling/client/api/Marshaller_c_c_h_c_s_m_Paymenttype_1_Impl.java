...
public class Marshaller_c_c_h_c_s_m_Paymenttype_1_Impl implements GeneratedMarshaller<Paymenttype> {
  private Paymenttype[] EMPTY_ARRAY = new Paymenttype[0];
  ...
  public Paymenttype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Paymenttype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Paymenttype.class, objId);
    }
  ...
  public String marshall(Paymenttype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Paymenttype\",\"^ObjectID\"");
