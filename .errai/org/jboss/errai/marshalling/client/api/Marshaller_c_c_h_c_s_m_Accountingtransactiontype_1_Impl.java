...
public class Marshaller_c_c_h_c_s_m_Accountingtransactiontype_1_Impl implements GeneratedMarshaller<Accountingtransactiontype> {
  private Accountingtransactiontype[] EMPTY_ARRAY = new Accountingtransactiontype[0];
  ...
  public Accountingtransactiontype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Accountingtransactiontype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Accountingtransactiontype.class, objId);
    }
    Accountingtransactiontype entity = new Accountingtransactiontype();
    ...
    if ((obj.containsKey("parentTy")) && (!obj.get("parentTy").isNull())) {
      entity.setParentTy(com_cloderia_helion_client_shared_model_Accountingtransactiontype.demarshall(obj.get("parentTy"), a1));
    }
  ...
  private void lazyInit() {
    ...
    if (com_cloderia_helion_client_shared_model_Accountingtransactiontype == null) {
      com_cloderia_helion_client_shared_model_Accountingtransactiontype = this;
    }
  }
}