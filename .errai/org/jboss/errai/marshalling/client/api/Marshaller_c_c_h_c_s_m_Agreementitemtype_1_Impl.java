...
public class Marshaller_c_c_h_c_s_m_Agreementitemtype_1_Impl implements GeneratedMarshaller<Agreementitemtype> {
  private Agreementitemtype[] EMPTY_ARRAY = new Agreementitemtype[0];
  ...
  public Agreementitemtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Agreementitemtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Agreementitemtype.class, objId);
    }
    Agreementitemtype entity = new Agreementitemtype();
  ...
  public String marshall(Agreementitemtype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Agreementitemtype\",\"^ObjectID\"");
