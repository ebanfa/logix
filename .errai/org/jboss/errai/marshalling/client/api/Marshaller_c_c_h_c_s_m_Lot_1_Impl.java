...
public class Marshaller_c_c_h_c_s_m_Lot_1_Impl implements GeneratedMarshaller<Lot> {
  private Lot[] EMPTY_ARRAY = new Lot[0];
  ...
  public Lot[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Lot demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Lot.class, objId);
    }
    Lot entity = new Lot();
    ...
    if ((obj.containsKey("expiryDt")) && (!obj.get("expiryDt").isNull())) {
      entity.setExpiryDt(java_util_Date.demarshall(obj.get("expiryDt"), a1));
    }
