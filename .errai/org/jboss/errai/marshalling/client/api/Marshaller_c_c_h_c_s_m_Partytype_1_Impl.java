...
public class Marshaller_c_c_h_c_s_m_Partytype_1_Impl implements GeneratedMarshaller<Partytype> {
  private Partytype[] EMPTY_ARRAY = new Partytype[0];
  ...
  public Partytype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Partytype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Partytype.class, objId);
    }
    ...
    if ((obj.containsKey("parentCategory")) && (!obj.get("parentCategory").isNull())) {
      entity.setParentCategory(com_cloderia_helion_client_shared_model_Partycategory.demarshall(obj.get("parentCategory"), a1));
    }
    if ((obj.containsKey("parentType")) && (!obj.get("parentType").isNull())) {
      entity.setParentType(com_cloderia_helion_client_shared_model_Partytype.demarshall(obj.get("parentType"), a1));
    }
  ...
  private void lazyInit() {
    ...
    if (com_cloderia_helion_client_shared_model_Partytype == null) {
      com_cloderia_helion_client_shared_model_Partytype = this;
    }
  }
}