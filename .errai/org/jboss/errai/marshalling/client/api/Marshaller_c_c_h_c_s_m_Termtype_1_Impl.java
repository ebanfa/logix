...
public class Marshaller_c_c_h_c_s_m_Termtype_1_Impl implements GeneratedMarshaller<Termtype> {
  private Termtype[] EMPTY_ARRAY = new Termtype[0];
  ...
  public Termtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Termtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Termtype.class, objId);
    }
  ...
  public String marshall(Termtype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Termtype\",\"^ObjectID\"");
