...
public class Marshaller_c_c_h_c_s_m_Inventoryitemtype_1_Impl implements GeneratedMarshaller<Inventoryitemtype> {
  private Inventoryitemtype[] EMPTY_ARRAY = new Inventoryitemtype[0];
  ...
  public Inventoryitemtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Inventoryitemtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Inventoryitemtype.class, objId);
    }
    Inventoryitemtype entity = new Inventoryitemtype();
  ...
  public String marshall(Inventoryitemtype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Inventoryitemtype\",\"^ObjectID\"");
