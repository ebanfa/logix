...
public class Marshaller_c_c_h_c_s_m_Financialaccount_1_Impl implements GeneratedMarshaller<Financialaccount> {
  private Financialaccount[] EMPTY_ARRAY = new Financialaccount[0];
  ...
  public Financialaccount[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Financialaccount demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Financialaccount.class, objId);
    }
    ...
    if ((obj.containsKey("finAcctTy")) && (!obj.get("finAcctTy").isNull())) {
      entity.setFinAcctTy(com_cloderia_helion_client_shared_model_Financialaccounttype.demarshall(obj.get("finAcctTy"), a1));
    }
