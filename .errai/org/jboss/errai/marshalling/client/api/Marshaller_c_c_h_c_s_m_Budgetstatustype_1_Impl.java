...
public class Marshaller_c_c_h_c_s_m_Budgetstatustype_1_Impl implements GeneratedMarshaller<Budgetstatustype> {
  private Budgetstatustype[] EMPTY_ARRAY = new Budgetstatustype[0];
  ...
  public Budgetstatustype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Budgetstatustype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Budgetstatustype.class, objId);
    }
    Budgetstatustype entity = new Budgetstatustype();
  ...
  public String marshall(Budgetstatustype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Budgetstatustype\",\"^ObjectID\"");
