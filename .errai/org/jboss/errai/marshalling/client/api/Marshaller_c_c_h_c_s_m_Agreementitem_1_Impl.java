...
public class Marshaller_c_c_h_c_s_m_Agreementitem_1_Impl implements GeneratedMarshaller<Agreementitem> {
  private Agreementitem[] EMPTY_ARRAY = new Agreementitem[0];
  private Marshaller<Long> java_lang_Long = Marshalling.getMarshaller(Long.class);
  private Marshaller<Universe> com_cloderia_helion_client_shared_model_Universe = null;
  private Marshaller<Agreementitemtype> com_cloderia_helion_client_shared_model_Agreementitemtype = null;
  ...
  public Agreementitem[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Agreementitem demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Agreementitem.class, objId);
    }
    Agreementitem entity = new Agreementitem();
    ...
    if ((obj.containsKey("agreementItemTy")) && (!obj.get("agreementItemTy").isNull())) {
      entity.setAgreementItemTy(com_cloderia_helion_client_shared_model_Agreementitemtype.demarshall(obj.get("agreementItemTy"), a1));
    }
    ...
    if ((obj.containsKey("agreementText")) && (!obj.get("agreementText").isNull())) {
      entity.setAgreementText(java_math_BigDecimal.demarshall(obj.get("agreementText"), a1));
    }
    if ((obj.containsKey("agreementImage")) && (!obj.get("agreementImage").isNull())) {
      entity.setAgreementImage(java_math_BigDecimal.demarshall(obj.get("agreementImage"), a1));
    }
    if ((obj.containsKey("agreementDt")) && (!obj.get("agreementDt").isNull())) {
      entity.setAgreementDt(java_util_Date.demarshall(obj.get("agreementDt"), a1));
    }
  ...
  private void lazyInit() {
    ...
    if (com_cloderia_helion_client_shared_model_Agreementitemtype == null) {
      com_cloderia_helion_client_shared_model_Agreementitemtype = Marshalling.getMarshaller(Agreementitemtype.class);
    }
    ...
    if (com_cloderia_helion_client_shared_model_Agreementitem == null) {
      com_cloderia_helion_client_shared_model_Agreementitem = this;
    }
  }
}