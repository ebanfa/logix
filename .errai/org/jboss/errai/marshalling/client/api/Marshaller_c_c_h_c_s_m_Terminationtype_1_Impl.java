...
public class Marshaller_c_c_h_c_s_m_Terminationtype_1_Impl implements GeneratedMarshaller<Terminationtype> {
  private Terminationtype[] EMPTY_ARRAY = new Terminationtype[0];
  ...
  public Terminationtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Terminationtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Terminationtype.class, objId);
    }
  ...
  public String marshall(Terminationtype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Terminationtype\",\"^ObjectID\"");
