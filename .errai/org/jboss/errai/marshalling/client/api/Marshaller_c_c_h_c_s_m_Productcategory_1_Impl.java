...
public class Marshaller_c_c_h_c_s_m_Productcategory_1_Impl implements GeneratedMarshaller<Productcategory> {
  private Productcategory[] EMPTY_ARRAY = new Productcategory[0];
  ...
  public Productcategory[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Productcategory demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Productcategory.class, objId);
    }
    ...
    if ((obj.containsKey("prodCatTy")) && (!obj.get("prodCatTy").isNull())) {
      entity.setProdCatTy(com_cloderia_helion_client_shared_model_Productcategorytype.demarshall(obj.get("prodCatTy"), a1));
    }
