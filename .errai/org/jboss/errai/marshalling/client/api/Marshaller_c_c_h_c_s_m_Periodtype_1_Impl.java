...
public class Marshaller_c_c_h_c_s_m_Periodtype_1_Impl implements GeneratedMarshaller<Periodtype> {
  private Periodtype[] EMPTY_ARRAY = new Periodtype[0];
  ...
  public Periodtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Periodtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Periodtype.class, objId);
    }
  ...
  public String marshall(Periodtype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Periodtype\",\"^ObjectID\"");
