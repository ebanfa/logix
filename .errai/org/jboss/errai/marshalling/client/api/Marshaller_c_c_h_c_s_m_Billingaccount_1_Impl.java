...
public class Marshaller_c_c_h_c_s_m_Billingaccount_1_Impl implements GeneratedMarshaller<Billingaccount> {
  private Billingaccount[] EMPTY_ARRAY = new Billingaccount[0];
  ...
  public Billingaccount[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Billingaccount demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Billingaccount.class, objId);
    }
    ...
    if ((obj.containsKey("toContMech")) && (!obj.get("toContMech").isNull())) {
      entity.setToContMech(com_cloderia_helion_client_shared_model_Contactmechanism.demarshall(obj.get("toContMech"), a1));
    }
