...
public class Marshaller_c_c_h_c_s_m_Contactmechanism_1_Impl implements GeneratedMarshaller<Contactmechanism> {
  private Contactmechanism[] EMPTY_ARRAY = new Contactmechanism[0];
  ...
  public Contactmechanism[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Contactmechanism demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Contactmechanism.class, objId);
    }
    Contactmechanism entity = new Contactmechanism();
    ...
    if ((obj.containsKey("contMechTy")) && (!obj.get("contMechTy").isNull())) {
      entity.setContMechTy(com_cloderia_helion_client_shared_model_Contactmechanismtype.demarshall(obj.get("contMechTy"), a1));
    }
