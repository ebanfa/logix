...
public class Marshaller_c_c_h_c_s_m_Contactmechanismpurposetype_1_Impl implements GeneratedMarshaller<Contactmechanismpurposetype> {
  private Contactmechanismpurposetype[] EMPTY_ARRAY = new Contactmechanismpurposetype[0];
  ...
  public Contactmechanismpurposetype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Contactmechanismpurposetype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Contactmechanismpurposetype.class, objId);
    }
    Contactmechanismpurposetype entity = new Contactmechanismpurposetype();
  ...
  public String marshall(Contactmechanismpurposetype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Contactmechanismpurposetype\",\"^ObjectID\"");
