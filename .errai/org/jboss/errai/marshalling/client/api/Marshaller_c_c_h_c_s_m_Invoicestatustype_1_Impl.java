...
public class Marshaller_c_c_h_c_s_m_Invoicestatustype_1_Impl implements GeneratedMarshaller<Invoicestatustype> {
  private Invoicestatustype[] EMPTY_ARRAY = new Invoicestatustype[0];
  ...
  public Invoicestatustype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Invoicestatustype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Invoicestatustype.class, objId);
    }
    Invoicestatustype entity = new Invoicestatustype();
  ...
  public String marshall(Invoicestatustype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Invoicestatustype\",\"^ObjectID\"");
