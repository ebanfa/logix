...
public class Marshaller_c_c_h_c_s_m_Depreciationmethod_1_Impl implements GeneratedMarshaller<Depreciationmethod> {
  private Depreciationmethod[] EMPTY_ARRAY = new Depreciationmethod[0];
  ...
  public Depreciationmethod[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Depreciationmethod demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Depreciationmethod.class, objId);
    }
    Depreciationmethod entity = new Depreciationmethod();
    ...
    if ((obj.containsKey("formula")) && (!obj.get("formula").isNull())) {
      entity.setFormula(java_lang_String.demarshall(obj.get("formula"), a1));
    }
