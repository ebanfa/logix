...
public class Marshaller_c_c_h_c_s_m_Agreementrole_1_Impl implements GeneratedMarshaller<Agreementrole> {
  private Agreementrole[] EMPTY_ARRAY = new Agreementrole[0];
  ...
  public Agreementrole[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Agreementrole demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Agreementrole.class, objId);
    }
    Agreementrole entity = new Agreementrole();
    ...
    if ((obj.containsKey("agreementRoleTy")) && (!obj.get("agreementRoleTy").isNull())) {
      entity.setAgreementRoleTy(com_cloderia_helion_client_shared_model_Agreementroletype.demarshall(obj.get("agreementRoleTy"), a1));
    }
