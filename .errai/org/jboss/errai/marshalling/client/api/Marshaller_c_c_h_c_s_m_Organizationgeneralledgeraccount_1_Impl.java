...
public class Marshaller_c_c_h_c_s_m_Organizationgeneralledgeraccount_1_Impl implements GeneratedMarshaller<Organizationgeneralledgeraccount> {
  private Organizationgeneralledgeraccount[] EMPTY_ARRAY = new Organizationgeneralledgeraccount[0];
  ...
  public Organizationgeneralledgeraccount[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Organizationgeneralledgeraccount demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Organizationgeneralledgeraccount.class, objId);
    }
    Organizationgeneralledgeraccount entity = new Organizationgeneralledgeraccount();
    ...
    if ((obj.containsKey("productCat")) && (!obj.get("productCat").isNull())) {
      entity.setProductCat(com_cloderia_helion_client_shared_model_Productcategory.demarshall(obj.get("productCat"), a1));
    }
    ...
    if ((obj.containsKey("refParty")) && (!obj.get("refParty").isNull())) {
      entity.setRefParty(com_cloderia_helion_client_shared_model_Party.demarshall(obj.get("refParty"), a1));
    }
