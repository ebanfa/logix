...
public class Marshaller_c_c_h_c_s_m_Fixedassetdepreciationmethod_1_Impl implements GeneratedMarshaller<Fixedassetdepreciationmethod> {
  private Fixedassetdepreciationmethod[] EMPTY_ARRAY = new Fixedassetdepreciationmethod[0];
  ...
  public Fixedassetdepreciationmethod[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Fixedassetdepreciationmethod demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Fixedassetdepreciationmethod.class, objId);
    }
    Fixedassetdepreciationmethod entity = new Fixedassetdepreciationmethod();
    ...
    if ((obj.containsKey("depMethod")) && (!obj.get("depMethod").isNull())) {
      entity.setDepMethod(com_cloderia_helion_client_shared_model_Depreciationmethod.demarshall(obj.get("depMethod"), a1));
    }
