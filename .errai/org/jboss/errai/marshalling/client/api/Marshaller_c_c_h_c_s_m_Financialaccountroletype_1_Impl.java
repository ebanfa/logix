...
public class Marshaller_c_c_h_c_s_m_Financialaccountroletype_1_Impl implements GeneratedMarshaller<Financialaccountroletype> {
  private Financialaccountroletype[] EMPTY_ARRAY = new Financialaccountroletype[0];
  ...
  public Financialaccountroletype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Financialaccountroletype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Financialaccountroletype.class, objId);
    }
    Financialaccountroletype entity = new Financialaccountroletype();
  ...
  public String marshall(Financialaccountroletype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Financialaccountroletype\",\"^ObjectID\"");
