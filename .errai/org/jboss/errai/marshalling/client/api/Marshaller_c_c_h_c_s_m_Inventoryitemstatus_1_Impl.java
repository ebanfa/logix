...
public class Marshaller_c_c_h_c_s_m_Inventoryitemstatus_1_Impl implements GeneratedMarshaller<Inventoryitemstatus> {
  private Inventoryitemstatus[] EMPTY_ARRAY = new Inventoryitemstatus[0];
  ...
  public Inventoryitemstatus[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Inventoryitemstatus demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Inventoryitemstatus.class, objId);
    }
    Inventoryitemstatus entity = new Inventoryitemstatus();
  ...
  public String marshall(Inventoryitemstatus a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Inventoryitemstatus\",\"^ObjectID\"");
