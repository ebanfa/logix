...
public class Marshaller_c_c_h_c_s_m_Geoboundry_1_Impl implements GeneratedMarshaller<Geoboundry> {
  private Geoboundry[] EMPTY_ARRAY = new Geoboundry[0];
  ...
  public Geoboundry[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Geoboundry demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Geoboundry.class, objId);
    }
    Geoboundry entity = new Geoboundry();
    ...
    if ((obj.containsKey("geoBoundryTy")) && (!obj.get("geoBoundryTy").isNull())) {
      entity.setGeoBoundryTy(com_cloderia_helion_client_shared_model_Geoboundrytype.demarshall(obj.get("geoBoundryTy"), a1));
    }
    if ((obj.containsKey("parentGeoBoundry")) && (!obj.get("parentGeoBoundry").isNull())) {
      entity.setParentGeoBoundry(com_cloderia_helion_client_shared_model_Geoboundry.demarshall(obj.get("parentGeoBoundry"), a1));
    }
    ...
    if ((obj.containsKey("geoCode")) && (!obj.get("geoCode").isNull())) {
      entity.setGeoCode(java_lang_String.demarshall(obj.get("geoCode"), a1));
    }
    if ((obj.containsKey("name")) && (!obj.get("name").isNull())) {
      entity.setName(java_lang_String.demarshall(obj.get("name"), a1));
    }
    if ((obj.containsKey("abbr")) && (!obj.get("abbr").isNull())) {
      entity.setAbbr(java_lang_String.demarshall(obj.get("abbr"), a1));
    }
  ...
  private void lazyInit() {
    ...
    if (com_cloderia_helion_client_shared_model_Geoboundry == null) {
      com_cloderia_helion_client_shared_model_Geoboundry = this;
    }
  }
}