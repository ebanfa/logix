...
public class Marshaller_c_c_h_c_s_m_Uom_1_Impl implements GeneratedMarshaller<Uom> {
  private Uom[] EMPTY_ARRAY = new Uom[0];
  ...
  public Uom[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Uom demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Uom.class, objId);
    }
    Uom entity = new Uom();
  ...
  public String marshall(Uom a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Uom\",\"^ObjectID\"");
