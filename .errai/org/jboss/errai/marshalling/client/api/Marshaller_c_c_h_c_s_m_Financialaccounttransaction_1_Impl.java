...
public class Marshaller_c_c_h_c_s_m_Financialaccounttransaction_1_Impl implements GeneratedMarshaller<Financialaccounttransaction> {
  private Financialaccounttransaction[] EMPTY_ARRAY = new Financialaccounttransaction[0];
  ...
  public Financialaccounttransaction[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Financialaccounttransaction demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Financialaccounttransaction.class, objId);
    }
    Financialaccounttransaction entity = new Financialaccounttransaction();
    ...
    if ((obj.containsKey("finTxnTy")) && (!obj.get("finTxnTy").isNull())) {
      entity.setFinTxnTy(com_cloderia_helion_client_shared_model_Financialaccounttransactiontype.demarshall(obj.get("finTxnTy"), a1));
    }
