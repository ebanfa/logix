...
public class Marshaller_c_c_h_c_s_m_Contactmechanismtype_1_Impl implements GeneratedMarshaller<Contactmechanismtype> {
  private Contactmechanismtype[] EMPTY_ARRAY = new Contactmechanismtype[0];
  ...
  public Contactmechanismtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Contactmechanismtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Contactmechanismtype.class, objId);
    }
    Contactmechanismtype entity = new Contactmechanismtype();
  ...
  public String marshall(Contactmechanismtype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Contactmechanismtype\",\"^ObjectID\"");
