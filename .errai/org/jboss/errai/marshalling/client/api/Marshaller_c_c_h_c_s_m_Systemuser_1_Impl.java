...
public class Marshaller_c_c_h_c_s_m_Systemuser_1_Impl implements GeneratedMarshaller<Systemuser> {
  private Systemuser[] EMPTY_ARRAY = new Systemuser[0];
  ...
  public Systemuser[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Systemuser demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Systemuser.class, objId);
    }
    ...
    if ((obj.containsKey("userNm")) && (!obj.get("userNm").isNull())) {
      entity.setUserNm(java_lang_String.demarshall(obj.get("userNm"), a1));
    }
    ...
    if ((obj.containsKey("lastLoginDt")) && (!obj.get("lastLoginDt").isNull())) {
      entity.setLastLoginDt(java_util_Date.demarshall(obj.get("lastLoginDt"), a1));
    }
    if ((obj.containsKey("lockedFg")) && (!obj.get("lockedFg").isNull())) {
      entity.setLockedFg(java_lang_String.demarshall(obj.get("lockedFg"), a1));
    }
