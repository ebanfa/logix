...
public class Marshaller_c_c_h_c_s_m_Fixedassettype_1_Impl implements GeneratedMarshaller<Fixedassettype> {
  private Fixedassettype[] EMPTY_ARRAY = new Fixedassettype[0];
  ...
  public Fixedassettype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Fixedassettype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Fixedassettype.class, objId);
    }
    Fixedassettype entity = new Fixedassettype();
    ...
    if ((obj.containsKey("parentTy")) && (!obj.get("parentTy").isNull())) {
      entity.setParentTy(com_cloderia_helion_client_shared_model_Fixedassettype.demarshall(obj.get("parentTy"), a1));
    }
  ...
  private void lazyInit() {
    ...
    if (com_cloderia_helion_client_shared_model_Fixedassettype == null) {
      com_cloderia_helion_client_shared_model_Fixedassettype = this;
    }
  }
}