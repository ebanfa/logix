...
public class Marshaller_c_c_h_c_s_m_Productfeaturetype_1_Impl implements GeneratedMarshaller<Productfeaturetype> {
  private Productfeaturetype[] EMPTY_ARRAY = new Productfeaturetype[0];
  ...
  public Productfeaturetype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Productfeaturetype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Productfeaturetype.class, objId);
    }
    Productfeaturetype entity = new Productfeaturetype();
  ...
  public String marshall(Productfeaturetype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Productfeaturetype\",\"^ObjectID\"");
