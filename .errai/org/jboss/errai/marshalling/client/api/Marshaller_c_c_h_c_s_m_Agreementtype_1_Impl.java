...
public class Marshaller_c_c_h_c_s_m_Agreementtype_1_Impl implements GeneratedMarshaller<Agreementtype> {
  private Agreementtype[] EMPTY_ARRAY = new Agreementtype[0];
  ...
  public Agreementtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Agreementtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Agreementtype.class, objId);
    }
    Agreementtype entity = new Agreementtype();
  ...
  public String marshall(Agreementtype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Agreementtype\",\"^ObjectID\"");
