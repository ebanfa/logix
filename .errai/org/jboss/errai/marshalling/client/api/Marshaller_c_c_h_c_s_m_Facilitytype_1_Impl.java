...
public class Marshaller_c_c_h_c_s_m_Facilitytype_1_Impl implements GeneratedMarshaller<Facilitytype> {
  private Facilitytype[] EMPTY_ARRAY = new Facilitytype[0];
  ...
  public Facilitytype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Facilitytype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Facilitytype.class, objId);
    }
  ...
  public String marshall(Facilitytype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Facilitytype\",\"^ObjectID\"");
