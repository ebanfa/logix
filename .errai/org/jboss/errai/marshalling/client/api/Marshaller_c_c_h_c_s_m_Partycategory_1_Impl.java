...
public class Marshaller_c_c_h_c_s_m_Partycategory_1_Impl implements GeneratedMarshaller<Partycategory> {
  private Partycategory[] EMPTY_ARRAY = new Partycategory[0];
  ...
  public Partycategory[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Partycategory demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Partycategory.class, objId);
    }
    Partycategory entity = new Partycategory();
  ...
  public String marshall(Partycategory a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Partycategory\",\"^ObjectID\"");
