...
public class Marshaller_c_c_h_c_s_m_Standardtimeperiod_1_Impl implements GeneratedMarshaller<Standardtimeperiod> {
  private Standardtimeperiod[] EMPTY_ARRAY = new Standardtimeperiod[0];
  ...
  public Standardtimeperiod[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Standardtimeperiod demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Standardtimeperiod.class, objId);
    }
    Standardtimeperiod entity = new Standardtimeperiod();
  ...
  public String marshall(Standardtimeperiod a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Standardtimeperiod\",\"^ObjectID\"");
