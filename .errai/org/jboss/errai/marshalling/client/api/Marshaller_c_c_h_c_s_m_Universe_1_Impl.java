...
public class Marshaller_c_c_h_c_s_m_Universe_1_Impl implements GeneratedMarshaller<Universe> {
  private Universe[] EMPTY_ARRAY = new Universe[0];
  ...
  public Universe[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Universe demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Universe.class, objId);
    }
    ...
    if ((obj.containsKey("parentUniverse")) && (!obj.get("parentUniverse").isNull())) {
      entity.setParentUniverse(com_cloderia_helion_client_shared_model_Universe.demarshall(obj.get("parentUniverse"), a1));
    }
    ...
    if ((obj.containsKey("businessNo")) && (!obj.get("businessNo").isNull())) {
      entity.setBusinessNo(java_lang_String.demarshall(obj.get("businessNo"), a1));
    }
    ...
    if ((obj.containsKey("universeTyCd")) && (!obj.get("universeTyCd").isNull())) {
      entity.setUniverseTyCd(java_lang_String.demarshall(obj.get("universeTyCd"), a1));
    }
    if ((obj.containsKey("id")) && (!obj.get("id").isNull())) {
      entity.setId(java_lang_Long.demarshall(obj.get("id"), a1));
    }
