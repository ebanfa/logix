...
public class Marshaller_c_c_h_c_s_m_Paymentmethodtype_1_Impl implements GeneratedMarshaller<Paymentmethodtype> {
  private Paymentmethodtype[] EMPTY_ARRAY = new Paymentmethodtype[0];
  ...
  public Paymentmethodtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Paymentmethodtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Paymentmethodtype.class, objId);
    }
    Paymentmethodtype entity = new Paymentmethodtype();
  ...
  public String marshall(Paymentmethodtype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Paymentmethodtype\",\"^ObjectID\"");
