...
public class Marshaller_c_c_h_c_s_m_Organization_1_Impl implements GeneratedMarshaller<Organization> {
  private Organization[] EMPTY_ARRAY = new Organization[0];
  ...
  public Organization[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Organization demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Organization.class, objId);
    }
    ...
    if ((obj.containsKey("tax")) && (!obj.get("tax").isNull())) {
      entity.setTax(java_lang_String.demarshall(obj.get("tax"), a1));
    }
