...
public class Marshaller_c_c_h_c_s_m_Accountingtransactiondetail_1_Impl implements GeneratedMarshaller<Accountingtransactiondetail> {
  private Accountingtransactiondetail[] EMPTY_ARRAY = new Accountingtransactiondetail[0];
  ...
  public Accountingtransactiondetail[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Accountingtransactiondetail demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Accountingtransactiondetail.class, objId);
    }
    Accountingtransactiondetail entity = new Accountingtransactiondetail();
    ...
    if ((obj.containsKey("transaction")) && (!obj.get("transaction").isNull())) {
      entity.setTransaction(com_cloderia_helion_client_shared_model_Accountingtransaction.demarshall(obj.get("transaction"), a1));
    }
    if ((obj.containsKey("associatedDetail")) && (!obj.get("associatedDetail").isNull())) {
      entity.setAssociatedDetail(com_cloderia_helion_client_shared_model_Accountingtransactiondetail.demarshall(obj.get("associatedDetail"), a1));
    }
    ...
    if ((obj.containsKey("debitCreditFg")) && (!obj.get("debitCreditFg").isNull())) {
      entity.setDebitCreditFg(java_lang_Boolean.demarshall(obj.get("debitCreditFg"), a1));
    }
  ...
  private void lazyInit() {
    ...
    if (com_cloderia_helion_client_shared_model_Accountingtransactiondetail == null) {
      com_cloderia_helion_client_shared_model_Accountingtransactiondetail = this;
    }
  }
}