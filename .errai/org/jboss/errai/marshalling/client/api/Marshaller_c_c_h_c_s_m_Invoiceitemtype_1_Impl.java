...
public class Marshaller_c_c_h_c_s_m_Invoiceitemtype_1_Impl implements GeneratedMarshaller<Invoiceitemtype> {
  private Invoiceitemtype[] EMPTY_ARRAY = new Invoiceitemtype[0];
  ...
  public Invoiceitemtype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Invoiceitemtype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Invoiceitemtype.class, objId);
    }
    Invoiceitemtype entity = new Invoiceitemtype();
    ...
    if ((obj.containsKey("parentItemTy")) && (!obj.get("parentItemTy").isNull())) {
      entity.setParentItemTy(com_cloderia_helion_client_shared_model_Invoiceitemtype.demarshall(obj.get("parentItemTy"), a1));
    }
  ...
  private void lazyInit() {
    ...
    if (com_cloderia_helion_client_shared_model_Invoiceitemtype == null) {
      com_cloderia_helion_client_shared_model_Invoiceitemtype = this;
    }
  }
}