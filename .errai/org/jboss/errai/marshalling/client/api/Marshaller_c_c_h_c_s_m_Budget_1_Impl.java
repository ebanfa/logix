...
public class Marshaller_c_c_h_c_s_m_Budget_1_Impl implements GeneratedMarshaller<Budget> {
  private Budget[] EMPTY_ARRAY = new Budget[0];
  ...
  public Budget[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Budget demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Budget.class, objId);
    }
    ...
    if ((obj.containsKey("period")) && (!obj.get("period").isNull())) {
      entity.setPeriod(com_cloderia_helion_client_shared_model_Standardtimeperiod.demarshall(obj.get("period"), a1));
    }
