...
public class Marshaller_c_c_h_c_s_m_Organizationglaccountbalance_1_Impl implements GeneratedMarshaller<Organizationglaccountbalance> {
  private Organizationglaccountbalance[] EMPTY_ARRAY = new Organizationglaccountbalance[0];
  ...
  public Organizationglaccountbalance[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Organizationglaccountbalance demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Organizationglaccountbalance.class, objId);
    }
    Organizationglaccountbalance entity = new Organizationglaccountbalance();
    ...
    if ((obj.containsKey("glAccount")) && (!obj.get("glAccount").isNull())) {
      entity.setGlAccount(com_cloderia_helion_client_shared_model_Organizationgeneralledgeraccount.demarshall(obj.get("glAccount"), a1));
    }
