...
public class Marshaller_c_c_h_c_s_m_Geoboundrytype_1_Impl implements GeneratedMarshaller<Geoboundrytype> {
  private Geoboundrytype[] EMPTY_ARRAY = new Geoboundrytype[0];
  ...
  public Geoboundrytype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Geoboundrytype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Geoboundrytype.class, objId);
    }
    Geoboundrytype entity = new Geoboundrytype();
  ...
  public String marshall(Geoboundrytype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Geoboundrytype\",\"^ObjectID\"");
