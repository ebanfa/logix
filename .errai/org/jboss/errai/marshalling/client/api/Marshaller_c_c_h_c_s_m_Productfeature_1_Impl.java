...
public class Marshaller_c_c_h_c_s_m_Productfeature_1_Impl implements GeneratedMarshaller<Productfeature> {
  private Productfeature[] EMPTY_ARRAY = new Productfeature[0];
  ...
  public Productfeature[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Productfeature demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Productfeature.class, objId);
    }
    ...
    if ((obj.containsKey("prodFeatTy")) && (!obj.get("prodFeatTy").isNull())) {
      entity.setProdFeatTy(com_cloderia_helion_client_shared_model_Productfeaturetype.demarshall(obj.get("prodFeatTy"), a1));
    }
    if ((obj.containsKey("prodFeatCat")) && (!obj.get("prodFeatCat").isNull())) {
      entity.setProdFeatCat(com_cloderia_helion_client_shared_model_Productfeaturecategory.demarshall(obj.get("prodFeatCat"), a1));
    }
