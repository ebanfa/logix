...
public class Marshaller_c_c_h_c_s_m_Partyrelationshiptype_1_Impl implements GeneratedMarshaller<Partyrelationshiptype> {
  private Partyrelationshiptype[] EMPTY_ARRAY = new Partyrelationshiptype[0];
  ...
  public Partyrelationshiptype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Partyrelationshiptype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Partyrelationshiptype.class, objId);
    }
  ...
  public String marshall(Partyrelationshiptype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Partyrelationshiptype\",\"^ObjectID\"");
