...
public class Marshaller_c_c_h_c_s_m_Payment_1_Impl implements GeneratedMarshaller<Payment> {
  private Payment[] EMPTY_ARRAY = new Payment[0];
  ...
  public Payment[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Payment demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Payment.class, objId);
    }
    ...
    if ((obj.containsKey("methodTy")) && (!obj.get("methodTy").isNull())) {
      entity.setMethodTy(com_cloderia_helion_client_shared_model_Paymentmethodtype.demarshall(obj.get("methodTy"), a1));
    }
    if ((obj.containsKey("paymentTy")) && (!obj.get("paymentTy").isNull())) {
      entity.setPaymentTy(com_cloderia_helion_client_shared_model_Paymenttype.demarshall(obj.get("paymentTy"), a1));
    }
