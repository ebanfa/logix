...
public class Marshaller_c_c_h_c_s_m_Budgettype_1_Impl implements GeneratedMarshaller<Budgettype> {
  private Budgettype[] EMPTY_ARRAY = new Budgettype[0];
  ...
  public Budgettype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Budgettype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Budgettype.class, objId);
    }
  ...
  public String marshall(Budgettype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Budgettype\",\"^ObjectID\"");
