...
public class Marshaller_c_c_h_c_s_m_Partyroletype_1_Impl implements GeneratedMarshaller<Partyroletype> {
  private Partyroletype[] EMPTY_ARRAY = new Partyroletype[0];
  ...
  public Partyroletype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Partyroletype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Partyroletype.class, objId);
    }
    ...
    if ((obj.containsKey("parentRoleTy")) && (!obj.get("parentRoleTy").isNull())) {
      entity.setParentRoleTy(com_cloderia_helion_client_shared_model_Partyroletype.demarshall(obj.get("parentRoleTy"), a1));
    }
  ...
  private void lazyInit() {
    ...
    if (com_cloderia_helion_client_shared_model_Partyroletype == null) {
      com_cloderia_helion_client_shared_model_Partyroletype = this;
    }
  }
}