...
public class Marshaller_c_c_h_c_s_m_Producttype_1_Impl implements GeneratedMarshaller<Producttype> {
  private Producttype[] EMPTY_ARRAY = new Producttype[0];
  ...
  public Producttype[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Producttype demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Producttype.class, objId);
    }
  ...
  public String marshall(Producttype a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Producttype\",\"^ObjectID\"");
