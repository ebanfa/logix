...
public class Marshaller_c_c_h_c_s_m_Terminationreason_1_Impl implements GeneratedMarshaller<Terminationreason> {
  private Terminationreason[] EMPTY_ARRAY = new Terminationreason[0];
  ...
  public Terminationreason[] getEmptyArray() {
    return EMPTY_ARRAY;
  }

  public Terminationreason demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(Terminationreason.class, objId);
    }
  ...
  public String marshall(Terminationreason a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"com.cloderia.helion.client.shared.model.Terminationreason\",\"^ObjectID\"");
