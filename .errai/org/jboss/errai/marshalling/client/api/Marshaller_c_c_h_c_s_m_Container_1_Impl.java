...
public class Marshaller_c_c_h_c_s_m_Container_1_Impl implements GeneratedMarshaller<Container> {
  ...
  public Container demarshall(EJValue a0, MarshallingSession a1) {
    ...
    if ((obj.containsKey("containerTy")) && (!obj.get("containerTy").isNull())) {
      entity.setContainerTy(com_cloderia_helion_client_shared_model_Containertype.demarshall(obj.get("containerTy"), a1));
    }
