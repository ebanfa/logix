 ...
 *
 */
@Templated(value = "list-partycategory-page.html#listWidget")
public class PartycategoryListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Partycategory>> binder;
	...
	private ListComponent<Partycategory, PartycategoryListItemDisplay> entityList;

	public void setItems(List<Partycategory> entities){
