 ...
 *
 */
@Templated(value = "list-universe-page.html#universeItem")
public class UniverseListItemDisplay extends UniversePresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow universeItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<UniverseListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<UniverseListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<UniverseListItemDisplay> deleteEntityEvent;
