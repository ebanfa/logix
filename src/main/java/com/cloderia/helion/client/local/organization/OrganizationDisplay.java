 ...
 *
 */
@Templated(value = "view-organization-page.html#entityDisplayComponent")
public class OrganizationDisplay extends OrganizationPresenter implements IsElement {
	...
	@Bound
	@DataField
	private TableCell tax = DOM.createTD().cast();
	...
	@Inject
	@RenderEditView
	private Event<OrganizationDisplay> renderEditViewEvent;
	
	@Inject
	@DeleteEntity
	private Event<OrganizationDisplay> deleteEntityEvent;
	
	@DataField
	private AnchorElement editOrganizationBtn = DOM.createAnchor().cast();
	
	@DataField
	private AnchorElement deleteOrganizationBtn = DOM.createAnchor().cast();
	...
	public void onEditOrganizationBtnClicked(ClickEvent e) {	
		initOps();
		renderEditViewEvent.fire(this);	
	}	
	
	@EventHandler("deleteOrganizationBtn")
	public void onDeleteOrganizationBtnClicked(ClickEvent e) { 
		initOps();
	...
	public void onClickViewAllBtn(ClickEvent e) { listOrganizationsPage.go();	}
