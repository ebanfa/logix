 ...
 *
 */
@Templated(value = "view-agreement-page.html#entityDisplayComponent")
public class AgreementDisplay extends AgreementPresenter implements IsElement {
	...
	@Inject
	@RenderEditView
	private Event<AgreementDisplay> renderEditViewEvent;
	
	@Inject
	@DeleteEntity
	private Event<AgreementDisplay> deleteEntityEvent;
	
	@DataField
	private AnchorElement editAgreementBtn = DOM.createAnchor().cast();
	
	@DataField
	private AnchorElement deleteAgreementBtn = DOM.createAnchor().cast();
	...
	public void onEditAgreementBtnClicked(ClickEvent e) {	
		initOps();
		renderEditViewEvent.fire(this);	
	}	
	
	@EventHandler("deleteAgreementBtn")
	public void onDeleteAgreementBtnClicked(ClickEvent e) { 
		initOps();
	...
	public void onClickViewAllBtn(ClickEvent e) { listAgreementsPage.go();	}
