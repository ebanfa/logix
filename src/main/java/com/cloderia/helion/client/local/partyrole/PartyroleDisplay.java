 ...
 *
 */
@Templated(value = "view-partyrole-page.html#entityDisplayComponent")
public class PartyroleDisplay extends PartyrolePresenter implements IsElement {
	...
	@Inject
	@Named("td")
	@Bound(property="partyRoleTy.name")
	@DataField
	private TableCell partyRoleTy = DOM.createTD().cast();
	@Inject
	@Named("td")
	...
	@Inject
	@RenderEditView
	private Event<PartyroleDisplay> renderEditViewEvent;
	
	@Inject
	@DeleteEntity
	private Event<PartyroleDisplay> deleteEntityEvent;
	
	@DataField
	private AnchorElement editPartyroleBtn = DOM.createAnchor().cast();
	
	@DataField
	private AnchorElement deletePartyroleBtn = DOM.createAnchor().cast();
	...
	public void onEditPartyroleBtnClicked(ClickEvent e) {	
		initOps();
		renderEditViewEvent.fire(this);	
	}	
	
	@EventHandler("deletePartyroleBtn")
	public void onDeletePartyroleBtnClicked(ClickEvent e) { 
		initOps();
	...
	public void onClickViewAllBtn(ClickEvent e) { listPartyrolesPage.go();	}
