 ...
 *
 */
@Templated(value = "list-budget-page.html#budgetItem")
public class BudgetListItemDisplay extends BudgetPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow budgetItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<BudgetListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<BudgetListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<BudgetListItemDisplay> deleteEntityEvent;
