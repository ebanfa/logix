 ...
 *
 */
@Templated(value = "list-producttype-page.html#listWidget")
public class ProducttypeListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Producttype>> binder;
	...
	private ListComponent<Producttype, ProducttypeListItemDisplay> entityList;

	public void setItems(List<Producttype> entities){
