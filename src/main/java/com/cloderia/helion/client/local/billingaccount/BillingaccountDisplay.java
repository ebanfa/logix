 ...
 *
 */
@Templated(value = "view-billingaccount-page.html#entityDisplayComponent")
public class BillingaccountDisplay extends BillingaccountPresenter implements IsElement {
	...
	@Inject
	@Named("td")
	@Bound(property="toContMech.name")
	@DataField
	private TableCell toContMech = DOM.createTD().cast();
	@Inject
	@Named("td")
	...
	@Inject
	@RenderEditView
	private Event<BillingaccountDisplay> renderEditViewEvent;
	
	@Inject
	@DeleteEntity
	private Event<BillingaccountDisplay> deleteEntityEvent;
	
	@DataField
	private AnchorElement editBillingaccountBtn = DOM.createAnchor().cast();
	
	@DataField
	private AnchorElement deleteBillingaccountBtn = DOM.createAnchor().cast();
	...
	public void onEditBillingaccountBtnClicked(ClickEvent e) {	
		initOps();
		renderEditViewEvent.fire(this);	
	}	
	
	@EventHandler("deleteBillingaccountBtn")
	public void onDeleteBillingaccountBtnClicked(ClickEvent e) { 
		initOps();
	...
	public void onClickViewAllBtn(ClickEvent e) { listBillingaccountsPage.go();	}
