 ...
 *
 */
@Templated(value = "list-party-page.html#listWidget")
public class PartyListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Party>> binder;
	...
	private ListComponent<Party, PartyListItemDisplay> entityList;

	public void setItems(List<Party> entities){
