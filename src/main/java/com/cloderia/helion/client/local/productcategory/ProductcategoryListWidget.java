 ...
 *
 */
@Templated(value = "list-productcategory-page.html#listWidget")
public class ProductcategoryListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Productcategory>> binder;
	...
	private ListComponent<Productcategory, ProductcategoryListItemDisplay> entityList;

	public void setItems(List<Productcategory> entities){
