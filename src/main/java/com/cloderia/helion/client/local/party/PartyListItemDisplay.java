 ...
 *
 */
@Templated(value = "list-party-page.html#partyItem")
public class PartyListItemDisplay extends PartyPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow partyItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<PartyListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<PartyListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<PartyListItemDisplay> deleteEntityEvent;
