 ...
 *
 */
@Templated(value = "list-facilitytype-page.html#listWidget")
public class FacilitytypeListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Facilitytype>> binder;
	...
	private ListComponent<Facilitytype, FacilitytypeListItemDisplay> entityList;

	public void setItems(List<Facilitytype> entities){
