 ...
 *
 */
@Templated(value = "list-supplierproduct-page.html#listWidget")
public class SupplierproductListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Supplierproduct>> binder;
	...
	private ListComponent<Supplierproduct, SupplierproductListItemDisplay> entityList;

	public void setItems(List<Supplierproduct> entities){
