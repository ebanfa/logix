 ...
 *
 */
@Templated(value = "list-organizationgeneralledgeraccount-page.html#listWidget")
public class OrganizationgeneralledgeraccountListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Organizationgeneralledgeraccount>> binder;
	...
	private ListComponent<Organizationgeneralledgeraccount, OrganizationgeneralledgeraccountListItemDisplay> entityList;

	public void setItems(List<Organizationgeneralledgeraccount> entities){
