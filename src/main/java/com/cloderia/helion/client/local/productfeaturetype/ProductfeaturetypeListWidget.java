 ...
 *
 */
@Templated(value = "list-productfeaturetype-page.html#listWidget")
public class ProductfeaturetypeListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Productfeaturetype>> binder;
	...
	private ListComponent<Productfeaturetype, ProductfeaturetypeListItemDisplay> entityList;

	public void setItems(List<Productfeaturetype> entities){
