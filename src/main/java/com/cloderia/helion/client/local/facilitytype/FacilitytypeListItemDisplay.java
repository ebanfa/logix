 ...
 *
 */
@Templated(value = "list-facilitytype-page.html#facilitytypeItem")
public class FacilitytypeListItemDisplay extends FacilitytypePresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow facilitytypeItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<FacilitytypeListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<FacilitytypeListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<FacilitytypeListItemDisplay> deleteEntityEvent;
