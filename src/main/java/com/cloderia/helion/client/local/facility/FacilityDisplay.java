 ...
 *
 */
@Templated(value = "view-facility-page.html#entityDisplayComponent")
public class FacilityDisplay extends FacilityPresenter implements IsElement {
	...
	@Inject
	@RenderEditView
	private Event<FacilityDisplay> renderEditViewEvent;
	
	@Inject
	@DeleteEntity
	private Event<FacilityDisplay> deleteEntityEvent;
	
	@DataField
	private AnchorElement editFacilityBtn = DOM.createAnchor().cast();
	
	@DataField
	private AnchorElement deleteFacilityBtn = DOM.createAnchor().cast();
	...
	public void onEditFacilityBtnClicked(ClickEvent e) {	
		initOps();
		renderEditViewEvent.fire(this);	
	}	
	
	@EventHandler("deleteFacilityBtn")
	public void onDeleteFacilityBtnClicked(ClickEvent e) { 
		initOps();
	...
	public void onClickViewAllBtn(ClickEvent e) { listFacilitysPage.go();	}
