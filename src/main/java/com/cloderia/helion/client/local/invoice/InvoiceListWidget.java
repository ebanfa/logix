 ...
 *
 */
@Templated(value = "list-invoice-page.html#listWidget")
public class InvoiceListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Invoice>> binder;
	...
	private ListComponent<Invoice, InvoiceListItemDisplay> entityList;

	public void setItems(List<Invoice> entities){
