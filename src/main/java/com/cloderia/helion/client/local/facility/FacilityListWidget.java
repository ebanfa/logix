 ...
 *
 */
@Templated(value = "list-facility-page.html#listWidget")
public class FacilityListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Facility>> binder;
	...
	private ListComponent<Facility, FacilityListItemDisplay> entityList;

	public void setItems(List<Facility> entities){
