 ...
 *
 */
@Templated(value = "list-invoiceterm-page.html#invoicetermItem")
public class InvoicetermListItemDisplay extends InvoicetermPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow invoicetermItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<InvoicetermListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<InvoicetermListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<InvoicetermListItemDisplay> deleteEntityEvent;
