 ...
 *
 */
@Templated(value = "list-organization-page.html#organizationItem")
public class OrganizationListItemDisplay extends OrganizationPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow organizationItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<OrganizationListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<OrganizationListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<OrganizationListItemDisplay> deleteEntityEvent;
