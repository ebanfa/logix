 ...
 *
 */
@Templated(value = "list-partyrole-page.html#listWidget")
public class PartyroleListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Partyrole>> binder;
	...
	private ListComponent<Partyrole, PartyroleListItemDisplay> entityList;

	public void setItems(List<Partyrole> entities){
