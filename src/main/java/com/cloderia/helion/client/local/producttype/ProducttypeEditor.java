 ...
 *
 */
@Templated(value = "edit-producttype-page.html#producttypeEditor")
public class ProducttypeEditor extends ProducttypePresenter implements IsElement {

	@Inject
	@DataField
	private Div producttypeEditor;
	...
	@DataField
	private Button editProducttypeBtn = new Button();

	@Inject
	@EditEntity
	private Event<ProducttypeEditor> editEntityEvent;

	@Inject
	@CreateEntity
	private Event<ProducttypeEditor> createEntityEvent;
	...
	public void editProducttype(ClickEvent e) {
	Long universeId = Long.valueOf(universe.getSelectedValue());
		...
		ProducttypeOperation producttypeOperation = initOps();
	    producttypeOperation.setUniverseId(universeId);
		if (getEditMode())
