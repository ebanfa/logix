 ...
 *
 */
@Templated(value = "list-invoiceterm-page.html#listWidget")
public class InvoicetermListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Invoiceterm>> binder;
	...
	private ListComponent<Invoiceterm, InvoicetermListItemDisplay> entityList;

	public void setItems(List<Invoiceterm> entities){
