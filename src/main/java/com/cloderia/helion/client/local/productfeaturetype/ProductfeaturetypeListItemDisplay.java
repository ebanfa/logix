 ...
 *
 */
@Templated(value = "list-productfeaturetype-page.html#productfeaturetypeItem")
public class ProductfeaturetypeListItemDisplay extends ProductfeaturetypePresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow productfeaturetypeItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<ProductfeaturetypeListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<ProductfeaturetypeListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<ProductfeaturetypeListItemDisplay> deleteEntityEvent;
