 ...
 *
 */
@Templated(value = "list-producttype-page.html#producttypeItem")
public class ProducttypeListItemDisplay extends ProducttypePresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow producttypeItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<ProducttypeListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<ProducttypeListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<ProducttypeListItemDisplay> deleteEntityEvent;
