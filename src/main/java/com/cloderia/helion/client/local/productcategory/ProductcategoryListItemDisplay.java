 ...
 *
 */
@Templated(value = "list-productcategory-page.html#productcategoryItem")
public class ProductcategoryListItemDisplay extends ProductcategoryPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow productcategoryItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<ProductcategoryListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<ProductcategoryListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<ProductcategoryListItemDisplay> deleteEntityEvent;
