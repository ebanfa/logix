 ...
 *
 */
@Templated(value = "list-systemuser-page.html#listWidget")
public class SystemuserListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Systemuser>> binder;
	...
	private ListComponent<Systemuser, SystemuserListItemDisplay> entityList;

	public void setItems(List<Systemuser> entities){
