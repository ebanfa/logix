 ...
 *
 */
@Templated(value = "list-person-page.html#personItem")
public class PersonListItemDisplay extends PersonPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow personItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<PersonListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<PersonListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<PersonListItemDisplay> deleteEntityEvent;
