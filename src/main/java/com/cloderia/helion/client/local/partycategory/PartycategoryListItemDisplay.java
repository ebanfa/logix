 ...
 *
 */
@Templated(value = "list-partycategory-page.html#partycategoryItem")
public class PartycategoryListItemDisplay extends PartycategoryPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow partycategoryItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<PartycategoryListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<PartycategoryListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<PartycategoryListItemDisplay> deleteEntityEvent;
