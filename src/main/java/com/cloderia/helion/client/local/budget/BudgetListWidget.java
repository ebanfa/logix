 ...
 *
 */
@Templated(value = "list-budget-page.html#listWidget")
public class BudgetListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Budget>> binder;
	...
	private ListComponent<Budget, BudgetListItemDisplay> entityList;

	public void setItems(List<Budget> entities){
