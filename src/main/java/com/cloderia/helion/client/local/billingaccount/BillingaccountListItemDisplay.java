 ...
 *
 */
@Templated(value = "list-billingaccount-page.html#billingaccountItem")
public class BillingaccountListItemDisplay extends BillingaccountPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow billingaccountItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<BillingaccountListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<BillingaccountListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<BillingaccountListItemDisplay> deleteEntityEvent;
