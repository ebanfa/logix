 ...
 *
 */
@Templated(value = "list-systemuser-page.html#systemuserItem")
public class SystemuserListItemDisplay extends SystemuserPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow systemuserItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<SystemuserListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<SystemuserListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<SystemuserListItemDisplay> deleteEntityEvent;
