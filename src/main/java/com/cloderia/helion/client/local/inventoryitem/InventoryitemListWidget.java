 ...
 *
 */
@Templated(value = "list-inventoryitem-page.html#listWidget")
public class InventoryitemListWidget extends Composite {
	...
	private ListComponent<Inventoryitem, InventoryitemListItemDisplay> entityList;

	public void setItems(List<Inventoryitem> entities){
