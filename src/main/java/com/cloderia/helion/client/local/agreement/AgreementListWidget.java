 ...
 *
 */
@Templated(value = "list-agreement-page.html#listWidget")
public class AgreementListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Agreement>> binder;
	...
	private ListComponent<Agreement, AgreementListItemDisplay> entityList;

	public void setItems(List<Agreement> entities){
