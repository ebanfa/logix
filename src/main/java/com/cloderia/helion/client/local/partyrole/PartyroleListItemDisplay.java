 ...
 *
 */
@Templated(value = "list-partyrole-page.html#partyroleItem")
public class PartyroleListItemDisplay extends PartyrolePresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow partyroleItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<PartyroleListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<PartyroleListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<PartyroleListItemDisplay> deleteEntityEvent;
