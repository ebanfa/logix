 ...
 *
 */
@Templated(value = "list-invoiceitem-page.html#listWidget")
public class InvoiceitemListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Invoiceitem>> binder;
	...
	private ListComponent<Invoiceitem, InvoiceitemListItemDisplay> entityList;

	public void setItems(List<Invoiceitem> entities){
