 ...
 *
 */
@Templated(value = "view-partycategory-page.html#entityDisplayComponent")
public class PartycategoryDisplay extends PartycategoryPresenter implements IsElement {
	...
	@Inject
	@RenderEditView
	private Event<PartycategoryDisplay> renderEditViewEvent;
	
	@Inject
	@DeleteEntity
	private Event<PartycategoryDisplay> deleteEntityEvent;
	
	@DataField
	private AnchorElement editPartycategoryBtn = DOM.createAnchor().cast();
	
	@DataField
	private AnchorElement deletePartycategoryBtn = DOM.createAnchor().cast();
	...
	public void onEditPartycategoryBtnClicked(ClickEvent e) {	
		initOps();
		renderEditViewEvent.fire(this);	
	}	
	
	@EventHandler("deletePartycategoryBtn")
	public void onDeletePartycategoryBtnClicked(ClickEvent e) { 
		initOps();
	...
	public void onClickViewAllBtn(ClickEvent e) { listPartycategorysPage.go();	}
