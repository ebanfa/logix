 ...
 *
 */
@Templated(value = "list-payment-page.html#listWidget")
public class PaymentListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Payment>> binder;
	...
	private ListComponent<Payment, PaymentListItemDisplay> entityList;

	public void setItems(List<Payment> entities){
