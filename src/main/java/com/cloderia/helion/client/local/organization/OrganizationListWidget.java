 ...
 *
 */
@Templated(value = "list-organization-page.html#listWidget")
public class OrganizationListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Organization>> binder;
	...
	private ListComponent<Organization, OrganizationListItemDisplay> entityList;

	public void setItems(List<Organization> entities){
