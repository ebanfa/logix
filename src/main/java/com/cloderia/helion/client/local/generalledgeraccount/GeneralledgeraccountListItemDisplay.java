 ...
 *
 */
@Templated(value = "list-generalledgeraccount-page.html#generalledgeraccountItem")
public class GeneralledgeraccountListItemDisplay extends GeneralledgeraccountPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow generalledgeraccountItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<GeneralledgeraccountListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<GeneralledgeraccountListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<GeneralledgeraccountListItemDisplay> deleteEntityEvent;
	...
	public HTMLElement getElement() {
		return generalledgeraccountItem;
	}
