 ...
 *
 */
@Templated(value = "list-partyroletype-page.html#partyroletypeItem")
public class PartyroletypeListItemDisplay extends PartyroletypePresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow partyroletypeItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<PartyroletypeListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<PartyroletypeListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<PartyroletypeListItemDisplay> deleteEntityEvent;
