 ...
 *
 */
@Templated(value = "list-facility-page.html#facilityItem")
public class FacilityListItemDisplay extends FacilityPresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow facilityItem = DOM.createTR().cast();
	
	@Inject
	@Named("td")
	@Bound(property="facilityTy.name")
	@DataField
	private TableCell facilityTy = DOM.createTD().cast();
	...
	@Inject
	@RenderSingleView
	private Event<FacilityListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<FacilityListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<FacilityListItemDisplay> deleteEntityEvent;
