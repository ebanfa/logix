 ...
 *
 */
@Templated(value = "list-partytype-page.html#listWidget")
public class PartytypeListWidget extends Composite {
	...
	@Inject
	@AutoBound
	private DataBinder<List<Partytype>> binder;
	...
	private ListComponent<Partytype, PartytypeListItemDisplay> entityList;

	public void setItems(List<Partytype> entities){
