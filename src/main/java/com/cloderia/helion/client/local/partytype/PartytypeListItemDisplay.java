 ...
 *
 */
@Templated(value = "list-partytype-page.html#partytypeItem")
public class PartytypeListItemDisplay extends PartytypePresenter implements IsElement {
	...
	@Inject
	@DataField
	private TableRow partytypeItem = DOM.createTR().cast();
	...
	@Inject
	@RenderSingleView
	private Event<PartytypeListItemDisplay> renderSingleViewEvent;

	@Inject
	@RenderEditView
	private Event<PartytypeListItemDisplay> renderEditViewEvent;

	@Inject
	@DeleteEntity
	private Event<PartytypeListItemDisplay> deleteEntityEvent;
