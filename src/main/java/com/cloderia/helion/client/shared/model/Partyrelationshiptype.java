...
@Entity
@NamedQueries({
  @NamedQuery(name = Partyrelationshiptype.ALL_PARTYRELATIONSHIPTYPE_QUERY, query = "SELECT e FROM Partyrelationshiptype e ORDER BY e.id"),
  @NamedQuery(name = Partyrelationshiptype.FIND_PARTYRELATIONSHIPTYPE_BY_CODE_QUERY, query = "SELECT e FROM Partyrelationshiptype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Partyrelationshiptype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_PARTYRELATIONSHIPTYPE_QUERY = "allPartyrelationshiptypes";
	public static final String FIND_PARTYRELATIONSHIPTYPE_BY_CODE_QUERY = "findPartyrelationshiptypesByCode";
