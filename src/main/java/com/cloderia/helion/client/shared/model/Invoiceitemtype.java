...
/**
 * Invoiceitemtype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Invoiceitemtype.ALL_INVOICEITEMTYPE_QUERY, query = "SELECT e FROM Invoiceitemtype e ORDER BY e.id"),
  @NamedQuery(name = Invoiceitemtype.FIND_INVOICEITEMTYPE_BY_CODE_QUERY, query = "SELECT e FROM Invoiceitemtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="invoice_item_type")
public class Invoiceitemtype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_INVOICEITEMTYPE_QUERY = "allInvoiceitemtypes";
	public static final String FIND_INVOICEITEMTYPE_BY_CODE_QUERY = "findInvoiceitemtypesByCode";
	
    private Long id;

    private Universe universe;
    private Invoiceitemtype parentItemTy;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="parent_item_ty", nullable=true)
    public Invoiceitemtype getParentItemTy() {
        return this.parentItemTy;
    }
    
    public void setParentItemTy(Invoiceitemtype parentItemTy) {
        this.parentItemTy = parentItemTy;
    }
