...
/**
 * Contactmechanismpurposetype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Contactmechanismpurposetype.ALL_CONTACTMECHANISMPURPOSETYPE_QUERY, query = "SELECT e FROM Contactmechanismpurposetype e ORDER BY e.id"),
  @NamedQuery(name = Contactmechanismpurposetype.FIND_CONTACTMECHANISMPURPOSETYPE_BY_CODE_QUERY, query = "SELECT e FROM Contactmechanismpurposetype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Contactmechanismpurposetype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_CONTACTMECHANISMPURPOSETYPE_QUERY = "allContactmechanismpurposetypes";
	public static final String FIND_CONTACTMECHANISMPURPOSETYPE_BY_CODE_QUERY = "findContactmechanismpurposetypesByCode";
