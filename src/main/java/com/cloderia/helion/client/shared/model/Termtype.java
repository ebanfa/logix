...
@Entity
@NamedQueries({
  @NamedQuery(name = Termtype.ALL_TERMTYPE_QUERY, query = "SELECT e FROM Termtype e ORDER BY e.id"),
  @NamedQuery(name = Termtype.FIND_TERMTYPE_BY_CODE_QUERY, query = "SELECT e FROM Termtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="term_type")
public class Termtype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_TERMTYPE_QUERY = "allTermtypes";
	public static final String FIND_TERMTYPE_BY_CODE_QUERY = "findTermtypesByCode";
