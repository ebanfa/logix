...
@Entity
@NamedQueries({
  @NamedQuery(name = Facility.ALL_FACILITY_QUERY, query = "SELECT e FROM Facility e ORDER BY e.id"),
  @NamedQuery(name = Facility.FIND_FACILITY_BY_CODE_QUERY, query = "SELECT e FROM Facility e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="facility")
public class Facility extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_FACILITY_QUERY = "allFacilitys";
	public static final String FIND_FACILITY_BY_CODE_QUERY = "findFacilitysByCode";
	
    private Long id;

    private Universe universe;
    private Facilitytype facilityTy;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="facility_ty", nullable=false)
    public Facilitytype getFacilityTy() {
        return this.facilityTy;
    }
    
    public void setFacilityTy(Facilitytype facilityTy) {
        this.facilityTy = facilityTy;
    }
