...
@Entity
@NamedQueries({
  @NamedQuery(name = Agreementterm.ALL_AGREEMENTTERM_QUERY, query = "SELECT e FROM Agreementterm e ORDER BY e.id"),
  @NamedQuery(name = Agreementterm.FIND_AGREEMENTTERM_BY_CODE_QUERY, query = "SELECT e FROM Agreementterm e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="agreement_term")
public class Agreementterm extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_AGREEMENTTERM_QUERY = "allAgreementterms";
	public static final String FIND_AGREEMENTTERM_BY_CODE_QUERY = "findAgreementtermsByCode";
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="agreement_item", nullable=false)
