...
/**
 * Accountingtransactiontype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Accountingtransactiontype.ALL_ACCOUNTINGTRANSACTIONTYPE_QUERY, query = "SELECT e FROM Accountingtransactiontype e ORDER BY e.id"),
  @NamedQuery(name = Accountingtransactiontype.FIND_ACCOUNTINGTRANSACTIONTYPE_BY_CODE_QUERY, query = "SELECT e FROM Accountingtransactiontype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Accountingtransactiontype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_ACCOUNTINGTRANSACTIONTYPE_QUERY = "allAccountingtransactiontypes";
	public static final String FIND_ACCOUNTINGTRANSACTIONTYPE_BY_CODE_QUERY = "findAccountingtransactiontypesByCode";
	
    private Long id;

    private Universe universe;
    private Accountingtransactiontype parentTy;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="parent_ty", nullable=true)
    public Accountingtransactiontype getParentTy() {
        return this.parentTy;
    }
