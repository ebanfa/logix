...
/**
 * Financialaccountroletype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Financialaccountroletype.ALL_FINANCIALACCOUNTROLETYPE_QUERY, query = "SELECT e FROM Financialaccountroletype e ORDER BY e.id"),
  @NamedQuery(name = Financialaccountroletype.FIND_FINANCIALACCOUNTROLETYPE_BY_CODE_QUERY, query = "SELECT e FROM Financialaccountroletype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Financialaccountroletype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_FINANCIALACCOUNTROLETYPE_QUERY = "allFinancialaccountroletypes";
	public static final String FIND_FINANCIALACCOUNTROLETYPE_BY_CODE_QUERY = "findFinancialaccountroletypesByCode";
