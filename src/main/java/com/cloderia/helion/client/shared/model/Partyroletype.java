...
/**
 * Partyroletype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Partyroletype.ALL_PARTYROLETYPE_QUERY, query = "SELECT e FROM Partyroletype e ORDER BY e.id"),
  @NamedQuery(name = Partyroletype.FIND_PARTYROLETYPE_BY_CODE_QUERY, query = "SELECT e FROM Partyroletype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="party_role_type")
public class Partyroletype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_PARTYROLETYPE_QUERY = "allPartyroletypes";
	public static final String FIND_PARTYROLETYPE_BY_CODE_QUERY = "findPartyroletypesByCode";
	
    private Long id;

    private Universe universe;
    private Partyroletype parentRoleTy;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="parent_role_ty", nullable=false)
    public Partyroletype getParentRoleTy() {
        return this.parentRoleTy;
    }
    
    public void setParentRoleTy(Partyroletype parentRoleTy) {
        this.parentRoleTy = parentRoleTy;
    }
