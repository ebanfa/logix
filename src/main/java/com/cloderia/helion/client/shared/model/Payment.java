...
@Entity
@NamedQueries({
  @NamedQuery(name = Payment.ALL_PAYMENT_QUERY, query = "SELECT e FROM Payment e ORDER BY e.id"),
  @NamedQuery(name = Payment.FIND_PAYMENT_BY_CODE_QUERY, query = "SELECT e FROM Payment e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="payment")
public class Payment extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_PAYMENT_QUERY = "allPayments";
	public static final String FIND_PAYMENT_BY_CODE_QUERY = "findPaymentsByCode";
	
    private Long id;

    private Universe universe;
    private Paymentmethodtype methodTy;
    private Paymenttype paymentTy;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="method_ty", nullable=false)
    public Paymentmethodtype getMethodTy() {
        return this.methodTy;
    }
    
    public void setMethodTy(Paymentmethodtype methodTy) {
        this.methodTy = methodTy;
    }
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="payment_ty", nullable=false)
    public Paymenttype getPaymentTy() {
        return this.paymentTy;
    }
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="fin_acct", nullable=true)
