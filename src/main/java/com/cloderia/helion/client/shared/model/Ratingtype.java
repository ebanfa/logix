...
@Entity
@NamedQueries({
  @NamedQuery(name = Ratingtype.ALL_RATINGTYPE_QUERY, query = "SELECT e FROM Ratingtype e ORDER BY e.id"),
  @NamedQuery(name = Ratingtype.FIND_RATINGTYPE_BY_CODE_QUERY, query = "SELECT e FROM Ratingtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="rating_type")
public class Ratingtype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_RATINGTYPE_QUERY = "allRatingtypes";
	public static final String FIND_RATINGTYPE_BY_CODE_QUERY = "findRatingtypesByCode";
