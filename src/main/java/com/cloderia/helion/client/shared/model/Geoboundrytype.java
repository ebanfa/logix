...
/**
 * Geoboundrytype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Geoboundrytype.ALL_GEOBOUNDRYTYPE_QUERY, query = "SELECT e FROM Geoboundrytype e ORDER BY e.id"),
  @NamedQuery(name = Geoboundrytype.FIND_GEOBOUNDRYTYPE_BY_CODE_QUERY, query = "SELECT e FROM Geoboundrytype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="geo_boundry_type")
public class Geoboundrytype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_GEOBOUNDRYTYPE_QUERY = "allGeoboundrytypes";
	public static final String FIND_GEOBOUNDRYTYPE_BY_CODE_QUERY = "findGeoboundrytypesByCode";
