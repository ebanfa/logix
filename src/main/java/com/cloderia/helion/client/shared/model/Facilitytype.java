...
@Entity
@NamedQueries({
  @NamedQuery(name = Facilitytype.ALL_FACILITYTYPE_QUERY, query = "SELECT e FROM Facilitytype e ORDER BY e.id"),
  @NamedQuery(name = Facilitytype.FIND_FACILITYTYPE_BY_CODE_QUERY, query = "SELECT e FROM Facilitytype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="facility_type")
public class Facilitytype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_FACILITYTYPE_QUERY = "allFacilitytypes";
	public static final String FIND_FACILITYTYPE_BY_CODE_QUERY = "findFacilitytypesByCode";
