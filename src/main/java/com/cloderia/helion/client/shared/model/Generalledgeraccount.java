...
/**
 * Generalledgeraccount generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Generalledgeraccount.ALL_GENERALLEDGERACCOUNT_QUERY, query = "SELECT e FROM Generalledgeraccount e ORDER BY e.id"),
  @NamedQuery(name = Generalledgeraccount.FIND_GENERALLEDGERACCOUNT_BY_CODE_QUERY, query = "SELECT e FROM Generalledgeraccount e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Generalledgeraccount extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_GENERALLEDGERACCOUNT_QUERY = "allGeneralledgeraccounts";
	public static final String FIND_GENERALLEDGERACCOUNT_BY_CODE_QUERY = "findGeneralledgeraccountsByCode";
	
    private Long id;

    private Universe universe;
    private Generalledgeraccounttype glAcctTy;
