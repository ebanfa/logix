...
@Entity
@NamedQueries({
  @NamedQuery(name = Terminationreason.ALL_TERMINATIONREASON_QUERY, query = "SELECT e FROM Terminationreason e ORDER BY e.id"),
  @NamedQuery(name = Terminationreason.FIND_TERMINATIONREASON_BY_CODE_QUERY, query = "SELECT e FROM Terminationreason e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="termination_reason")
public class Terminationreason extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_TERMINATIONREASON_QUERY = "allTerminationreasons";
	public static final String FIND_TERMINATIONREASON_BY_CODE_QUERY = "findTerminationreasonsByCode";
