...
/**
 * Inventoryitemstatus generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Inventoryitemstatus.ALL_INVENTORYITEMSTATUS_QUERY, query = "SELECT e FROM Inventoryitemstatus e ORDER BY e.id"),
  @NamedQuery(name = Inventoryitemstatus.FIND_INVENTORYITEMSTATUS_BY_CODE_QUERY, query = "SELECT e FROM Inventoryitemstatus e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Inventoryitemstatus extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_INVENTORYITEMSTATUS_QUERY = "allInventoryitemstatuss";
	public static final String FIND_INVENTORYITEMSTATUS_BY_CODE_QUERY = "findInventoryitemstatussByCode";
