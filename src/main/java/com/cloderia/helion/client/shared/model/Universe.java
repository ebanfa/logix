...
/**
 * Universe generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Universe.ALL_UNIVERSE_QUERY, query = "SELECT e FROM Universe e ORDER BY e.id"),
  @NamedQuery(name = Universe.FIND_UNIVERSE_BY_CODE_QUERY, query = "SELECT e FROM Universe e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="universe")
public class Universe extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_UNIVERSE_QUERY = "allUniverses";
	public static final String FIND_UNIVERSE_BY_CODE_QUERY = "findUniversesByCode";
    ...
    @JoinColumn(name="parent_universe", nullable=true)
    ...
    @Column(name="entity_code", nullable=false, length=75)
    ...
    @Column(name="universe_ty_cd", nullable=true, length=35)
