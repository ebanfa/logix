...
/**
 * Paymentmethodtype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Paymentmethodtype.ALL_PAYMENTMETHODTYPE_QUERY, query = "SELECT e FROM Paymentmethodtype e ORDER BY e.id"),
  @NamedQuery(name = Paymentmethodtype.FIND_PAYMENTMETHODTYPE_BY_CODE_QUERY, query = "SELECT e FROM Paymentmethodtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="payment_method_type")
public class Paymentmethodtype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_PAYMENTMETHODTYPE_QUERY = "allPaymentmethodtypes";
	public static final String FIND_PAYMENTMETHODTYPE_BY_CODE_QUERY = "findPaymentmethodtypesByCode";
