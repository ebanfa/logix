...
@Entity
@NamedQueries({
  @NamedQuery(name = Lot.ALL_LOT_QUERY, query = "SELECT e FROM Lot e ORDER BY e.id"),
  @NamedQuery(name = Lot.FIND_LOT_BY_CODE_QUERY, query = "SELECT e FROM Lot e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="lot")
public class Lot extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_LOT_QUERY = "allLots";
	public static final String FIND_LOT_BY_CODE_QUERY = "findLotsByCode";
