...
@Entity
@NamedQueries({
  @NamedQuery(name = Productfeature.ALL_PRODUCTFEATURE_QUERY, query = "SELECT e FROM Productfeature e ORDER BY e.id"),
  @NamedQuery(name = Productfeature.FIND_PRODUCTFEATURE_BY_CODE_QUERY, query = "SELECT e FROM Productfeature e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="product_feature")
public class Productfeature extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_PRODUCTFEATURE_QUERY = "allProductfeatures";
	public static final String FIND_PRODUCTFEATURE_BY_CODE_QUERY = "findProductfeaturesByCode";
	
    private Long id;

    private Universe universe;
    private Productfeaturetype prodFeatTy;
    private Productfeaturecategory prodFeatCat;
    private Uom uom;
