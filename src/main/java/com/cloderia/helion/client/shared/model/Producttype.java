...
@Entity
@NamedQueries({
  @NamedQuery(name = Producttype.ALL_PRODUCTTYPE_QUERY, query = "SELECT e FROM Producttype e ORDER BY e.id"),
  @NamedQuery(name = Producttype.FIND_PRODUCTTYPE_BY_CODE_QUERY, query = "SELECT e FROM Producttype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="product_type")
public class Producttype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_PRODUCTTYPE_QUERY = "allProducttypes";
	public static final String FIND_PRODUCTTYPE_BY_CODE_QUERY = "findProducttypesByCode";
