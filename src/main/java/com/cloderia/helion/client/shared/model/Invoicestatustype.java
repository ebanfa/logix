...
/**
 * Invoicestatustype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Invoicestatustype.ALL_INVOICESTATUSTYPE_QUERY, query = "SELECT e FROM Invoicestatustype e ORDER BY e.id"),
  @NamedQuery(name = Invoicestatustype.FIND_INVOICESTATUSTYPE_BY_CODE_QUERY, query = "SELECT e FROM Invoicestatustype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="invoice_status_type")
public class Invoicestatustype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_INVOICESTATUSTYPE_QUERY = "allInvoicestatustypes";
	public static final String FIND_INVOICESTATUSTYPE_BY_CODE_QUERY = "findInvoicestatustypesByCode";
