...
/**
 * Depreciationmethod generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Depreciationmethod.ALL_DEPRECIATIONMETHOD_QUERY, query = "SELECT e FROM Depreciationmethod e ORDER BY e.id"),
  @NamedQuery(name = Depreciationmethod.FIND_DEPRECIATIONMETHOD_BY_CODE_QUERY, query = "SELECT e FROM Depreciationmethod e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Depreciationmethod extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_DEPRECIATIONMETHOD_QUERY = "allDepreciationmethods";
	public static final String FIND_DEPRECIATIONMETHOD_BY_CODE_QUERY = "findDepreciationmethodsByCode";
    ...
    @Column(name="formula", nullable=true, length=35)
