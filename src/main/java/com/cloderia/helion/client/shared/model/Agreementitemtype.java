...
@Entity
@NamedQueries({
  @NamedQuery(name = Agreementitemtype.ALL_AGREEMENTITEMTYPE_QUERY, query = "SELECT e FROM Agreementitemtype e ORDER BY e.id"),
  @NamedQuery(name = Agreementitemtype.FIND_AGREEMENTITEMTYPE_BY_CODE_QUERY, query = "SELECT e FROM Agreementitemtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="agreement_item_type")
public class Agreementitemtype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_AGREEMENTITEMTYPE_QUERY = "allAgreementitemtypes";
	public static final String FIND_AGREEMENTITEMTYPE_BY_CODE_QUERY = "findAgreementitemtypesByCode";
