...
/**
 * Contactmechanism generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Contactmechanism.ALL_CONTACTMECHANISM_QUERY, query = "SELECT e FROM Contactmechanism e ORDER BY e.id"),
  @NamedQuery(name = Contactmechanism.FIND_CONTACTMECHANISM_BY_CODE_QUERY, query = "SELECT e FROM Contactmechanism e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="contact_mechanism")
public class Contactmechanism extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_CONTACTMECHANISM_QUERY = "allContactmechanisms";
	public static final String FIND_CONTACTMECHANISM_BY_CODE_QUERY = "findContactmechanismsByCode";
	
    private Long id;

    private Universe universe;
    private Contactmechanismtype contMechTy;
