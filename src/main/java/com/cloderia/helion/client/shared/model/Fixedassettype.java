...
/**
 * Fixedassettype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Fixedassettype.ALL_FIXEDASSETTYPE_QUERY, query = "SELECT e FROM Fixedassettype e ORDER BY e.id"),
  @NamedQuery(name = Fixedassettype.FIND_FIXEDASSETTYPE_BY_CODE_QUERY, query = "SELECT e FROM Fixedassettype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="fixed_asset_type")
public class Fixedassettype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_FIXEDASSETTYPE_QUERY = "allFixedassettypes";
	public static final String FIND_FIXEDASSETTYPE_BY_CODE_QUERY = "findFixedassettypesByCode";
	
    private Long id;

    private Universe universe;
    private Fixedassettype parentTy;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="parent_ty", nullable=false)
