...
@Entity
@NamedQueries({
  @NamedQuery(name = Invoicestatus.ALL_INVOICESTATUS_QUERY, query = "SELECT e FROM Invoicestatus e ORDER BY e.id"),
  @NamedQuery(name = Invoicestatus.FIND_INVOICESTATUS_BY_CODE_QUERY, query = "SELECT e FROM Invoicestatus e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="invoice_status")
public class Invoicestatus extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_INVOICESTATUS_QUERY = "allInvoicestatuss";
	public static final String FIND_INVOICESTATUS_BY_CODE_QUERY = "findInvoicestatussByCode";
	
    private Long id;

    private Universe universe;
    private Invoice invoice;
    private Invoicestatustype invoiceStatTy;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="invoice_stat_ty", nullable=false)
    public Invoicestatustype getInvoiceStatTy() {
        return this.invoiceStatTy;
    }
    
    public void setInvoiceStatTy(Invoicestatustype invoiceStatTy) {
        this.invoiceStatTy = invoiceStatTy;
    }
