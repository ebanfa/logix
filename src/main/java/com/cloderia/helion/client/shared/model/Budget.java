...
@Entity
@NamedQueries({
  @NamedQuery(name = Budget.ALL_BUDGET_QUERY, query = "SELECT e FROM Budget e ORDER BY e.id"),
  @NamedQuery(name = Budget.FIND_BUDGET_BY_CODE_QUERY, query = "SELECT e FROM Budget e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="budget")
public class Budget extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_BUDGET_QUERY = "allBudgets";
	public static final String FIND_BUDGET_BY_CODE_QUERY = "findBudgetsByCode";
	
    private Long id;

    private Universe universe;
    private Standardtimeperiod period;
