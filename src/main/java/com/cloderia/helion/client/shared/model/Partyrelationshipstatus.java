...
/**
 * Partyrelationshipstatus generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Partyrelationshipstatus.ALL_PARTYRELATIONSHIPSTATUS_QUERY, query = "SELECT e FROM Partyrelationshipstatus e ORDER BY e.id"),
  @NamedQuery(name = Partyrelationshipstatus.FIND_PARTYRELATIONSHIPSTATUS_BY_CODE_QUERY, query = "SELECT e FROM Partyrelationshipstatus e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Partyrelationshipstatus extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_PARTYRELATIONSHIPSTATUS_QUERY = "allPartyrelationshipstatuss";
	public static final String FIND_PARTYRELATIONSHIPSTATUS_BY_CODE_QUERY = "findPartyrelationshipstatussByCode";
