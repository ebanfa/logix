...
@Entity
@NamedQueries({
  @NamedQuery(name = Container.ALL_CONTAINER_QUERY, query = "SELECT e FROM Container e ORDER BY e.id"),
  @NamedQuery(name = Container.FIND_CONTAINER_BY_CODE_QUERY, query = "SELECT e FROM Container e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="container")
public class Container extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_CONTAINER_QUERY = "allContainers";
	public static final String FIND_CONTAINER_BY_CODE_QUERY = "findContainersByCode";
	
    private Long id;

    private Universe universe;
    private Facility facility;
    private Containertype containerTy;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="container_ty", nullable=false)
    public Containertype getContainerTy() {
        return this.containerTy;
    }
    
    public void setContainerTy(Containertype containerTy) {
        this.containerTy = containerTy;
    }
