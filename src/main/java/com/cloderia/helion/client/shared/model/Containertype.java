...
@Entity
@NamedQueries({
  @NamedQuery(name = Containertype.ALL_CONTAINERTYPE_QUERY, query = "SELECT e FROM Containertype e ORDER BY e.id"),
  @NamedQuery(name = Containertype.FIND_CONTAINERTYPE_BY_CODE_QUERY, query = "SELECT e FROM Containertype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="container_type")
public class Containertype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_CONTAINERTYPE_QUERY = "allContainertypes";
	public static final String FIND_CONTAINERTYPE_BY_CODE_QUERY = "findContainertypesByCode";
