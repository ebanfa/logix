...
@Entity
@NamedQueries({
  @NamedQuery(name = Financialaccounttype.ALL_FINANCIALACCOUNTTYPE_QUERY, query = "SELECT e FROM Financialaccounttype e ORDER BY e.id"),
  @NamedQuery(name = Financialaccounttype.FIND_FINANCIALACCOUNTTYPE_BY_CODE_QUERY, query = "SELECT e FROM Financialaccounttype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Financialaccounttype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_FINANCIALACCOUNTTYPE_QUERY = "allFinancialaccounttypes";
	public static final String FIND_FINANCIALACCOUNTTYPE_BY_CODE_QUERY = "findFinancialaccounttypesByCode";
