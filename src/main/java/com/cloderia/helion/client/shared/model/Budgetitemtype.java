...
/**
 * Budgetitemtype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Budgetitemtype.ALL_BUDGETITEMTYPE_QUERY, query = "SELECT e FROM Budgetitemtype e ORDER BY e.id"),
  @NamedQuery(name = Budgetitemtype.FIND_BUDGETITEMTYPE_BY_CODE_QUERY, query = "SELECT e FROM Budgetitemtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="budget_item_type")
public class Budgetitemtype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_BUDGETITEMTYPE_QUERY = "allBudgetitemtypes";
	public static final String FIND_BUDGETITEMTYPE_BY_CODE_QUERY = "findBudgetitemtypesByCode";
