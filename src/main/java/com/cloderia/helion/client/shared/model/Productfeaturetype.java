...
/**
 * Productfeaturetype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Productfeaturetype.ALL_PRODUCTFEATURETYPE_QUERY, query = "SELECT e FROM Productfeaturetype e ORDER BY e.id"),
  @NamedQuery(name = Productfeaturetype.FIND_PRODUCTFEATURETYPE_BY_CODE_QUERY, query = "SELECT e FROM Productfeaturetype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Productfeaturetype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_PRODUCTFEATURETYPE_QUERY = "allProductfeaturetypes";
	public static final String FIND_PRODUCTFEATURETYPE_BY_CODE_QUERY = "findProductfeaturetypesByCode";
