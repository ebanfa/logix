...
/**
 * Generalledgeraccounttype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Generalledgeraccounttype.ALL_GENERALLEDGERACCOUNTTYPE_QUERY, query = "SELECT e FROM Generalledgeraccounttype e ORDER BY e.id"),
  @NamedQuery(name = Generalledgeraccounttype.FIND_GENERALLEDGERACCOUNTTYPE_BY_CODE_QUERY, query = "SELECT e FROM Generalledgeraccounttype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Generalledgeraccounttype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_GENERALLEDGERACCOUNTTYPE_QUERY = "allGeneralledgeraccounttypes";
	public static final String FIND_GENERALLEDGERACCOUNTTYPE_BY_CODE_QUERY = "findGeneralledgeraccounttypesByCode";
