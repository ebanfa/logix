...
@Entity
@NamedQueries({
  @NamedQuery(name = Budgettype.ALL_BUDGETTYPE_QUERY, query = "SELECT e FROM Budgettype e ORDER BY e.id"),
  @NamedQuery(name = Budgettype.FIND_BUDGETTYPE_BY_CODE_QUERY, query = "SELECT e FROM Budgettype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="budget_type")
public class Budgettype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_BUDGETTYPE_QUERY = "allBudgettypes";
	public static final String FIND_BUDGETTYPE_BY_CODE_QUERY = "findBudgettypesByCode";
