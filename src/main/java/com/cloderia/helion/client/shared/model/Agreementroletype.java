...
/**
 * Agreementroletype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Agreementroletype.ALL_AGREEMENTROLETYPE_QUERY, query = "SELECT e FROM Agreementroletype e ORDER BY e.id"),
  @NamedQuery(name = Agreementroletype.FIND_AGREEMENTROLETYPE_BY_CODE_QUERY, query = "SELECT e FROM Agreementroletype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="agreement_role_type")
public class Agreementroletype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_AGREEMENTROLETYPE_QUERY = "allAgreementroletypes";
	public static final String FIND_AGREEMENTROLETYPE_BY_CODE_QUERY = "findAgreementroletypesByCode";
