...
@Entity
@NamedQueries({
  @NamedQuery(name = Financialaccount.ALL_FINANCIALACCOUNT_QUERY, query = "SELECT e FROM Financialaccount e ORDER BY e.id"),
  @NamedQuery(name = Financialaccount.FIND_FINANCIALACCOUNT_BY_CODE_QUERY, query = "SELECT e FROM Financialaccount e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="financial_account")
public class Financialaccount extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_FINANCIALACCOUNT_QUERY = "allFinancialaccounts";
	public static final String FIND_FINANCIALACCOUNT_BY_CODE_QUERY = "findFinancialaccountsByCode";
	
    private Long id;

    private Universe universe;
    private Financialaccounttype finAcctTy;
