...
/**
 * Financialaccounttransactiontype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Financialaccounttransactiontype.ALL_FINANCIALACCOUNTTRANSACTIONTYPE_QUERY, query = "SELECT e FROM Financialaccounttransactiontype e ORDER BY e.id"),
  @NamedQuery(name = Financialaccounttransactiontype.FIND_FINANCIALACCOUNTTRANSACTIONTYPE_BY_CODE_QUERY, query = "SELECT e FROM Financialaccounttransactiontype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Financialaccounttransactiontype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_FINANCIALACCOUNTTRANSACTIONTYPE_QUERY = "allFinancialaccounttransactiontypes";
	public static final String FIND_FINANCIALACCOUNTTRANSACTIONTYPE_BY_CODE_QUERY = "findFinancialaccounttransactiontypesByCode";
