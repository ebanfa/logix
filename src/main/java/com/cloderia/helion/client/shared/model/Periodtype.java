...
@Entity
@NamedQueries({
  @NamedQuery(name = Periodtype.ALL_PERIODTYPE_QUERY, query = "SELECT e FROM Periodtype e ORDER BY e.id"),
  @NamedQuery(name = Periodtype.FIND_PERIODTYPE_BY_CODE_QUERY, query = "SELECT e FROM Periodtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="period_type")
public class Periodtype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_PERIODTYPE_QUERY = "allPeriodtypes";
	public static final String FIND_PERIODTYPE_BY_CODE_QUERY = "findPeriodtypesByCode";
