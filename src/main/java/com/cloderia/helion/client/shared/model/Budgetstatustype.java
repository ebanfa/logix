...
/**
 * Budgetstatustype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Budgetstatustype.ALL_BUDGETSTATUSTYPE_QUERY, query = "SELECT e FROM Budgetstatustype e ORDER BY e.id"),
  @NamedQuery(name = Budgetstatustype.FIND_BUDGETSTATUSTYPE_BY_CODE_QUERY, query = "SELECT e FROM Budgetstatustype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="budget_status_type")
public class Budgetstatustype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_BUDGETSTATUSTYPE_QUERY = "allBudgetstatustypes";
	public static final String FIND_BUDGETSTATUSTYPE_BY_CODE_QUERY = "findBudgetstatustypesByCode";
