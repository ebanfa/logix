...
@Entity
@NamedQueries({
  @NamedQuery(name = Productcategory.ALL_PRODUCTCATEGORY_QUERY, query = "SELECT e FROM Productcategory e ORDER BY e.id"),
  @NamedQuery(name = Productcategory.FIND_PRODUCTCATEGORY_BY_CODE_QUERY, query = "SELECT e FROM Productcategory e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="product_category")
public class Productcategory extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_PRODUCTCATEGORY_QUERY = "allProductcategorys";
	public static final String FIND_PRODUCTCATEGORY_BY_CODE_QUERY = "findProductcategorysByCode";
	
    private Long id;

    private Universe universe;
    private Productcategorytype prodCatTy;
