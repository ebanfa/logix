...
@Entity
@NamedQueries({
  @NamedQuery(name = Paymenttype.ALL_PAYMENTTYPE_QUERY, query = "SELECT e FROM Paymenttype e ORDER BY e.id"),
  @NamedQuery(name = Paymenttype.FIND_PAYMENTTYPE_BY_CODE_QUERY, query = "SELECT e FROM Paymenttype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="payment_type")
public class Paymenttype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_PAYMENTTYPE_QUERY = "allPaymenttypes";
	public static final String FIND_PAYMENTTYPE_BY_CODE_QUERY = "findPaymenttypesByCode";
