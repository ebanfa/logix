...
/**
 * Productcategorytype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Productcategorytype.ALL_PRODUCTCATEGORYTYPE_QUERY, query = "SELECT e FROM Productcategorytype e ORDER BY e.id"),
  @NamedQuery(name = Productcategorytype.FIND_PRODUCTCATEGORYTYPE_BY_CODE_QUERY, query = "SELECT e FROM Productcategorytype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Productcategorytype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_PRODUCTCATEGORYTYPE_QUERY = "allProductcategorytypes";
	public static final String FIND_PRODUCTCATEGORYTYPE_BY_CODE_QUERY = "findProductcategorytypesByCode";
