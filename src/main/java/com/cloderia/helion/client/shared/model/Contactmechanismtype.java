...
/**
 * Contactmechanismtype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Contactmechanismtype.ALL_CONTACTMECHANISMTYPE_QUERY, query = "SELECT e FROM Contactmechanismtype e ORDER BY e.id"),
  @NamedQuery(name = Contactmechanismtype.FIND_CONTACTMECHANISMTYPE_BY_CODE_QUERY, query = "SELECT e FROM Contactmechanismtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Contactmechanismtype extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_CONTACTMECHANISMTYPE_QUERY = "allContactmechanismtypes";
	public static final String FIND_CONTACTMECHANISMTYPE_BY_CODE_QUERY = "findContactmechanismtypesByCode";
