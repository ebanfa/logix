...
/**
 * Inventoryitemtype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Inventoryitemtype.ALL_INVENTORYITEMTYPE_QUERY, query = "SELECT e FROM Inventoryitemtype e ORDER BY e.id"),
  @NamedQuery(name = Inventoryitemtype.FIND_INVENTORYITEMTYPE_BY_CODE_QUERY, query = "SELECT e FROM Inventoryitemtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="inventory_item_type")
public class Inventoryitemtype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_INVENTORYITEMTYPE_QUERY = "allInventoryitemtypes";
	public static final String FIND_INVENTORYITEMTYPE_BY_CODE_QUERY = "findInventoryitemtypesByCode";
