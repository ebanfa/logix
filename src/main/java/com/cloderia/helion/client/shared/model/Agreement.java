...
@Entity
@NamedQueries({
  @NamedQuery(name = Agreement.ALL_AGREEMENT_QUERY, query = "SELECT e FROM Agreement e ORDER BY e.id"),
  @NamedQuery(name = Agreement.FIND_AGREEMENT_BY_CODE_QUERY, query = "SELECT e FROM Agreement e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="agreement")
public class Agreement extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_AGREEMENT_QUERY = "allAgreements";
	public static final String FIND_AGREEMENT_BY_CODE_QUERY = "findAgreementsByCode";
	
    private Long id;

    private Universe universe;
    private Agreementtype agreementTy;
    private Partyrelationship partyRel;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="agreement_ty", nullable=false)
    public Agreementtype getAgreementTy() {
        return this.agreementTy;
    }
    
    public void setAgreementTy(Agreementtype agreementTy) {
        this.agreementTy = agreementTy;
    }
    @ManyToOne(fetch=FetchType.EAGER)
