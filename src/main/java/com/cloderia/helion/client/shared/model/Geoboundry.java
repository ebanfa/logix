...
/**
 * Geoboundry generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Geoboundry.ALL_GEOBOUNDRY_QUERY, query = "SELECT e FROM Geoboundry e ORDER BY e.id"),
  @NamedQuery(name = Geoboundry.FIND_GEOBOUNDRY_BY_CODE_QUERY, query = "SELECT e FROM Geoboundry e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="geo_boundry")
public class Geoboundry extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_GEOBOUNDRY_QUERY = "allGeoboundrys";
	public static final String FIND_GEOBOUNDRY_BY_CODE_QUERY = "findGeoboundrysByCode";
	
    private Long id;

    private Universe universe;
    private Geoboundrytype geoBoundryTy;
    private Geoboundry parentGeoBoundry;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="geo_boundry_ty", nullable=false)
    public Geoboundrytype getGeoBoundryTy() {
        return this.geoBoundryTy;
    }
    
    public void setGeoBoundryTy(Geoboundrytype geoBoundryTy) {
        this.geoBoundryTy = geoBoundryTy;
    }
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="parent_geo_boundry", nullable=false)
    public Geoboundry getParentGeoBoundry() {
        return this.parentGeoBoundry;
    }
    
    public void setParentGeoBoundry(Geoboundry parentGeoBoundry) {
        this.parentGeoBoundry = parentGeoBoundry;
    }
    ...
    @Column(name="geo_code", nullable=true, length=35)
    ...
    @Column(name="abbr", nullable=true, length=15)
