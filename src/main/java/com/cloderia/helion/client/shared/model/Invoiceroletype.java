...
/**
 * Invoiceroletype generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Invoiceroletype.ALL_INVOICEROLETYPE_QUERY, query = "SELECT e FROM Invoiceroletype e ORDER BY e.id"),
  @NamedQuery(name = Invoiceroletype.FIND_INVOICEROLETYPE_BY_CODE_QUERY, query = "SELECT e FROM Invoiceroletype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="invoice_role_type")
public class Invoiceroletype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_INVOICEROLETYPE_QUERY = "allInvoiceroletypes";
	public static final String FIND_INVOICEROLETYPE_BY_CODE_QUERY = "findInvoiceroletypesByCode";
