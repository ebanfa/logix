...
/**
 * Standardtimeperiod generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Standardtimeperiod.ALL_STANDARDTIMEPERIOD_QUERY, query = "SELECT e FROM Standardtimeperiod e ORDER BY e.id"),
  @NamedQuery(name = Standardtimeperiod.FIND_STANDARDTIMEPERIOD_BY_CODE_QUERY, query = "SELECT e FROM Standardtimeperiod e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Standardtimeperiod extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_STANDARDTIMEPERIOD_QUERY = "allStandardtimeperiods";
	public static final String FIND_STANDARDTIMEPERIOD_BY_CODE_QUERY = "findStandardtimeperiodsByCode";
