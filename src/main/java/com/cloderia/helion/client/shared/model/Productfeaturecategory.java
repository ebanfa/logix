...
/**
 * Productfeaturecategory generated by hbm2java
 */
@Bindable
@Portable
@Entity
@NamedQueries({
  @NamedQuery(name = Productfeaturecategory.ALL_PRODUCTFEATURECATEGORY_QUERY, query = "SELECT e FROM Productfeaturecategory e ORDER BY e.id"),
  @NamedQuery(name = Productfeaturecategory.FIND_PRODUCTFEATURECATEGORY_BY_CODE_QUERY, query = "SELECT e FROM Productfeaturecategory e where e.entityCode = :entityCode ORDER  BY e.id")
})
...
public class Productfeaturecategory extends BaseEntity implements java.io.Serializable {
	...
	public static final String ALL_PRODUCTFEATURECATEGORY_QUERY = "allProductfeaturecategorys";
	public static final String FIND_PRODUCTFEATURECATEGORY_BY_CODE_QUERY = "findProductfeaturecategorysByCode";
