...
@Entity
@NamedQueries({
  @NamedQuery(name = Document.ALL_DOCUMENT_QUERY, query = "SELECT e FROM Document e ORDER BY e.id"),
  @NamedQuery(name = Document.FIND_DOCUMENT_BY_CODE_QUERY, query = "SELECT e FROM Document e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="document")
public class Document extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_DOCUMENT_QUERY = "allDocuments";
	public static final String FIND_DOCUMENT_BY_CODE_QUERY = "findDocumentsByCode";
	
    private Long id;

    private Universe universe;
    private Documenttype docTy;
    ...
    @ManyToOne(fetch=FetchType.EAGER)
    @JoinColumn(name="doc_ty", nullable=false)
