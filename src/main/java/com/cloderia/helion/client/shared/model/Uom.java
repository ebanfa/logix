...
@Entity
@NamedQueries({
  @NamedQuery(name = Uom.ALL_UOM_QUERY, query = "SELECT e FROM Uom e ORDER BY e.id"),
  @NamedQuery(name = Uom.FIND_UOM_BY_CODE_QUERY, query = "SELECT e FROM Uom e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="uom")
public class Uom extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_UOM_QUERY = "allUoms";
	public static final String FIND_UOM_BY_CODE_QUERY = "findUomsByCode";
