...
@Entity
@NamedQueries({
  @NamedQuery(name = Terminationtype.ALL_TERMINATIONTYPE_QUERY, query = "SELECT e FROM Terminationtype e ORDER BY e.id"),
  @NamedQuery(name = Terminationtype.FIND_TERMINATIONTYPE_BY_CODE_QUERY, query = "SELECT e FROM Terminationtype e where e.entityCode = :entityCode ORDER  BY e.id")
})
@Table(name="termination_type")
public class Terminationtype extends BaseEntity implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public static final String ALL_TERMINATIONTYPE_QUERY = "allTerminationtypes";
	public static final String FIND_TERMINATIONTYPE_BY_CODE_QUERY = "findTerminationtypesByCode";
